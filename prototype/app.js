...
(function () {
  ...
  // Materias de idioma: si se marca una, la IA y los repasos de esa materia
  ...
  var LANG_SUBJ = [
    ...
    { v: "pt", flag: "🇵🇹", es: "Portugués", en: "Portuguese", it: "Portoghese", fr: "Portugais", pt: "Português" }
  ];
  function langSubjName(v) { var o = LANG_SUBJ.filter(function (x) { return x.v === v; })[0]; return o ? (o[DB.lang] || o.es) : ""; }
  ...
  var I18N = {
    es: {
      ...
      "subj.langQ": "¿Es una asignatura de idioma? (opcional)", "subj.langNo": "No",
      "subj.langNote": "La IA y los repasos de esta materia saldrán en {lang}.",
    ...
    en: {
      ...
      "subj.langQ": "Language subject (optional)", "subj.langNo": "No",
      "subj.langNote": "Zynqora AI and reviews for this subject will be in {lang}.",
    ...
    it: {
      "proto.mobile": "Cellulare", "proto.tablet": "Tablet", "proto.desktop": "Desktop",
      "proto.screens": "Schermate", "proto.hide": "Nascondi", "proto.reveal": "Mostra controlli",
      "proto.demoNote": "Prototipo · dati simulati, senza connessione reale",

      "menu.welcome": "Benvenuto", "menu.app": "Applicazione", "menu.states": "Stati",
      "menu.landing": "Landing", "menu.onboarding": "Onboarding", "menu.dashboard": "Dashboard · Oggi",
      "menu.subjects": "Le mie materie", "menu.subject": "Dettaglio materia", "menu.notes": "I miei appunti",
      "menu.addMaterial": "Aggiungi materiale", "menu.analysis": "Analisi del materiale",
      "menu.document": "Materiale del documento", "menu.path": "Percorso di studio", "menu.study": "Modalità di ripasso", "menu.fill": "Completa la parola",
      "menu.flashcards": "Flashcard", "menu.test": "Test", "menu.results": "Risultati",
      "menu.progress": "Progressi", "menu.calendar": "Calendario", "menu.plan": "Piano consigliato",
      "menu.ai": "Zynqora AI", "menu.settings": "Impostazioni",
      "menu.stFirst": "Dashboard · prima volta", "menu.stEmptyNotes": "Appunti · vuoto",
      "menu.stAllclear": "Studio · nessun ripasso", "menu.stError": "Errore di connessione",

      "nav.today": "Oggi", "nav.subjects": "Materie", "nav.notes": "Appunti",
      "nav.calendar": "Calendario", "nav.progress": "Progressi", "nav.profile": "Profilo", "nav.ai": "Zynqora AI",

      "common.continue": "Continua", "common.back": "Indietro", "common.next": "Avanti",
      "common.prev": "Precedente", "common.skip": "Salta", "common.save": "Salva", "common.cancel": "Annulla",
      "common.add": "Aggiungi", "common.min": "min", "common.minutes": "minuti", "common.seeAll": "Vedi tutto",
      "common.demoAction": "Azione dimostrativa", "common.close": "Chiudi", "common.optional": "facoltativo",
      "common.today": "Oggi", "common.tomorrow": "Domani",
      "err.subjectName": "Scrivi un nome per la materia.",
      "err.taskTitle": "Scrivi un titolo per il compito.",
      "err.profName": "Il nome non può essere vuoto.",
      "err.badEmail": "Inserisci un'email valida.",
      "subj.langQ": "Materia di lingua? (facoltativo)", "subj.langNo": "No",
      "subj.langNote": "La IA e i ripassi di questa materia saranno in {lang}.",

      "landing.signin": "Accedi", "landing.badge": "Studio con intelligenza",
      "landing.title": "Sa cosa studiare prima ancora che tu apra il libro.",
      "landing.sub": "Carica il tuo materiale. Zynqora lo comprende, crea i tuoi contenuti di studio e ti dice esattamente cosa ripassare oggi.",
      "landing.cta": "Inizia gratis", "landing.demo": "Guarda la demo",
      "landing.note": "Senza carta. Web, iOS e Android con un solo account.",
      "landing.f1t": "Dal tuo materiale", "landing.f1d": "PDF, appunti, foto e testo diventano materiale strutturato.",
      "landing.f2t": "Ripetizione dilazionata", "landing.f2d": "Il sistema decide quando ripassare ogni concetto.",
      "landing.f3t": "Focus quotidiano", "landing.f3d": "Una raccomandazione chiara ogni giorno, non un pannello di numeri.",
      "landing.footer": "© 2026 Zynqora · Prototipo di design",

      "ob.step": "Passo {n} di {total}", "ob.nameLabel": "Nome della materia",
      "ob.welcomeTitle": "Benvenuto su Zynqora", "ob.welcomeSub": "Personalizziamo la tua esperienza. Ci vorrà meno di un minuto.",
      "ob.welcomeStart": "Inizia",
      "ob.qHow": "Come hai conosciuto Zynqora?",
      "ob.howFriend": "Un amico", "ob.howTiktok": "TikTok", "ob.howInsta": "Instagram", "ob.howYoutube": "YouTube",
      "ob.howGoogle": "Google / Internet", "ob.howOther": "Altro",
      "ob.qGoal": "Cosa vuoi ottenere con Zynqora?", "ob.qGoalSub": "Puoi sceglierne diversi.",
      "ob.goalGrades": "Migliorare i miei voti", "ob.goalOrganise": "Organizzare meglio lo studio", "ob.goalExams": "Preparare gli esami",
      "ob.goalUnderstand": "Capire meglio le mie materie", "ob.goalTime": "Risparmiare tempo nello studio", "ob.goalHabit": "Creare un'abitudine di studio",
      "ob.qLevel": "Cosa studi?",
      "ob.lvlEso": "Scuola secondaria", "ob.lvlBach": "Liceo", "ob.lvlUniv": "Università", "ob.lvlFp": "Formazione professionale", "ob.lvlOtro": "Altro",
      "ob.qFirst": "Cosa vuoi studiare per primo?", "ob.qFirstSub": "Scegli una materia o creane una nuova.",
      "ob.createNew": "Crea una nuova materia", "ob.newNamePh": "Nome della materia",
      "ob.readyTitle": "Perfetto. Zynqora è pronta per te.", "ob.readySub": "Ora puoi iniziare a studiare in modo più intelligente.",
      "ob.readyStart": "Inizia",

      "greet.morning": "Buongiorno", "greet.afternoon": "Buon pomeriggio", "greet.evening": "Buonasera",

      "dash.nextStep": "Il tuo prossimo passo", "dash.reason": "In base a ciò che devi rafforzare.",
      "dash.reviewTopic": "Ripassa {topic}", "dash.studyWeak": "Studia {topic}",
      "dash.startSession": "Inizia", "dash.estimated": "{n} min stimati",
      "dash.reviews": "ripassi", "dash.weak": "concetti deboli", "dash.streak": "giorni di serie",
      "dash.todayProgress": "Progressi di oggi", "dash.goalLeft": "Ti mancano {n} min per il tuo obiettivo.",
      "dash.goalDone": "Obiettivo di oggi raggiunto. Ottimo lavoro.",
      "dash.upcoming": "Prossimi compiti", "dash.nextExam": "Prossimo esame", "dash.inDays": "tra {n} giorni",
      "dash.weakTitle": "Concetti che necessitano di rinforzo",
      "dash.lastTest": "Ultimo test", "dash.lastTestSub": "{score}/{total} in {topic}",
      "dash.askAiCard": "Chiedi a Zynqora AI su ciò che stai studiando.",
      "dash.open": "Apri", "dash.prepPlan": "Vuoi che Zynqora ti prepari un piano?",
      "dash.seePlan": "Vedi il piano consigliato",

      "subjects.title": "Le mie materie", "subjects.add": "Aggiungi materia", "subjects.switchTo": "Cambia materia",
      "subjects.docs": "documenti", "subjects.doc1": "documento", "subjects.mastery": "{n}% di padronanza", "subjects.empty": "Nessuna materia",
      "subjects.emptySub": "Crea la tua prima materia per iniziare a organizzare lo studio.",
      "subjects.newTitle": "Nuova materia", "subjects.newSub": "Dalle un nome, un'icona e un colore.",
      "subjects.icon": "Icona", "subjects.color": "Colore", "subjects.namePlaceholder": "Storia",

      "subject.overall": "Padronanza generale",
      "tab.docs": "Documenti", "tab.flashcards": "Flashcard", "tab.tests": "Test", "tab.progress": "Progressi", "tab.weak": "Punti deboli",
      "subject.noDocs": "Ancora nessun documento in questa materia.", "subject.addMaterial": "Aggiungi materiale",
      "subject.studyNow": "Studia ora", "subject.startTest": "Fai un test", "subject.reviewCards": "Ripassa le flashcard",
      "subject.cardsCount": "{n} flashcard", "subject.testsCount": "{n} test svolti",
      "subject.weakList": "Concetti deboli di questa materia", "subject.noWeak": "Nessun concetto debole rilevato.",
      "subject.sessions": "Sessioni di studio", "subject.lastSession": "Ultima sessione: {n} giorni fa",

      "notes.title": "I miei appunti", "notes.addMaterial": "Aggiungi materiale",
      "notes.sub": "Tutto il tuo materiale di studio, organizzato per materia.",
      "notes.docsIn": "in {subject}", "notes.pages": "pagine", "notes.ready": "Pronto", "notes.analyzing": "Analisi in corso",
      "notes.open": "Apri", "notes.askAi": "Chiedi a Zynqora AI",
      "notes.emptyTitle": "Non hai ancora aggiunto materiale",
      "notes.emptySub": "Carica un PDF, un documento, una foto o scrivi una nota. Zynqora lo trasformerà in materiale di studio.",

      "add.title": "Aggiungi materiale", "add.sub": "Che tipo di materiale vuoi aggiungere a {subject}?",
      "add.pdf": "PDF", "add.pdfSub": "Appunti, programma o schemi in PDF",
      "add.doc": "Documento", "add.docSub": "Word, Google Docs o simili",
      "add.image": "Immagine o foto", "add.imageSub": "Foto di appunti o lavagna",
      "add.text": "Testo", "add.textSub": "Scrivi o incolla i tuoi appunti",
      "add.sourceTitle": "Scegli il file", "add.sourceSub": "Seleziona un file o usa un esempio",
      "add.choose": "Seleziona file", "add.example": "Usa documento di esempio",
      "add.exampleNote": "Il prototipo non elabora file reali. Usa l'esempio per vedere il flusso completo.",
      "add.selected": "Selezionato", "add.analyze": "Analizza materiale", "add.remove": "Rimuovi",
      "add.textPlaceholder": "Scrivi o incolla qui i tuoi appunti…", "add.demoFileNote": "Simulato — non viene caricato né letto alcun contenuto reale.",

      "analysis.title": "Analisi", "analysis.working": "Analisi del materiale in corso…",
      "analysis.s1": "Lettura del documento", "analysis.s2": "Identificazione del contenuto",
      "analysis.s3": "Rilevamento dei concetti importanti", "analysis.s4": "Individuazione delle aree da rafforzare",
      "analysis.readyTitle": "Il tuo materiale è pronto",
      "analysis.readySub": "Zynqora ha compreso il tuo materiale e ha preparato i contenuti di studio.",
      "analysis.mConcepts": "concetti rilevati", "analysis.mDifficulty": "difficoltà stimata",
      "analysis.mTopics": "argomenti principali", "analysis.mReadTime": "min di lettura",
      "analysis.mainConcepts": "Concetti importanti", "analysis.weakAreas": "Aree da rafforzare",
      "analysis.viewSummary": "Vedi riassunto", "analysis.makeFlashcards": "Crea flashcard",
      "analysis.makeTest": "Crea test", "analysis.makeSession": "Crea sessione di studio", "analysis.askAi": "Chiedi a Zynqora AI",
      "diff.easy": "Bassa", "diff.med": "Media", "diff.hard": "Alta",

      "document.title": "Materiale", "document.summary": "Riassunto", "document.readFull": "Leggi il riassunto completo",
      "document.structured": "Contenuto strutturato", "document.generated": "Materiale generato",
      "document.study": "Studia questo", "document.createSession": "Crea sessione di studio",
      "document.flashcardsN": "{n} flashcard", "document.questionsN": "{n} domande", "document.summaryN": "1 riassunto",
      "document.ready": "Pronto per studiare", "document.aiAnalysis": "Analisi di Zynqora", "document.askAi": "Chiedi a Zynqora AI su questo materiale",

      "doc.status.pending": "In attesa", "doc.status.processing": "Elaborazione", "doc.status.analyzed": "Analizzato", "doc.status.failed": "Impossibile analizzare",
      "doc.realBadge": "Contenuto del file reale", "doc.localBadge": "Generato localmente dal testo reale", "doc.exampleBadge": "Contenuto di esempio",
      "doc.wordsN": "{n} parole", "doc.charsN": "{n} caratteri", "doc.noText": "Nessun testo estratto",
      "doc.detailTitle": "Documento", "doc.meta.type": "Tipo", "doc.meta.size": "Dimensione", "doc.meta.date": "Data", "doc.meta.subject": "Materia", "doc.meta.status": "Stato", "doc.meta.source": "Origine del testo",
      "doc.content": "Contenuto estratto", "doc.contentMore": "Vedi tutto il testo", "doc.contentLess": "Vedi meno",
      "doc.summarySection": "Riassunto", "doc.conceptsSection": "Concetti principali", "doc.keyPoints": "Punti importanti",
      "doc.changeSubject": "Cambia materia", "doc.startReview": "Inizia il ripasso", "doc.delete": "Elimina documento",
      "doc.deleteQ": "Eliminare questo documento?", "doc.deleteSub": "Verranno eliminati anche il riassunto, le flashcard e le sessioni. Non riguarda gli altri documenti.",
      "doc.deleted": "Documento eliminato", "doc.genSummary": "Genera riassunto", "doc.regen": "Rigenera",
      "doc.ocrPending": "Immagine salvata — il testo verrà letto con OCR quando il backend sarà connesso.",
      "doc.attach": "Allega a Zynqora AI", "doc.fromDoc": "Basato su: {name}",
      "an.reading": "Lettura del file", "an.extracting": "Estrazione del contenuto", "an.analyzing": "Analisi del testo", "an.preparing": "Preparazione del materiale",
      "an.failedTitle": "Impossibile leggere il contenuto", "an.pendingTitle": "Immagine salvata",
      "an.textOk": "Testo estratto · {n} parole", "an.keepAnyway": "Mantieni comunque",
      "add.chooseSub": "Trascina un file qui o selezionalo. TXT e PDF vengono letti nel browser; le immagini vengono salvate per l'OCR.",
      "add.dropHere": "Rilascia il file", "add.pasteReal": "Il testo che incolli viene letto e usato davvero.",

      "study.title": "Sessione di studio", "study.recommended": "Consigliato per oggi",
      "study.about": "Circa {n} minuti", "study.includes": "Include",
      "study.bReviews": "{n} flashcard di ripasso", "study.bQuestions": "{n} domande nuove", "study.bSummary": "1 riassunto dell'argomento",
      "study.why": "Perché questa sessione",
      "study.begin": "Inizia sessione", "study.customize": "Personalizza",
      "study.allClearTitle": "Tutto aggiornato", "study.allClearSub": "Non hai ripassi in sospeso in questa materia.",
      "study.doTest": "Fai un test",

      "fc.title": "Flashcard", "fc.showAnswer": "Vedi risposta", "fc.answer": "Risposta",
      "fc.tapHint": "Tocca per vedere la risposta", "fc.again": "Devo ripassarlo", "fc.known": "Lo sapevo",
      "fc.dontGetIt": "Non lo capisco", "fc.explainAi": "Spiega con Zynqora AI",
      "fc.doneTitle": "Ripasso completato", "fc.doneSub": "{known} di {total} sapute · {again} da ripassare presto",
      "fc.toTest": "Continua con il test", "fc.toDash": "Torna alla dashboard",

      "test.title": "Test", "test.pick": "Scegli un'opzione", "test.correct": "Corretto", "test.incorrect": "Non esattamente",
      "test.next": "Avanti", "test.finish": "Vedi risultati", "test.whyFailed": "Perché ho sbagliato? Chiedi a Zynqora AI",

      "results.title": "Risultati", "results.score": "punteggio", "results.questions": "domande",
      "results.correct": "corrette", "results.incorrect": "errate",
      "results.mastered": "Concetti padroneggiati", "results.weak": "Concetti deboli",
      "results.understandErrors": "Vuoi capire i tuoi errori?", "results.askAi": "Chiedi a Zynqora AI",
      "results.whatNow": "Cosa dovrei studiare ora?", "results.seeRec": "Vedi raccomandazione",
      "results.backPanel": "Torna alla dashboard",

      "progress.title": "Progressi", "progress.overall": "Generale", "progress.thisSubject": "Questa materia",
      "progress.studyMinutes": "Minuti di studio", "progress.last14": "Ultimi 14 giorni",
      "progress.twoWeeksAgo": "2 sett. fa", "progress.today": "Oggi",
      "progress.thisWeek": "questa settimana", "progress.currentStreak": "serie", "progress.avgMastery": "padronanza media",
      "progress.sessions": "Sessioni", "progress.sessionsSub": "{n} sessioni in 14 giorni",
      "progress.bySubject": "Per materia", "progress.concepts": "Padronanza dei concetti", "progress.reinforce": "Rafforza",

      "cal.title": "Calendario", "cal.addTask": "Aggiungi compito", "cal.noTasks": "Nessun compito in questo giorno.",
      "cal.tasksFor": "Compiti · {date}", "cal.newTask": "Nuovo compito", "cal.taskTitle": "Titolo",
      "cal.subject": "Materia", "cal.type": "Tipo", "cal.date": "Data", "cal.time": "Ora",
      "cal.typeExercise": "Esercizio", "cal.typeReview": "Ripasso", "cal.typeStudy": "Studio", "cal.typeExam": "Esame",
      "cal.taskDetail": "Dettaglio del compito", "cal.markDone": "Segna come fatto", "cal.done": "Fatto",
      "cal.markUndone": "Segna come in sospeso",
      "cal.desc": "Descrizione", "cal.descPh": "Dettagli, argomenti da trattare…", "cal.descOpt": "Descrizione (facoltativa)",
      "cal.editTask": "Modifica compito", "cal.edit": "Modifica", "cal.delete": "Elimina",
      "cal.deleteConfirm": "Eliminare questo compito? Non si può annullare.",
      "cal.taskDeleted": "Compito eliminato",
      "cal.prepPlanQ": "Hai un esame il {day}. Vuoi che Zynqora ti prepari un piano?",
      "cal.prepPlan": "Prepara piano con Zynqora",

      "plan.title": "Piano consigliato", "plan.for": "Per: {exam}",
      "plan.intro": "Zynqora ha distribuito lo studio nei giorni che mancano al tuo esame.",
      "plan.addToCalendar": "Aggiungi il piano al calendario", "plan.added": "Piano aggiunto al calendario",
      "plan.mon": "Lun", "plan.tue": "Mar", "plan.wed": "Mer", "plan.thu": "Gio", "plan.fri": "Ven",

      "ai.title": "Zynqora AI", "ai.subtitle": "Il tuo compagno di studio",
      "ai.placeholder": "Chiedi su ciò che stai studiando…",
      "ai.demoNote": "Risposte simulate per il prototipo. Qui si collegherà il sistema di IA reale.",
      "ai.newConv": "Nuova chat", "ai.yourConvs": "Le tue conversazioni", "ai.noConvs": "Ancora nessuna conversazione.",
      "ai.deleteConv": "Elimina conversazione", "ai.deleteConvQ": "Eliminare questa conversazione?",
      "ai.deleteConvSub": "Verrà eliminata per sempre.", "ai.convDeleted": "Conversazione eliminata",
      "ai.ctxSubject": "Contesto: {subject}", "ai.ctxDoc": "Contesto: {doc}",
      "ai.ctxSubjectDoc": "Contesto: {subject} · {doc}",
      "ai.ctxFlashcard": "Contesto: flashcard · {t}", "ai.ctxTest": "Contesto: domanda sbagliata",
      "ai.ctxResult": "Contesto: il tuo ultimo test di {subject}",
      "ai.attach": "Allega", "ai.attachPdf": "PDF", "ai.attachDoc": "Documento", "ai.attachImage": "Immagine / foto",
      "ai.ctxAdded": "Contesto aggiunto: {name}", "ai.usingContext": "Ho aggiunto {name} al contesto di questa conversazione.",
      "ai.sugExplain": "Spiegami questo concetto", "ai.sugSimple": "Spiegamelo in modo semplice",
      "ai.sugExample": "Fammi un esempio", "ai.sugCompare": "Confronta due idee di questo argomento",
      "ai.sugQuiz": "Fammi una domanda per verificare se ho capito",
      "ai.sugWhyFailed": "Perché ho sbagliato questa domanda?", "ai.sugSummarize": "Riassumi i miei appunti",
      "ai.sugImprove": "Come posso migliorare?", "ai.backToConvs": "Conversazioni",
      "ai.ctxLabel": "Contesto", "ai.ctxNone": "Nessun contesto",
      "ai.tSimple": "Spiegamelo più facile", "ai.tExample": "Fammi un esempio", "ai.tQuiz": "Fammi una domanda", "ai.tDeeper": "Approfondisci",
      "ai.fAnother": "Un altro esercizio", "ai.fHarder": "Più difficile", "ai.fEasier": "Più facile", "ai.fCorrect": "Correggimi",

      "settings.title": "Impostazioni", "settings.language": "Lingua", "settings.theme": "Tema",
      "settings.themeLight": "Chiaro", "settings.themeDark": "Scuro", "settings.themeAuto": "Sistema",
      "settings.accent": "Colore accento",
      "accent.violet": "Viola", "accent.blue": "Blu", "accent.green": "Verde", "accent.pink": "Rosa", "accent.orange": "Arancione",
      "premium.title": "Zynqora Premium", "premium.sub": "Studia senza limiti.",
      "premium.f1t": "IA senza limiti", "premium.f1d": "Genera tutti i riassunti, flashcard e test di cui hai bisogno.",
      "premium.f2t": "Piani d'esame", "premium.f2d": "Zynqora organizza il tuo studio giorno per giorno.",
      "premium.f3t": "Statistiche avanzate", "premium.f3d": "Analizza a fondo i tuoi progressi e i tuoi punti deboli.",
      "premium.f4t": "Senza pubblicità", "premium.f4d": "Un'esperienza pulita e mirata.",
      "premium.cta": "Prova Premium",
      "study.pTitle": "Personalizza sessione", "study.pSub": "Regola questa sessione di studio.",
      "study.pMore": "Più flashcard", "study.pShorter": "Sessione più breve", "study.pTest": "Includi un test finale",
      "study.pApply": "Applica modifiche",
      "path.title": "Il tuo percorso di studio", "path.sub": "Quattro passi per padroneggiare {topic}.",
      "path.n1t": "Ripassa", "path.n1s": "{topic}", "path.n2t": "Pratica", "path.n2s": "Concetti chiave",
      "path.n3t": "Verifica", "path.n3s": "Test rapido", "path.n4t": "Padroneggia", "path.n4s": "Ripasso finale",
      "path.start": "Continua il percorso", "path.done": "Percorso completato!", "path.step": "Passo {n} di 4",
      "mode.title": "Come vuoi ripassare?", "mode.sub": "Scegli come studiare {topic} oggi.", "mode.rec": "Consigliato",
      "mode.flashcards": "Flashcard", "mode.flashcardsS": "Domanda e risposta",
      "mode.test": "Test", "mode.testS": "Scelta multipla con feedback",
      "mode.fill": "Completa la parola", "mode.fillS": "Riempi lo spazio nella frase",
      "mode.match": "Collega i concetti", "mode.matchS": "Unisci ogni termine alla sua definizione",
      "mode.explain": "Spiega con parole tue", "mode.explainS": "Raccontalo a Zynqora AI",
      "mode.identify": "Identifica il concetto", "mode.identifyS": "A quale idea si riferisce?",
      "fib.title": "Completa la parola", "fib.check": "Verifica", "fib.next": "Avanti", "fib.finish": "Termina",
      "fib.correct": "Corretto!", "fib.wrong": "Quasi. La risposta era: {a}",
      "rm.matchTitle": "Collega ogni concetto alla sua definizione", "rm.identifyTitle": "A quale concetto si riferisce questa descrizione?",
      "rm.explainTitle": "Spiegalo con parole tue", "rm.explainPh": "Scrivi la tua spiegazione di {c}…", "rm.explainSend": "Invia a Zynqora AI",
      "rm.done": "Esercizio completato", "rm.back": "Torna al percorso",
      "streak.title": "Serie di {n} giorni!", "streak.sub": "Continua così domani per non perderla.",
      "profile.editPhoto": "Modifica profilo", "profile.photoTitle": "Foto profilo", "profile.photoSub": "Scegli un'immagine o un colore.",
      "profile.choosePhoto": "Scegli immagine", "profile.photoSaved": "Foto aggiornata",
      "profile.editTitle": "Modifica profilo", "profile.editSub": "Il tuo nome e la tua foto vengono salvati su questo dispositivo.",
      "profile.nameLabel": "Nome", "profile.emailLabel": "Email",
      "profile.emailNote": "L'email viene sostituita quando accedi con un account reale.",
      "profile.photoSection": "Foto", "profile.saved": "Profilo aggiornato",
      "settings.notifications": "Notifiche", "settings.notifOn": "Attivate", "settings.notifOff": "Disattivate",
      "settings.study": "Preferenze di studio", "settings.dailyGoal": "Obiettivo giornaliero",
      "settings.sessionLength": "Durata sessione", "settings.short": "Breve", "settings.balanced": "Equilibrata", "settings.long": "Lunga",
      "settings.reminders": "Promemoria di studio", "settings.remindersVal": "Ogni giorno · 18:00",
      "settings.reminderTime": "Ora del promemoria",
      "settings.reminderNote": "L'impostazione viene salvata. Il prototipo non invia ancora notifiche push.",
      "settings.account": "Account", "settings.signout": "Esci", "settings.deleteAccount": "Elimina account",
      "settings.wipeConfirm": "Eliminare tutti i tuoi dati su questo dispositivo? Materie, chat, calendario e progressi verranno cancellati. Non si può annullare.",
      "settings.wipeDone": "Dati eliminati",
      "settings.version": "Zynqora · versione prototipo", "settings.plan": "Piano", "settings.planFree": "Gratis",

      "states.firstTitle": "Ancora niente da studiare",
      "states.firstSub": "Aggiungi il tuo primo materiale e Zynqora preparerà il tuo piano di studio in meno di un minuto.",
      "states.howItWorks": "Come funziona",
      "states.hiw1t": "Aggiungi il tuo materiale", "states.hiw1d": "PDF, documento, foto o testo",
      "states.hiw2t": "Zynqora lo comprende", "states.hiw2d": "Riassunto, flashcard e domande",
      "states.hiw3t": "Studia con concentrazione", "states.hiw3d": "Ti diciamo cosa ripassare ogni giorno",
      "states.errorTitle": "Impossibile caricare la dashboard",
      "states.errorSub": "Controlla la tua connessione. I tuoi dati sono al sicuro.", "states.retry": "Riprova"
    },
    fr: {
      "proto.mobile": "Mobile", "proto.tablet": "Tablette", "proto.desktop": "Bureau",
      "proto.screens": "Écrans", "proto.hide": "Masquer", "proto.reveal": "Afficher les contrôles",
      "proto.demoNote": "Prototype · données simulées, sans connexion réelle",

      "menu.welcome": "Bienvenue", "menu.app": "Application", "menu.states": "États",
      "menu.landing": "Landing", "menu.onboarding": "Onboarding", "menu.dashboard": "Tableau de bord · Aujourd'hui",
      "menu.subjects": "Mes matières", "menu.subject": "Détail de la matière", "menu.notes": "Mes notes",
      "menu.addMaterial": "Ajouter du contenu", "menu.analysis": "Analyse du contenu",
      "menu.document": "Contenu du document", "menu.path": "Parcours d'étude", "menu.study": "Modes de révision", "menu.fill": "Complète le mot",
      "menu.flashcards": "Flashcards", "menu.test": "Test", "menu.results": "Résultats",
      "menu.progress": "Progrès", "menu.calendar": "Calendrier", "menu.plan": "Plan recommandé",
      "menu.ai": "Zynqora AI", "menu.settings": "Paramètres",
      "menu.stFirst": "Tableau de bord · première fois", "menu.stEmptyNotes": "Notes · vide",
      "menu.stAllclear": "Étude · rien à réviser", "menu.stError": "Erreur de connexion",

      "nav.today": "Aujourd'hui", "nav.subjects": "Matières", "nav.notes": "Notes",
      "nav.calendar": "Calendrier", "nav.progress": "Progrès", "nav.profile": "Profil", "nav.ai": "Zynqora AI",

      "common.continue": "Continuer", "common.back": "Retour", "common.next": "Suivant",
      "common.prev": "Précédent", "common.skip": "Passer", "common.save": "Enregistrer", "common.cancel": "Annuler",
      "common.add": "Ajouter", "common.min": "min", "common.minutes": "minutes", "common.seeAll": "Tout voir",
      "common.demoAction": "Action de démonstration", "common.close": "Fermer", "common.optional": "facultatif",
      "common.today": "Aujourd'hui", "common.tomorrow": "Demain",
      "err.subjectName": "Écris un nom pour la matière.",
      "err.taskTitle": "Écris un titre pour la tâche.",
      "err.profName": "Le nom ne peut pas être vide.",
      "err.badEmail": "Saisis une adresse email valide.",
      "subj.langQ": "Matière de langue ? (facultatif)", "subj.langNo": "Non",
      "subj.langNote": "L'IA et les révisions de cette matière seront en {lang}.",

      "landing.signin": "Se connecter", "landing.badge": "Étudier avec intelligence",
      "landing.title": "Il sait quoi étudier avant même que tu ouvres le livre.",
      "landing.sub": "Envoie ton contenu. Zynqora le comprend, crée ton contenu d'étude et te dit exactement quoi réviser aujourd'hui.",
      "landing.cta": "Commencer gratuitement", "landing.demo": "Voir la démo",
      "landing.note": "Sans carte bancaire. Web, iOS et Android avec un seul compte.",
      "landing.f1t": "À partir de ton contenu", "landing.f1d": "PDF, notes, photos et texte deviennent du contenu structuré.",
      "landing.f2t": "Répétition espacée", "landing.f2d": "Le système décide quand réviser chaque concept.",
      "landing.f3t": "Focus quotidien", "landing.f3d": "Une recommandation claire chaque jour, pas un tableau de chiffres.",
      "landing.footer": "© 2026 Zynqora · Prototype de design",

      "ob.step": "Étape {n} sur {total}", "ob.nameLabel": "Nom de la matière",
      "ob.welcomeTitle": "Bienvenue sur Zynqora", "ob.welcomeSub": "Personnalisons ton expérience. Ça prendra moins d'une minute.",
      "ob.welcomeStart": "Commencer",
      "ob.qHow": "Comment as-tu connu Zynqora ?",
      "ob.howFriend": "Un ami", "ob.howTiktok": "TikTok", "ob.howInsta": "Instagram", "ob.howYoutube": "YouTube",
      "ob.howGoogle": "Google / Internet", "ob.howOther": "Autre",
      "ob.qGoal": "Que veux-tu accomplir avec Zynqora ?", "ob.qGoalSub": "Tu peux en choisir plusieurs.",
      "ob.goalGrades": "Améliorer mes notes", "ob.goalOrganise": "Mieux organiser mes études", "ob.goalExams": "Préparer mes examens",
      "ob.goalUnderstand": "Mieux comprendre mes matières", "ob.goalTime": "Gagner du temps en étudiant", "ob.goalHabit": "Créer une habitude d'étude",
      "ob.qLevel": "Que fais-tu comme études ?",
      "ob.lvlEso": "Collège", "ob.lvlBach": "Lycée", "ob.lvlUniv": "Université", "ob.lvlFp": "Formation professionnelle", "ob.lvlOtro": "Autre",
      "ob.qFirst": "Que veux-tu étudier en premier ?", "ob.qFirstSub": "Choisis une matière ou crées-en une nouvelle.",
      "ob.createNew": "Créer une nouvelle matière", "ob.newNamePh": "Nom de la matière",
      "ob.readyTitle": "Parfait. Zynqora est prête pour toi.", "ob.readySub": "Tu peux maintenant commencer à étudier plus intelligemment.",
      "ob.readyStart": "Commencer",

      "greet.morning": "Bonjour", "greet.afternoon": "Bon après-midi", "greet.evening": "Bonsoir",

      "dash.nextStep": "Ta prochaine étape", "dash.reason": "En fonction de ce que tu dois renforcer.",
      "dash.reviewTopic": "Réviser {topic}", "dash.studyWeak": "Étudier {topic}",
      "dash.startSession": "Commencer", "dash.estimated": "{n} min estimées",
      "dash.reviews": "révisions", "dash.weak": "concepts faibles", "dash.streak": "jours de série",
      "dash.todayProgress": "Progrès du jour", "dash.goalLeft": "Il te reste {n} min pour atteindre ton objectif.",
      "dash.goalDone": "Objectif du jour atteint. Bon travail.",
      "dash.upcoming": "Tâches à venir", "dash.nextExam": "Prochain examen", "dash.inDays": "dans {n} jours",
      "dash.weakTitle": "Concepts à renforcer",
      "dash.lastTest": "Dernier test", "dash.lastTestSub": "{score}/{total} en {topic}",
      "dash.askAiCard": "Demande à Zynqora AI à propos de ce que tu étudies.",
      "dash.open": "Ouvrir", "dash.prepPlan": "Tu veux que Zynqora te prépare un plan ?",
      "dash.seePlan": "Voir le plan recommandé",

      "subjects.title": "Mes matières", "subjects.add": "Ajouter une matière", "subjects.switchTo": "Changer de matière",
      "subjects.docs": "documents", "subjects.doc1": "document", "subjects.mastery": "{n}% de maîtrise", "subjects.empty": "Aucune matière",
      "subjects.emptySub": "Crée ta première matière pour commencer à organiser tes études.",
      "subjects.newTitle": "Nouvelle matière", "subjects.newSub": "Donne-lui un nom, une icône et une couleur.",
      "subjects.icon": "Icône", "subjects.color": "Couleur", "subjects.namePlaceholder": "Histoire",

      "subject.overall": "Maîtrise globale",
      "tab.docs": "Documents", "tab.flashcards": "Flashcards", "tab.tests": "Tests", "tab.progress": "Progrès", "tab.weak": "Points faibles",
      "subject.noDocs": "Aucun document dans cette matière pour l'instant.", "subject.addMaterial": "Ajouter du contenu",
      "subject.studyNow": "Étudier maintenant", "subject.startTest": "Faire un test", "subject.reviewCards": "Réviser les flashcards",
      "subject.cardsCount": "{n} flashcards", "subject.testsCount": "{n} tests réalisés",
      "subject.weakList": "Concepts faibles de cette matière", "subject.noWeak": "Aucun concept faible détecté.",
      "subject.sessions": "Sessions d'étude", "subject.lastSession": "Dernière session : il y a {n} jours",

      "notes.title": "Mes notes", "notes.addMaterial": "Ajouter du contenu",
      "notes.sub": "Tout ton contenu d'étude, organisé par matière.",
      "notes.docsIn": "dans {subject}", "notes.pages": "pages", "notes.ready": "Prêt", "notes.analyzing": "Analyse en cours",
      "notes.open": "Ouvrir", "notes.askAi": "Demander à Zynqora AI",
      "notes.emptyTitle": "Tu n'as pas encore ajouté de contenu",
      "notes.emptySub": "Envoie un PDF, un document, une photo ou écris une note. Zynqora le transformera en contenu d'étude.",

      "add.title": "Ajouter du contenu", "add.sub": "Quel type de contenu veux-tu ajouter à {subject} ?",
      "add.pdf": "PDF", "add.pdfSub": "Notes, programme ou plans en PDF",
      "add.doc": "Document", "add.docSub": "Word, Google Docs ou similaire",
      "add.image": "Image ou photo", "add.imageSub": "Photo de notes ou de tableau",
      "add.text": "Texte", "add.textSub": "Tape ou colle tes notes",
      "add.sourceTitle": "Choisis le fichier", "add.sourceSub": "Sélectionne un fichier ou utilise un exemple",
      "add.choose": "Sélectionner un fichier", "add.example": "Utiliser un document d'exemple",
      "add.exampleNote": "Le prototype ne traite pas de vrais fichiers. Utilise l'exemple pour voir le flux complet.",
      "add.selected": "Sélectionné", "add.analyze": "Analyser le contenu", "add.remove": "Retirer",
      "add.textPlaceholder": "Tape ou colle tes notes ici…", "add.demoFileNote": "Simulé — aucun contenu réel n'est envoyé ni lu.",

      "analysis.title": "Analyse", "analysis.working": "Analyse du contenu en cours…",
      "analysis.s1": "Lecture du document", "analysis.s2": "Identification du contenu",
      "analysis.s3": "Détection des concepts importants", "analysis.s4": "Repérage des points à renforcer",
      "analysis.readyTitle": "Ton contenu est prêt",
      "analysis.readySub": "Zynqora a compris ton contenu et a préparé le matériel d'étude.",
      "analysis.mConcepts": "concepts détectés", "analysis.mDifficulty": "difficulté estimée",
      "analysis.mTopics": "sujets principaux", "analysis.mReadTime": "min de lecture",
      "analysis.mainConcepts": "Concepts importants", "analysis.weakAreas": "Points à renforcer",
      "analysis.viewSummary": "Voir le résumé", "analysis.makeFlashcards": "Créer des flashcards",
      "analysis.makeTest": "Créer un test", "analysis.makeSession": "Créer une session d'étude", "analysis.askAi": "Demander à Zynqora AI",
      "diff.easy": "Faible", "diff.med": "Moyenne", "diff.hard": "Élevée",

      "document.title": "Contenu", "document.summary": "Résumé", "document.readFull": "Lire le résumé complet",
      "document.structured": "Contenu structuré", "document.generated": "Contenu généré",
      "document.study": "Étudier ceci", "document.createSession": "Créer une session d'étude",
      "document.flashcardsN": "{n} flashcards", "document.questionsN": "{n} questions", "document.summaryN": "1 résumé",
      "document.ready": "Prêt à étudier", "document.aiAnalysis": "Analyse de Zynqora", "document.askAi": "Demander à Zynqora AI à propos de ce contenu",

      "doc.status.pending": "En attente", "doc.status.processing": "En traitement", "doc.status.analyzed": "Analysé", "doc.status.failed": "Analyse impossible",
      "doc.realBadge": "Contenu du fichier réel", "doc.localBadge": "Généré localement à partir du texte réel", "doc.exampleBadge": "Contenu d'exemple",
      "doc.wordsN": "{n} mots", "doc.charsN": "{n} caractères", "doc.noText": "Aucun texte extrait",
      "doc.detailTitle": "Document", "doc.meta.type": "Type", "doc.meta.size": "Taille", "doc.meta.date": "Date", "doc.meta.subject": "Matière", "doc.meta.status": "État", "doc.meta.source": "Origine du texte",
      "doc.content": "Contenu extrait", "doc.contentMore": "Voir tout le texte", "doc.contentLess": "Voir moins",
      "doc.summarySection": "Résumé", "doc.conceptsSection": "Concepts principaux", "doc.keyPoints": "Points importants",
      "doc.changeSubject": "Changer de matière", "doc.startReview": "Commencer la révision", "doc.delete": "Supprimer le document",
      "doc.deleteQ": "Supprimer ce document ?", "doc.deleteSub": "Son résumé, ses flashcards et ses sessions seront aussi supprimés. Les autres documents ne sont pas affectés.",
      "doc.deleted": "Document supprimé", "doc.genSummary": "Générer un résumé", "doc.regen": "Régénérer",
      "doc.ocrPending": "Image enregistrée — le texte sera lu par OCR une fois le serveur connecté.",
      "doc.attach": "Joindre à Zynqora AI", "doc.fromDoc": "Basé sur : {name}",
      "an.reading": "Lecture du fichier", "an.extracting": "Extraction du contenu", "an.analyzing": "Analyse du texte", "an.preparing": "Préparation de ton contenu",
      "an.failedTitle": "Impossible de lire le contenu", "an.pendingTitle": "Image enregistrée",
      "an.textOk": "Texte extrait · {n} mots", "an.keepAnyway": "Garder quand même",
      "add.chooseSub": "Dépose un fichier ici ou sélectionne-le. Les TXT et PDF sont lus dans le navigateur ; les images sont enregistrées pour l'OCR.",
      "add.dropHere": "Dépose le fichier", "add.pasteReal": "Le texte que tu colles est lu et vraiment utilisé.",

      "study.title": "Session d'étude", "study.recommended": "Recommandé pour aujourd'hui",
      "study.about": "Environ {n} minutes", "study.includes": "Inclut",
      "study.bReviews": "{n} flashcards de révision", "study.bQuestions": "{n} nouvelles questions", "study.bSummary": "1 résumé du sujet",
      "study.why": "Pourquoi cette session",
      "study.begin": "Commencer la session", "study.customize": "Personnaliser",
      "study.allClearTitle": "Tout est à jour", "study.allClearSub": "Rien à réviser dans cette matière.",
      "study.doTest": "Faire un test",

      "fc.title": "Flashcards", "fc.showAnswer": "Voir la réponse", "fc.answer": "Réponse",
      "fc.tapHint": "Appuie pour voir la réponse", "fc.again": "À revoir", "fc.known": "Je le savais",
      "fc.dontGetIt": "Je ne comprends pas", "fc.explainAi": "Expliquer avec Zynqora AI",
      "fc.doneTitle": "Révision terminée", "fc.doneSub": "{known} sur {total} connues · {again} à revoir bientôt",
      "fc.toTest": "Continuer avec le test", "fc.toDash": "Retour au tableau de bord",

      "test.title": "Test", "test.pick": "Choisis une option", "test.correct": "Correct", "test.incorrect": "Pas tout à fait",
      "test.next": "Suivant", "test.finish": "Voir les résultats", "test.whyFailed": "Pourquoi je me suis trompé ? Demander à Zynqora AI",

      "results.title": "Résultats", "results.score": "score", "results.questions": "questions",
      "results.correct": "correctes", "results.incorrect": "incorrectes",
      "results.mastered": "Concepts maîtrisés", "results.weak": "Concepts faibles",
      "results.understandErrors": "Tu veux comprendre tes erreurs ?", "results.askAi": "Demander à Zynqora AI",
      "results.whatNow": "Qu'est-ce que je devrais étudier maintenant ?", "results.seeRec": "Voir la recommandation",
      "results.backPanel": "Retour au tableau de bord",

      "progress.title": "Progrès", "progress.overall": "Global", "progress.thisSubject": "Cette matière",
      "progress.studyMinutes": "Minutes d'étude", "progress.last14": "14 derniers jours",
      "progress.twoWeeksAgo": "Il y a 2 sem.", "progress.today": "Aujourd'hui",
      "progress.thisWeek": "cette semaine", "progress.currentStreak": "série", "progress.avgMastery": "maîtrise moyenne",
      "progress.sessions": "Sessions", "progress.sessionsSub": "{n} sessions en 14 jours",
      "progress.bySubject": "Par matière", "progress.concepts": "Maîtrise des concepts", "progress.reinforce": "Renforcer",

      "cal.title": "Calendrier", "cal.addTask": "Ajouter une tâche", "cal.noTasks": "Aucune tâche ce jour.",
      "cal.tasksFor": "Tâches · {date}", "cal.newTask": "Nouvelle tâche", "cal.taskTitle": "Titre",
      "cal.subject": "Matière", "cal.type": "Type", "cal.date": "Date", "cal.time": "Heure",
      "cal.typeExercise": "Exercice", "cal.typeReview": "Révision", "cal.typeStudy": "Étude", "cal.typeExam": "Examen",
      "cal.taskDetail": "Détail de la tâche", "cal.markDone": "Marquer comme fait", "cal.done": "Fait",
      "cal.markUndone": "Marquer comme en attente",
      "cal.desc": "Description", "cal.descPh": "Détails, sujets à couvrir…", "cal.descOpt": "Description (facultative)",
      "cal.editTask": "Modifier la tâche", "cal.edit": "Modifier", "cal.delete": "Supprimer",
      "cal.deleteConfirm": "Supprimer cette tâche ? Action irréversible.",
      "cal.taskDeleted": "Tâche supprimée",
      "cal.prepPlanQ": "Tu as un examen le {day}. Tu veux que Zynqora te prépare un plan ?",
      "cal.prepPlan": "Préparer un plan avec Zynqora",

      "plan.title": "Plan recommandé", "plan.for": "Pour : {exam}",
      "plan.intro": "Zynqora a réparti l'étude sur les jours restants avant ton examen.",
      "plan.addToCalendar": "Ajouter le plan au calendrier", "plan.added": "Plan ajouté à ton calendrier",
      "plan.mon": "Lun", "plan.tue": "Mar", "plan.wed": "Mer", "plan.thu": "Jeu", "plan.fri": "Ven",

      "ai.title": "Zynqora AI", "ai.subtitle": "Ton compagnon d'étude",
      "ai.placeholder": "Pose une question sur ce que tu étudies…",
      "ai.demoNote": "Réponses simulées pour le prototype. Le vrai système d'IA se connectera ici.",
      "ai.newConv": "Nouvelle discussion", "ai.yourConvs": "Tes conversations", "ai.noConvs": "Pas encore de conversation.",
      "ai.deleteConv": "Supprimer la conversation", "ai.deleteConvQ": "Supprimer cette conversation ?",
      "ai.deleteConvSub": "Elle sera supprimée définitivement.", "ai.convDeleted": "Conversation supprimée",
      "ai.ctxSubject": "Contexte : {subject}", "ai.ctxDoc": "Contexte : {doc}",
      "ai.ctxSubjectDoc": "Contexte : {subject} · {doc}",
      "ai.ctxFlashcard": "Contexte : flashcard · {t}", "ai.ctxTest": "Contexte : question ratée",
      "ai.ctxResult": "Contexte : ton dernier test de {subject}",
      "ai.attach": "Joindre", "ai.attachPdf": "PDF", "ai.attachDoc": "Document", "ai.attachImage": "Image / photo",
      "ai.ctxAdded": "Contexte ajouté : {name}", "ai.usingContext": "J'ai ajouté {name} au contexte de cette conversation.",
      "ai.sugExplain": "Explique-moi ce concept", "ai.sugSimple": "Explique-le simplement",
      "ai.sugExample": "Donne-moi un exemple", "ai.sugCompare": "Compare deux idées de ce sujet",
      "ai.sugQuiz": "Interroge-moi pour vérifier que j'ai compris",
      "ai.sugWhyFailed": "Pourquoi je me suis trompé sur cette question ?", "ai.sugSummarize": "Résume mes notes",
      "ai.sugImprove": "Comment puis-je m'améliorer ?", "ai.backToConvs": "Conversations",
      "ai.ctxLabel": "Contexte", "ai.ctxNone": "Aucun contexte",
      "ai.tSimple": "Explique-le plus simplement", "ai.tExample": "Donne-moi un exemple", "ai.tQuiz": "Pose-moi une question", "ai.tDeeper": "Approfondir",
      "ai.fAnother": "Un autre exercice", "ai.fHarder": "Plus difficile", "ai.fEasier": "Plus facile", "ai.fCorrect": "Corrige-moi",
      ...
      "accent.violet": "Violet", "accent.blue": "Bleu", "accent.green": "Vert", "accent.pink": "Rose", "accent.orange": "Orange",
      "premium.title": "Zynqora Premium", "premium.sub": "Étudie sans limites.",
      "premium.f1t": "IA illimitée", "premium.f1d": "Génère tous les résumés, flashcards et tests dont tu as besoin.",
      "premium.f2t": "Plans d'examen", "premium.f2d": "Zynqora organise ton étude jour après jour.",
      "premium.f3t": "Statistiques avancées", "premium.f3d": "Analyse en profondeur tes progrès et tes points faibles.",
      "premium.f4t": "Sans publicité", "premium.f4d": "Une expérience claire et concentrée.",
      "premium.cta": "Essayer Premium",
      "study.pTitle": "Personnaliser la session", "study.pSub": "Ajuste cette session d'étude.",
      "study.pMore": "Plus de flashcards", "study.pShorter": "Session plus courte", "study.pTest": "Inclure un test à la fin",
      "study.pApply": "Appliquer les changements",
      "path.title": "Ton parcours d'étude", "path.sub": "Quatre étapes pour maîtriser {topic}.",
      "path.n1t": "Réviser", "path.n1s": "{topic}", "path.n2t": "Pratiquer", "path.n2s": "Concepts clés",
      "path.n3t": "Vérifier", "path.n3s": "Test rapide", "path.n4t": "Maîtriser", "path.n4s": "Révision finale",
      "path.start": "Continuer le parcours", "path.done": "Parcours terminé !", "path.step": "Étape {n} sur 4",
      "mode.title": "Comment veux-tu réviser ?", "mode.sub": "Choisis comment étudier {topic} aujourd'hui.", "mode.rec": "Recommandé",
      "mode.flashcards": "Flashcards", "mode.flashcardsS": "Question et réponse",
      "mode.test": "Test", "mode.testS": "Choix multiple avec feedback",
      "mode.fill": "Complète le mot", "mode.fillS": "Remplis le blanc de la phrase",
      "mode.match": "Associe les concepts", "mode.matchS": "Relie chaque terme à sa définition",
      "mode.explain": "Explique avec tes propres mots", "mode.explainS": "Raconte-le à Zynqora AI",
      "mode.identify": "Identifie le concept", "mode.identifyS": "À quelle idée cela fait-il référence ?",
      "fib.title": "Complète le mot", "fib.check": "Vérifier", "fib.next": "Suivant", "fib.finish": "Terminer",
      "fib.correct": "Correct !", "fib.wrong": "Presque. La réponse était : {a}",
      "rm.matchTitle": "Associe chaque concept à sa définition", "rm.identifyTitle": "À quel concept cette description fait-elle référence ?",
      "rm.explainTitle": "Explique-le avec tes propres mots", "rm.explainPh": "Écris ton explication de {c}…", "rm.explainSend": "Envoyer à Zynqora AI",
      "rm.done": "Exercice terminé", "rm.back": "Retour au parcours",
      "streak.title": "Série de {n} jours !", "streak.sub": "Continue comme ça demain pour ne pas la perdre.",
      "profile.editPhoto": "Modifier le profil", "profile.photoTitle": "Photo de profil", "profile.photoSub": "Choisis une image ou une couleur.",
      "profile.choosePhoto": "Choisir une image", "profile.photoSaved": "Photo mise à jour",
      "profile.editTitle": "Modifier le profil", "profile.editSub": "Ton nom et ta photo sont enregistrés sur cet appareil.",
      "profile.nameLabel": "Nom", "profile.emailLabel": "Email",
      "profile.emailNote": "L'email est remplacé lorsque tu te connectes avec un vrai compte.",
      "profile.photoSection": "Photo", "profile.saved": "Profil mis à jour",
      "settings.notifications": "Notifications", "settings.notifOn": "Activées", "settings.notifOff": "Désactivées",
      "settings.study": "Préférences d'étude", "settings.dailyGoal": "Objectif quotidien",
      "settings.sessionLength": "Durée de session", "settings.short": "Courte", "settings.balanced": "Équilibrée", "settings.long": "Longue",
      "settings.reminders": "Rappel d'étude", "settings.remindersVal": "Tous les jours · 18h00",
      "settings.reminderTime": "Heure du rappel",
      "settings.reminderNote": "Le réglage est enregistré. Le prototype n'envoie pas encore de notifications push.",
      "settings.account": "Compte", "settings.signout": "Se déconnecter", "settings.deleteAccount": "Supprimer le compte",
      "settings.wipeConfirm": "Supprimer toutes tes données sur cet appareil ? Matières, discussions, calendrier et progrès seront effacés. Action irréversible.",
      "settings.wipeDone": "Données supprimées",
      "settings.version": "Zynqora · version prototype", "settings.plan": "Plan", "settings.planFree": "Gratuit",

      "states.firstTitle": "Rien à étudier pour l'instant",
      "states.firstSub": "Ajoute ton premier contenu et Zynqora préparera ton plan d'étude en moins d'une minute.",
      "states.howItWorks": "Comment ça marche",
      "states.hiw1t": "Ajoute ton contenu", "states.hiw1d": "PDF, document, photo ou texte",
      "states.hiw2t": "Zynqora le comprend", "states.hiw2d": "Résumé, flashcards et questions",
      "states.hiw3t": "Étudie avec concentration", "states.hiw3d": "On te dit quoi réviser chaque jour",
      "states.errorTitle": "Impossible de charger ton tableau de bord",
      "states.errorSub": "Vérifie ta connexion. Tes données sont en sécurité.", "states.retry": "Réessayer"
    },
    pt: {
      "proto.mobile": "Telemóvel", "proto.tablet": "Tablet", "proto.desktop": "Ambiente de trabalho",
      "proto.screens": "Ecrãs", "proto.hide": "Ocultar", "proto.reveal": "Mostrar controlos",
      "proto.demoNote": "Protótipo · dados simulados, sem ligação real",

      "menu.welcome": "Boas-vindas", "menu.app": "Aplicação", "menu.states": "Estados",
      "menu.landing": "Landing", "menu.onboarding": "Onboarding", "menu.dashboard": "Painel · Hoje",
      "menu.subjects": "As minhas disciplinas", "menu.subject": "Detalhe da disciplina", "menu.notes": "Os meus apontamentos",
      "menu.addMaterial": "Adicionar material", "menu.analysis": "Análise do material",
      "menu.document": "Material do documento", "menu.path": "Caminho de estudo", "menu.study": "Modos de revisão", "menu.fill": "Completa a palavra",
      "menu.flashcards": "Flashcards", "menu.test": "Teste", "menu.results": "Resultados",
      "menu.progress": "Progresso", "menu.calendar": "Calendário", "menu.plan": "Plano recomendado",
      "menu.ai": "Zynqora AI", "menu.settings": "Definições",
      "menu.stFirst": "Painel · primeira vez", "menu.stEmptyNotes": "Apontamentos · vazio",
      "menu.stAllclear": "Estudo · sem revisões", "menu.stError": "Erro de ligação",

      "nav.today": "Hoje", "nav.subjects": "Disciplinas", "nav.notes": "Apontamentos",
      "nav.calendar": "Calendário", "nav.progress": "Progresso", "nav.profile": "Perfil", "nav.ai": "Zynqora AI",

      "common.continue": "Continuar", "common.back": "Voltar", "common.next": "Seguinte",
      "common.prev": "Anterior", "common.skip": "Saltar", "common.save": "Guardar", "common.cancel": "Cancelar",
      "common.add": "Adicionar", "common.min": "min", "common.minutes": "minutos", "common.seeAll": "Ver tudo",
      "common.demoAction": "Ação de demonstração", "common.close": "Fechar", "common.optional": "opcional",
      "common.today": "Hoje", "common.tomorrow": "Amanhã",
      "err.subjectName": "Escreve um nome para a disciplina.",
      "err.taskTitle": "Escreve um título para a tarefa.",
      "err.profName": "O nome não pode estar vazio.",
      "err.badEmail": "Introduz um email válido.",
      "subj.langQ": "Disciplina de idioma? (opcional)", "subj.langNo": "Não",
      "subj.langNote": "A IA e as revisões desta disciplina serão em {lang}.",

      "landing.signin": "Iniciar sessão", "landing.badge": "Estudo com inteligência",
      "landing.title": "Sabe o que estudar antes de abrires o livro.",
      "landing.sub": "Carrega o teu material. A Zynqora percebe-o, cria o teu conteúdo de estudo e diz-te exatamente o que rever hoje.",
      "landing.cta": "Começar grátis", "landing.demo": "Ver demonstração",
      "landing.note": "Sem cartão. Web, iOS e Android com uma só conta.",
      "landing.f1t": "A partir do teu material", "landing.f1d": "PDFs, apontamentos, fotos e texto tornam-se material estruturado.",
      "landing.f2t": "Repetição espaçada", "landing.f2d": "O sistema decide quando rever cada conceito.",
      "landing.f3t": "Foco diário", "landing.f3d": "Uma recomendação clara todos os dias, não um painel de números.",
      "landing.footer": "© 2026 Zynqora · Protótipo de design",

      "ob.step": "Passo {n} de {total}", "ob.nameLabel": "Nome da disciplina",
      "ob.welcomeTitle": "Bem-vindo à Zynqora", "ob.welcomeSub": "Vamos personalizar a tua experiência. Vai demorar menos de um minuto.",
      "ob.welcomeStart": "Começar",
      "ob.qHow": "Como conheceste a Zynqora?",
      "ob.howFriend": "Um amigo", "ob.howTiktok": "TikTok", "ob.howInsta": "Instagram", "ob.howYoutube": "YouTube",
      "ob.howGoogle": "Google / Internet", "ob.howOther": "Outra forma",
      "ob.qGoal": "O que queres alcançar com a Zynqora?", "ob.qGoalSub": "Podes escolher várias.",
      "ob.goalGrades": "Melhorar as minhas notas", "ob.goalOrganise": "Organizar melhor o meu estudo", "ob.goalExams": "Preparar exames",
      "ob.goalUnderstand": "Compreender melhor as minhas disciplinas", "ob.goalTime": "Poupar tempo a estudar", "ob.goalHabit": "Criar um hábito de estudo",
      "ob.qLevel": "O que estudas?",
      "ob.lvlEso": "Ensino básico", "ob.lvlBach": "Ensino secundário", "ob.lvlUniv": "Universidade", "ob.lvlFp": "Formação profissional", "ob.lvlOtro": "Outro",
      "ob.qFirst": "O que queres estudar primeiro?", "ob.qFirstSub": "Escolhe uma disciplina ou cria uma nova.",
      "ob.createNew": "Criar uma nova disciplina", "ob.newNamePh": "Nome da disciplina",
      "ob.readyTitle": "Perfeito. A Zynqora está pronta para ti.", "ob.readySub": "Já podes começar a estudar de forma mais inteligente.",
      "ob.readyStart": "Começar",

      "greet.morning": "Bom dia", "greet.afternoon": "Boa tarde", "greet.evening": "Boa noite",

      "dash.nextStep": "O teu próximo passo", "dash.reason": "Com base no que precisas de reforçar.",
      "dash.reviewTopic": "Rever {topic}", "dash.studyWeak": "Estudar {topic}",
      "dash.startSession": "Começar", "dash.estimated": "{n} min estimados",
      "dash.reviews": "revisões", "dash.weak": "conceitos fracos", "dash.streak": "dias seguidos",
      "dash.todayProgress": "Progresso de hoje", "dash.goalLeft": "Faltam-te {n} min para o teu objetivo.",
      "dash.goalDone": "Objetivo de hoje alcançado. Bom trabalho.",
      "dash.upcoming": "Próximas tarefas", "dash.nextExam": "Próximo exame", "dash.inDays": "em {n} dias",
      "dash.weakTitle": "Conceitos que precisam de reforço",
      "dash.lastTest": "Último teste", "dash.lastTestSub": "{score}/{total} em {topic}",
      "dash.askAiCard": "Pergunta à Zynqora AI sobre o que estás a estudar.",
      "dash.open": "Abrir", "dash.prepPlan": "Queres que a Zynqora te prepare um plano?",
      "dash.seePlan": "Ver plano recomendado",

      "subjects.title": "As minhas disciplinas", "subjects.add": "Adicionar disciplina", "subjects.switchTo": "Mudar de disciplina",
      "subjects.docs": "documentos", "subjects.doc1": "documento", "subjects.mastery": "{n}% de domínio", "subjects.empty": "Sem disciplinas",
      "subjects.emptySub": "Cria a tua primeira disciplina para começar a organizar o teu estudo.",
      "subjects.newTitle": "Nova disciplina", "subjects.newSub": "Dá-lhe um nome, um ícone e uma cor.",
      "subjects.icon": "Ícone", "subjects.color": "Cor", "subjects.namePlaceholder": "História",

      "subject.overall": "Domínio geral",
      "tab.docs": "Documentos", "tab.flashcards": "Flashcards", "tab.tests": "Testes", "tab.progress": "Progresso", "tab.weak": "Pontos fracos",
      "subject.noDocs": "Ainda não há documentos nesta disciplina.", "subject.addMaterial": "Adicionar material",
      "subject.studyNow": "Estudar agora", "subject.startTest": "Fazer um teste", "subject.reviewCards": "Rever flashcards",
      "subject.cardsCount": "{n} flashcards", "subject.testsCount": "{n} testes realizados",
      "subject.weakList": "Conceitos fracos desta disciplina", "subject.noWeak": "Nenhum conceito fraco detetado.",
      "subject.sessions": "Sessões de estudo", "subject.lastSession": "Última sessão: há {n} dias",

      "notes.title": "Os meus apontamentos", "notes.addMaterial": "Adicionar material",
      "notes.sub": "Todo o teu material de estudo, organizado por disciplina.",
      "notes.docsIn": "em {subject}", "notes.pages": "páginas", "notes.ready": "Pronto", "notes.analyzing": "A analisar",
      "notes.open": "Abrir", "notes.askAi": "Perguntar à Zynqora AI",
      "notes.emptyTitle": "Ainda não adicionaste material",
      "notes.emptySub": "Carrega um PDF, um documento, uma foto ou escreve uma nota. A Zynqora transforma-o em material de estudo.",

      "add.title": "Adicionar material", "add.sub": "Que tipo de material queres adicionar a {subject}?",
      "add.pdf": "PDF", "add.pdfSub": "Apontamentos, programa ou esquemas em PDF",
      "add.doc": "Documento", "add.docSub": "Word, Google Docs ou semelhante",
      "add.image": "Imagem ou foto", "add.imageSub": "Foto de apontamentos ou quadro",
      "add.text": "Texto", "add.textSub": "Escreve ou cola os teus apontamentos",
      "add.sourceTitle": "Escolhe o ficheiro", "add.sourceSub": "Seleciona um ficheiro ou usa um exemplo",
      "add.choose": "Selecionar ficheiro", "add.example": "Usar documento de exemplo",
      "add.exampleNote": "O protótipo não processa ficheiros reais. Usa o exemplo para ver o fluxo completo.",
      "add.selected": "Selecionado", "add.analyze": "Analisar material", "add.remove": "Remover",
      "add.textPlaceholder": "Escreve ou cola aqui os teus apontamentos…", "add.demoFileNote": "Simulado — não é carregado nem lido nenhum conteúdo real.",

      "analysis.title": "Análise", "analysis.working": "A analisar material…",
      "analysis.s1": "A ler o documento", "analysis.s2": "A identificar o conteúdo",
      "analysis.s3": "A detetar conceitos importantes", "analysis.s4": "A localizar áreas que precisam de reforço",
      "analysis.readyTitle": "O teu material está pronto",
      "analysis.readySub": "A Zynqora percebeu o teu material e preparou o conteúdo de estudo.",
      "analysis.mConcepts": "conceitos detetados", "analysis.mDifficulty": "dificuldade estimada",
      "analysis.mTopics": "temas principais", "analysis.mReadTime": "min de leitura",
      "analysis.mainConcepts": "Conceitos importantes", "analysis.weakAreas": "Áreas que precisam de reforço",
      "analysis.viewSummary": "Ver resumo", "analysis.makeFlashcards": "Criar flashcards",
      "analysis.makeTest": "Criar teste", "analysis.makeSession": "Criar sessão de estudo", "analysis.askAi": "Perguntar à Zynqora AI",
      "diff.easy": "Baixa", "diff.med": "Média", "diff.hard": "Alta",

      "document.title": "Material", "document.summary": "Resumo", "document.readFull": "Ler resumo completo",
      "document.structured": "Conteúdo estruturado", "document.generated": "Material gerado",
      "document.study": "Estudar isto", "document.createSession": "Criar sessão de estudo",
      "document.flashcardsN": "{n} flashcards", "document.questionsN": "{n} perguntas", "document.summaryN": "1 resumo",
      "document.ready": "Pronto a estudar", "document.aiAnalysis": "Análise da Zynqora", "document.askAi": "Perguntar à Zynqora AI sobre este material",

      "doc.status.pending": "Pendente", "doc.status.processing": "A processar", "doc.status.analyzed": "Analisado", "doc.status.failed": "Não foi possível analisar",
      "doc.realBadge": "Conteúdo do ficheiro real", "doc.localBadge": "Gerado localmente a partir do texto real", "doc.exampleBadge": "Conteúdo de exemplo",
      "doc.wordsN": "{n} palavras", "doc.charsN": "{n} carateres", "doc.noText": "Sem texto extraído",
      "doc.detailTitle": "Documento", "doc.meta.type": "Tipo", "doc.meta.size": "Tamanho", "doc.meta.date": "Data", "doc.meta.subject": "Disciplina", "doc.meta.status": "Estado", "doc.meta.source": "Origem do texto",
      "doc.content": "Conteúdo extraído", "doc.contentMore": "Ver todo o texto", "doc.contentLess": "Ver menos",
      "doc.summarySection": "Resumo", "doc.conceptsSection": "Conceitos principais", "doc.keyPoints": "Pontos importantes",
      "doc.changeSubject": "Mudar disciplina", "doc.startReview": "Começar revisão", "doc.delete": "Eliminar documento",
      "doc.deleteQ": "Eliminar este documento?", "doc.deleteSub": "O seu resumo, flashcards e sessões também serão eliminados. Não afeta outros documentos.",
      "doc.deleted": "Documento eliminado", "doc.genSummary": "Gerar resumo", "doc.regen": "Regenerar",
      "doc.ocrPending": "Imagem guardada — o texto será lido por OCR quando o servidor for ligado.",
      "doc.attach": "Anexar à Zynqora AI", "doc.fromDoc": "Com base em: {name}",
      "an.reading": "A ler o ficheiro", "an.extracting": "A extrair o conteúdo", "an.analyzing": "A analisar o texto", "an.preparing": "A preparar o teu material",
      "an.failedTitle": "Não foi possível ler o conteúdo", "an.pendingTitle": "Imagem guardada",
      "an.textOk": "Texto extraído · {n} palavras", "an.keepAnyway": "Guardar mesmo assim",
      "add.chooseSub": "Arrasta um ficheiro para aqui ou seleciona-o. TXT e PDF são lidos no navegador; as imagens são guardadas para OCR.",
      "add.dropHere": "Larga o ficheiro", "add.pasteReal": "O texto que colas é lido e realmente usado.",

      "study.title": "Sessão de estudo", "study.recommended": "Recomendado para hoje",
      "study.about": "Cerca de {n} minutos", "study.includes": "Inclui",
      "study.bReviews": "{n} flashcards de revisão", "study.bQuestions": "{n} perguntas novas", "study.bSummary": "1 resumo do tema",
      "study.why": "Porquê esta sessão",
      "study.begin": "Começar sessão", "study.customize": "Personalizar",
      "study.allClearTitle": "Tudo em dia", "study.allClearSub": "Não tens revisões pendentes nesta disciplina.",
      "study.doTest": "Fazer um teste",

      "fc.title": "Flashcards", "fc.showAnswer": "Ver resposta", "fc.answer": "Resposta",
      "fc.tapHint": "Toca para ver a resposta", "fc.again": "Preciso de rever", "fc.known": "Já sabia",
      "fc.dontGetIt": "Não percebo", "fc.explainAi": "Explicar com a Zynqora AI",
      "fc.doneTitle": "Revisão concluída", "fc.doneSub": "{known} de {total} sabidas · {again} para rever em breve",
      "fc.toTest": "Continuar com o teste", "fc.toDash": "Voltar ao painel",

      "test.title": "Teste", "test.pick": "Escolhe uma opção", "test.correct": "Correto", "test.incorrect": "Não é bem isso",
      "test.next": "Seguinte", "test.finish": "Ver resultados", "test.whyFailed": "Porque é que errei? Perguntar à Zynqora AI",

      "results.title": "Resultados", "results.score": "pontuação", "results.questions": "perguntas",
      "results.correct": "corretas", "results.incorrect": "incorretas",
      "results.mastered": "Conceitos dominados", "results.weak": "Conceitos fracos",
      "results.understandErrors": "Queres perceber os teus erros?", "results.askAi": "Perguntar à Zynqora AI",
      "results.whatNow": "O que devo estudar agora?", "results.seeRec": "Ver recomendação",
      "results.backPanel": "Voltar ao painel",

      "progress.title": "Progresso", "progress.overall": "Geral", "progress.thisSubject": "Esta disciplina",
      "progress.studyMinutes": "Minutos de estudo", "progress.last14": "Últimos 14 dias",
      "progress.twoWeeksAgo": "Há 2 sem.", "progress.today": "Hoje",
      "progress.thisWeek": "esta semana", "progress.currentStreak": "sequência", "progress.avgMastery": "domínio médio",
      "progress.sessions": "Sessões", "progress.sessionsSub": "{n} sessões em 14 dias",
      "progress.bySubject": "Por disciplina", "progress.concepts": "Domínio de conceitos", "progress.reinforce": "Reforçar",

      "cal.title": "Calendário", "cal.addTask": "Adicionar tarefa", "cal.noTasks": "Sem tarefas neste dia.",
      "cal.tasksFor": "Tarefas · {date}", "cal.newTask": "Nova tarefa", "cal.taskTitle": "Título",
      "cal.subject": "Disciplina", "cal.type": "Tipo", "cal.date": "Data", "cal.time": "Hora",
      "cal.typeExercise": "Exercício", "cal.typeReview": "Revisão", "cal.typeStudy": "Estudo", "cal.typeExam": "Exame",
      "cal.taskDetail": "Detalhe da tarefa", "cal.markDone": "Marcar como feita", "cal.done": "Feita",
      "cal.markUndone": "Marcar como pendente",
      "cal.desc": "Descrição", "cal.descPh": "Detalhes, temas a abordar…", "cal.descOpt": "Descrição (opcional)",
      "cal.editTask": "Editar tarefa", "cal.edit": "Editar", "cal.delete": "Eliminar",
      "cal.deleteConfirm": "Eliminar esta tarefa? Não é possível desfazer.",
      "cal.taskDeleted": "Tarefa eliminada",
      "cal.prepPlanQ": "Tens um exame a {day}. Queres que a Zynqora te prepare um plano?",
      "cal.prepPlan": "Preparar plano com a Zynqora",

      "plan.title": "Plano recomendado", "plan.for": "Para: {exam}",
      "plan.intro": "A Zynqora distribuiu o estudo pelos dias que faltam até ao teu exame.",
      "plan.addToCalendar": "Adicionar o plano ao calendário", "plan.added": "Plano adicionado ao teu calendário",
      "plan.mon": "Seg", "plan.tue": "Ter", "plan.wed": "Qua", "plan.thu": "Qui", "plan.fri": "Sex",

      "ai.title": "Zynqora AI", "ai.subtitle": "O teu companheiro de estudo",
      "ai.placeholder": "Pergunta sobre o que estás a estudar…",
      "ai.demoNote": "Respostas simuladas para o protótipo. Aqui liga-se o sistema de IA real.",
      "ai.newConv": "Nova conversa", "ai.yourConvs": "As tuas conversas", "ai.noConvs": "Ainda não há conversas.",
      "ai.deleteConv": "Eliminar conversa", "ai.deleteConvQ": "Eliminar esta conversa?",
      "ai.deleteConvSub": "Será eliminada para sempre.", "ai.convDeleted": "Conversa eliminada",
      "ai.ctxSubject": "Contexto: {subject}", "ai.ctxDoc": "Contexto: {doc}",
      "ai.ctxSubjectDoc": "Contexto: {subject} · {doc}",
      "ai.ctxFlashcard": "Contexto: flashcard · {t}", "ai.ctxTest": "Contexto: pergunta errada",
      "ai.ctxResult": "Contexto: o teu último teste de {subject}",
      "ai.attach": "Anexar", "ai.attachPdf": "PDF", "ai.attachDoc": "Documento", "ai.attachImage": "Imagem / foto",
      "ai.ctxAdded": "Contexto adicionado: {name}", "ai.usingContext": "Adicionei {name} ao contexto desta conversa.",
      "ai.sugExplain": "Explica-me este conceito", "ai.sugSimple": "Explica-mo de forma simples",
      "ai.sugExample": "Dá-me um exemplo", "ai.sugCompare": "Compara duas ideias deste tema",
      "ai.sugQuiz": "Pergunta-me para verificar se percebi",
      "ai.sugWhyFailed": "Porque errei esta pergunta?", "ai.sugSummarize": "Resume os meus apontamentos",
      "ai.sugImprove": "Como posso melhorar?", "ai.backToConvs": "Conversas",
      "ai.ctxLabel": "Contexto", "ai.ctxNone": "Sem contexto",
      "ai.tSimple": "Explica-mo mais fácil", "ai.tExample": "Dá-me um exemplo", "ai.tQuiz": "Faz-me uma pergunta", "ai.tDeeper": "Aprofundar",
      "ai.fAnother": "Outro exercício", "ai.fHarder": "Mais difícil", "ai.fEasier": "Mais fácil", "ai.fCorrect": "Corrige-me",

      "settings.title": "Definições", "settings.language": "Idioma", "settings.theme": "Tema",
      "settings.themeLight": "Claro", "settings.themeDark": "Escuro", "settings.themeAuto": "Sistema",
      "settings.accent": "Cor de destaque",
      "accent.violet": "Violeta", "accent.blue": "Azul", "accent.green": "Verde", "accent.pink": "Rosa", "accent.orange": "Laranja",
      "premium.title": "Zynqora Premium", "premium.sub": "Estuda sem limites.",
      "premium.f1t": "IA sem limites", "premium.f1d": "Gera todos os resumos, flashcards e testes de que precisares.",
      "premium.f2t": "Planos de exame", "premium.f2d": "A Zynqora organiza o teu estudo dia a dia.",
      "premium.f3t": "Estatísticas avançadas", "premium.f3d": "Analisa a fundo o teu progresso e os teus pontos fracos.",
      "premium.f4t": "Sem anúncios", "premium.f4d": "Uma experiência limpa e focada.",
      "premium.cta": "Experimentar Premium",
      "study.pTitle": "Personalizar sessão", "study.pSub": "Ajusta esta sessão de estudo.",
      "study.pMore": "Mais flashcards", "study.pShorter": "Sessão mais curta", "study.pTest": "Incluir teste no final",
      "study.pApply": "Aplicar alterações",
      "path.title": "O teu caminho de estudo", "path.sub": "Quatro passos para dominares {topic}.",
      "path.n1t": "Rever", "path.n1s": "{topic}", "path.n2t": "Praticar", "path.n2s": "Conceitos-chave",
      "path.n3t": "Verificar", "path.n3s": "Teste rápido", "path.n4t": "Dominar", "path.n4s": "Revisão final",
      "path.start": "Continuar o caminho", "path.done": "Caminho concluído!", "path.step": "Passo {n} de 4",
      "mode.title": "Como queres rever?", "mode.sub": "Escolhe como estudar {topic} hoje.", "mode.rec": "Recomendado",
      "mode.flashcards": "Flashcards", "mode.flashcardsS": "Pergunta e resposta",
      "mode.test": "Teste", "mode.testS": "Escolha múltipla com feedback",
      "mode.fill": "Completa a palavra", "mode.fillS": "Preenche o espaço na frase",
      "mode.match": "Relaciona conceitos", "mode.matchS": "Une cada termo à sua definição",
      "mode.explain": "Explica por palavras tuas", "mode.explainS": "Conta à Zynqora AI",
      "mode.identify": "Identifica o conceito", "mode.identifyS": "A que ideia se refere?",
      "fib.title": "Completa a palavra", "fib.check": "Verificar", "fib.next": "Seguinte", "fib.finish": "Terminar",
      "fib.correct": "Correto!", "fib.wrong": "Quase. A resposta era: {a}",
      "rm.matchTitle": "Relaciona cada conceito com a sua definição", "rm.identifyTitle": "A que conceito se refere esta descrição?",
      "rm.explainTitle": "Explica por palavras tuas", "rm.explainPh": "Escreve a tua explicação de {c}…", "rm.explainSend": "Enviar à Zynqora AI",
      "rm.done": "Exercício concluído", "rm.back": "Voltar ao caminho",
      "streak.title": "Sequência de {n} dias!", "streak.sub": "Continua assim amanhã para não a perderes.",
      "profile.editPhoto": "Editar perfil", "profile.photoTitle": "Foto de perfil", "profile.photoSub": "Escolhe uma imagem ou uma cor.",
      "profile.choosePhoto": "Escolher imagem", "profile.photoSaved": "Foto atualizada",
      "profile.editTitle": "Editar perfil", "profile.editSub": "O teu nome e foto são guardados neste dispositivo.",
      "profile.nameLabel": "Nome", "profile.emailLabel": "Email",
      "profile.emailNote": "O email é substituído ao iniciar sessão com uma conta real.",
      "profile.photoSection": "Foto", "profile.saved": "Perfil atualizado",
      "settings.notifications": "Notificações", "settings.notifOn": "Ativadas", "settings.notifOff": "Desativadas",
      "settings.study": "Preferências de estudo", "settings.dailyGoal": "Objetivo diário",
      "settings.sessionLength": "Duração da sessão", "settings.short": "Curta", "settings.balanced": "Equilibrada", "settings.long": "Longa",
      "settings.reminders": "Lembrete de estudo", "settings.remindersVal": "Todos os dias · 18:00",
      "settings.reminderTime": "Hora do lembrete",
      "settings.reminderNote": "A definição é guardada. O protótipo ainda não envia notificações push.",
      "settings.account": "Conta", "settings.signout": "Terminar sessão", "settings.deleteAccount": "Eliminar conta",
      "settings.wipeConfirm": "Eliminar todos os teus dados deste dispositivo? Disciplinas, conversas, calendário e progresso serão apagados. Não é possível desfazer.",
      "settings.wipeDone": "Dados eliminados",
      "settings.version": "Zynqora · versão protótipo", "settings.plan": "Plano", "settings.planFree": "Grátis",

      "states.firstTitle": "Ainda não há nada para estudar",
      "states.firstSub": "Adiciona o teu primeiro material e a Zynqora prepara o teu plano de estudo em menos de um minuto.",
      "states.howItWorks": "Como funciona",
      "states.hiw1t": "Adiciona o teu material", "states.hiw1d": "PDF, documento, foto ou texto",
      "states.hiw2t": "A Zynqora percebe-o", "states.hiw2d": "Resumo, flashcards e perguntas",
      "states.hiw3t": "Estuda com foco", "states.hiw3d": "Dizemos-te o que rever todos os dias",
      "states.errorTitle": "Não foi possível carregar o teu painel",
      "states.errorSub": "Verifica a tua ligação. Os teus dados estão seguros.", "states.retry": "Tentar novamente"
    }
  };

  /* ---- Fase 1.0 strings (plans, limits, policies, AI tools) ---- */
  (function (P) {
    APP_LANGS.forEach(function (L) { for (var k in (P[L] || {})) { I18N[L] = I18N[L] || {}; I18N[L][k] = P[L][k]; } });
  })({
    es: {
    ...
    it: {
      "menu.plans": "Piani", "menu.checkout": "Checkout (demo)", "menu.policies": "Politiche", "menu.aitools": "Strumenti IA",
      "menu.policiesFull": "Politiche e condizioni",
      "plan.free": "Zynqora Free", "plan.plus": "Zynqora Plus", "plan.pro": "Zynqora Pro",
      "plan.freeShort": "Free", "plan.plusShort": "Plus", "plan.proShort": "Pro",
      "plans.title": "Scegli come vuoi studiare", "plans.sub": "Inizia gratis e passa a un piano superiore quando ti serve di più.",
      "plan.forever": "Sempre gratis",
      "plans.monthly": "Mensile", "plans.annual": "Annuale",
      "plans.perMonth": "/mese", "plans.perYear": "/anno", "plans.free0": "0 €",
      "plans.save": "Risparmi il {pct}% rispetto al pagamento mensile",
      "plans.popular": "Più popolare", "plans.proTag": "Esperienza IA avanzata",
      "plans.proSub": "Per studenti che vogliono sfruttare Zynqora al massimo",
      "plans.current": "Il tuo piano attuale", "plans.choose": "Scegli {plan}",
      "plans.downgrade": "Passa a Free", "plans.cta": "Passa a un piano superiore", "plans.manage": "Gestisci piano",
      "plans.noAds": "Senza pubblicità. Solo tu, i tuoi studi e Zynqora.",
      "feat.aiMessages": "Messaggi a Zynqora AI", "feat.files": "File da studiare",
      "feat.tests": "Test generati", "feat.flashcards": "Flashcard generate",
      "feat.podcasts": "Podcast IA", "feat.presentations": "Presentazioni IA",
      "feat.conceptMaps": "Mappe concettuali IA", "feat.subjects": "Materie",
      "feat.perMonth": "{n} al mese", "feat.unlimited": "Senza limiti", "feat.none": "Non incluso", "feat.persBasic": "Colori base",
      "usage.title": "Il tuo piano", "usage.resets": "I limiti si rinnovano ogni mese.",
      "usage.reached": "Hai raggiunto il limite di questa funzione nel tuo piano.",
      "usage.atLimit": "limite raggiunto",
      "up.title": "Hai raggiunto il limite del piano Free",
      "up.body": "Puoi continuare a studiare con Zynqora passando a un piano superiore.",
      "up.usedFeature": "Hai usato i tuoi {limit} {feature} di questo mese.",
      "up.plusOffer": "Passa a Plus per avere fino a {n} {feature} al mese.",
      "short.aiMessages": "messaggi IA", "short.files": "file", "short.tests": "test", "short.flashcards": "flashcard",
      "up.subjectsUsed": "Il tuo piano Free include {limit} materie.",
      "up.subjectsOffer": "Passa a Plus per avere fino a {n} materie.",
      "up.toPlus": "Passa a Plus", "up.seeAll": "Vedi tutti i piani", "up.notNow": "Non ora",
      "fm.podcastT": "Trasforma i tuoi appunti in un podcast",
      "fm.presentationT": "Trasforma i tuoi appunti in una presentazione",
      "fm.conceptMapT": "Trasforma i tuoi appunti in una mappa concettuale",
      "fm.personalizationT": "Più opzioni di personalizzazione",
      "fm.availPlus": "Questa funzione è disponibile su Zynqora Plus e Pro.",
      "fm.seePlans": "Vedi i piani",
      "co.title": "Checkout dimostrativo", "co.plan": "Piano", "co.total": "Totale",
      "co.name": "Nome", "co.email": "Email", "co.payment": "Metodo di pagamento",
      "co.paymentDemo": "Pagamento dimostrativo — non viene elaborato alcun addebito reale.",
      "co.card": "Carta (demo)", "co.confirm": "Conferma abbonamento",
      "co.note": "Checkout dimostrativo. Non viene richiesto né elaborato alcun dato bancario reale.",
      "co.welcome": "Benvenuto su {plan}! ✨",
      "co.welcomeSub": "Il tuo piano dimostrativo è attivo. Puoi tornare a Free quando vuoi dal tuo profilo.",
      "co.start": "Inizia", "co.cancelAnytime": "Puoi annullare il rinnovo in qualsiasi momento.",
      "tools.title": "Strumenti di studio IA", "tools.sub": "Trasforma il tuo materiale in nuovi formati.",
      "tools.podcast": "Crea podcast", "tools.podcastS": "Ascolta i tuoi appunti come un episodio.",
      "tools.presentation": "Crea presentazione", "tools.presentationS": "Genera diapositive dal tuo materiale.",
      "tools.conceptMap": "Crea mappa concettuale", "tools.conceptMapS": "Visualizza come si collegano le idee.",
      "tf.source": "Materiale", "tf.style": "Stile", "tf.preview": "Anteprima",
      "tf.generate": "Genera", "tf.edit": "Modifica", "tf.export": "Esporta",
      "tf.step": "Passo {n} di {total}",
      "tf.demoPreview": "Anteprima dimostrativa. La generazione reale verrà collegata più avanti.",
      "tf.podcastStyle1": "Conversazione (2 voci)", "tf.podcastStyle2": "Narrazione (1 voce)",
      "tf.presStyle1": "Minimalista", "tf.presStyle2": "Visivo",
      "tf.mapStyle1": "Radiale", "tf.mapStyle2": "Gerarchico",
      "pol.title": "Politiche e condizioni",
      "pol.sub": "Tutto quello che devi sapere su Zynqora, spiegato in modo chiaro e trasparente.",
      "pol.nutshell": "In poche parole",
      "pol.nut1t": "Cancellazione", "pol.nut1d": "Gli abbonamenti possono essere cancellati per evitare rinnovi futuri.",
      "pol.nut2t": "Rinnovo", "pol.nut2d": "Le condizioni di rinnovo vengono mostrate prima dell'abbonamento.",
      "pol.nut3t": "Rimborsi", "pol.nut3d": "Le condizioni applicabili vengono mostrate prima dell'acquisto.",
      "pol.nut4t": "Privacy", "pol.nut4d": "I dati vengono trattati in conformità con l'Informativa sulla Privacy.",
      "pol.nut5t": "IA", "pol.nut5d": "Zynqora AI è uno strumento di supporto allo studio e le sue risposte possono contenere errori.",
      "pol.adsTitle": "Senza pubblicità",
      "pol.adsBody": "Senza pubblicità. Solo tu, i tuoi studi e Zynqora. Zynqora non utilizza pubblicità all'interno dell'app in nessuno dei suoi piani: niente banner, niente pubblicità tra un esercizio e l'altro e niente annunci invasivi.",
      "pol.disclaimer": "Questo testo è una bozza di prodotto. Le condizioni definitive dovranno essere adattate alla legislazione applicabile prima del lancio commerciale. I diritti legali del consumatore prevalgono quando applicabili.",
      "pol.s01t": "Scopo di Zynqora", "pol.s01b": "Zynqora è uno strumento digitale di supporto allo studio che aiuta a organizzare i materiali, generare contenuti di ripasso (riassunti, flashcard, test) e pianificare l'apprendimento.",
      "pol.s02t": "Accettazione delle condizioni", "pol.s02b": "Creando un account o utilizzando Zynqora, l'utente accetta queste condizioni. Se non è d'accordo, non deve utilizzare il servizio.",
      "pol.s03t": "Account utente", "pol.s03b": "L'utente è responsabile di mantenere riservate le proprie credenziali e dell'attività svolta dal proprio account.",
      "pol.s04t": "Piani e servizi", "pol.s04b": "Zynqora offre un piano gratuito e piani a pagamento (Plus e Pro) con diversi limiti d'uso. Le funzioni di ciascun piano possono evolversi.",
      "pol.s05t": "Prezzi e pagamenti", "pol.s05b": "I prezzi vengono mostrati prima dell'abbonamento, comprese le imposte applicabili quando pertinenti. Gli importi di questa versione sono indicativi.",
      "pol.s06t": "Pagamenti e fornitori", "pol.s06b": "Quando saranno abilitati i pagamenti reali, verranno elaborati tramite fornitori di pagamento esterni. Zynqora non memorizza i dati completi delle carte.",
      "pol.s07t": "Abbonamenti e rinnovo", "pol.s07b": "Gli abbonamenti a pagamento si rinnovano per periodi equivalenti salvo cancellazione. Le condizioni di rinnovo vengono mostrate prima dell'abbonamento.",
      "pol.s08t": "Cancellazione", "pol.s08b": "L'utente può cancellare il rinnovo in qualsiasi momento dal proprio profilo. L'accesso a pagamento rimane attivo fino alla fine del periodo già pagato.",
      "pol.s09t": "Rimborsi", "pol.s09b": "Le condizioni di rimborso applicabili vengono mostrate prima dell'acquisto. Per alcuni piani potrà esistere una garanzia commerciale di soddisfazione di 30 minuti, soggetta alle condizioni applicabili. I diritti legali del consumatore prevalgono quando applicabili.",
      "pol.s10t": "Prove e promozioni", "pol.s10b": "Zynqora può offrire periodi di prova o promozioni con condizioni specifiche, comunicate di volta in volta.",
      "pol.s11t": "Privacy e protezione dei dati", "pol.s11b": "I dati personali vengono trattati in conformità con l'Informativa sulla Privacy, che descrive finalità, basi giuridiche e diritti.",
      "pol.s12t": "Dati trattati", "pol.s12b": "Zynqora può trattare dati dell'account, dati di utilizzo del servizio e i contenuti che l'utente decide di caricare per utilizzare le funzioni di studio.",
      "pol.s13t": "Uso dei dati", "pol.s13b": "I dati vengono utilizzati per fornire il servizio, migliorarlo, offrire assistenza e adempiere agli obblighi legali. Non vengono venduti a terzi.",
      "pol.s14t": "Sicurezza", "pol.s14b": "Zynqora applica misure tecniche e organizzative ragionevoli per proteggere le informazioni. Nessun sistema è completamente infallibile.",
      "pol.s15t": "Fornitori esterni", "pol.s15b": "Zynqora si appoggia a fornitori di infrastruttura, intelligenza artificiale e analisi necessari per fornire il servizio, soggetti ai relativi accordi sul trattamento dei dati.",
      "pol.s16t": "Diritti dell'utente", "pol.s16b": "L'utente può accedere, rettificare, eliminare e portare i propri dati, nonché opporsi o limitare determinati trattamenti, secondo la normativa applicabile.",
      "pol.s17t": "File e contenuti dell'utente", "pol.s17b": "L'utente può caricare materiali di studio (PDF, documenti, immagini o testo) per utilizzare le funzioni di Zynqora. L'utente dichiara di avere il diritto di utilizzare tali materiali. Per fornire il servizio, i file potranno essere elaborati dai fornitori tecnologici necessari quando l'architettura reale lo richieda. Le condizioni dettagliate saranno riportate nell'Informativa sulla Privacy.",
      "pol.s18t": "Zynqora AI e contenuti generati", "pol.s18b": "Zynqora AI offre supporto educativo. Le sue risposte sono generate tramite sistemi di intelligenza artificiale e possono contenere errori. L'utente deve verificare le informazioni importanti. Zynqora non garantisce che una risposta sia sempre corretta e non sostituisce insegnanti, professionisti o altre fonti ufficiali quando pertinente.",
      "pol.s19t": "Uso responsabile", "pol.s19b": "L'utente si impegna a non usare Zynqora per scopi illeciti, per violare i diritti di terzi né per generare contenuti dannosi.",
      "pol.s20t": "Proprietà intellettuale", "pol.s20b": "Zynqora e i suoi elementi di marchio appartengono ai rispettivi titolari. L'utente conserva i diritti sui propri contenuti.",
      "pol.s21t": "Disponibilità del servizio", "pol.s21b": "Zynqora si impegna a mantenere il servizio disponibile, ma possono verificarsi interruzioni per manutenzione o cause tecniche.",
      "pol.s22t": "Eliminazione degli account", "pol.s22b": "L'utente può eliminare il proprio account in qualsiasi momento. L'eliminazione comporta la cancellazione o l'anonimizzazione dei dati secondo i termini legali.",
      "pol.s23t": "Sospensione degli account", "pol.s23b": "Zynqora può sospendere o limitare account che violano queste condizioni o che mettono a rischio il servizio o altri utenti.",
      "pol.s24t": "Modifica del servizio", "pol.s24b": "Zynqora può aggiungere, modificare o rimuovere funzioni per migliorare il prodotto, comunicando i cambiamenti rilevanti.",
      "pol.s25t": "Modifica delle politiche", "pol.s25b": "Queste condizioni possono essere aggiornate. Le modifiche sostanziali saranno comunicate con un ragionevole preavviso.",
      "pol.s26t": "Assistenza clienti", "pol.s26b": "L'utente può contattare il team di assistenza tramite i canali indicati all'interno dell'app.",
      "pol.s27t": "Legge applicabile", "pol.s27b": "Queste condizioni sono regolate dalla legge applicabile in base al domicilio dell'utente e dalla normativa sui consumatori in vigore."
    },
    fr: {
      "menu.plans": "Forfaits", "menu.checkout": "Paiement (démo)", "menu.policies": "Politiques", "menu.aitools": "Outils IA",
      "menu.policiesFull": "Politiques et conditions",
      "plan.free": "Zynqora Free", "plan.plus": "Zynqora Plus", "plan.pro": "Zynqora Pro",
      "plan.freeShort": "Free", "plan.plusShort": "Plus", "plan.proShort": "Pro",
      "plans.title": "Choisis comment tu veux étudier", "plans.sub": "Commence gratuitement et passe à un forfait supérieur quand tu en as besoin.",
      "plan.forever": "Gratuit pour toujours",
      "plans.monthly": "Mensuel", "plans.annual": "Annuel",
      "plans.perMonth": "/mois", "plans.perYear": "/an", "plans.free0": "0 €",
      "plans.save": "Économise {pct}% par rapport au paiement mensuel",
      "plans.popular": "Le plus populaire", "plans.proTag": "Expérience IA avancée",
      "plans.proSub": "Pour les étudiants qui veulent tirer le meilleur de Zynqora",
      "plans.current": "Ton forfait actuel", "plans.choose": "Choisir {plan}",
      "plans.downgrade": "Passer à Free", "plans.cta": "Mettre à niveau", "plans.manage": "Gérer le forfait",
      "plans.noAds": "Sans publicité. Juste toi, tes études et Zynqora.",
      "feat.aiMessages": "Messages à Zynqora AI", "feat.files": "Fichiers à étudier",
      "feat.tests": "Tests générés", "feat.flashcards": "Flashcards générées",
      "feat.podcasts": "Podcasts IA", "feat.presentations": "Présentations IA",
      "feat.conceptMaps": "Cartes conceptuelles IA", "feat.subjects": "Matières",
      "feat.perMonth": "{n} par mois", "feat.unlimited": "Illimité", "feat.none": "Non inclus", "feat.persBasic": "Couleurs de base",
      "usage.title": "Ton forfait", "usage.resets": "Les limites se renouvellent chaque mois.",
      "usage.reached": "Tu as atteint la limite de cette fonctionnalité sur ton forfait.",
      "usage.atLimit": "limite atteinte",
      "up.title": "Tu as atteint la limite de ton forfait Free",
      "up.body": "Tu peux continuer à étudier avec Zynqora en passant à un forfait supérieur.",
      "up.usedFeature": "Tu as utilisé tes {limit} {feature} de ce mois-ci.",
      "up.plusOffer": "Passe à Plus pour disposer de jusqu'à {n} {feature} par mois.",
      "short.aiMessages": "messages IA", "short.files": "fichiers", "short.tests": "tests", "short.flashcards": "flashcards",
      "up.subjectsUsed": "Ton forfait Free inclut {limit} matières.",
      "up.subjectsOffer": "Passe à Plus pour avoir jusqu'à {n} matières.",
      "up.toPlus": "Passer à Plus", "up.seeAll": "Voir tous les forfaits", "up.notNow": "Pas maintenant",
      "fm.podcastT": "Transforme tes notes en podcast",
      "fm.presentationT": "Transforme tes notes en présentation",
      "fm.conceptMapT": "Transforme tes notes en carte conceptuelle",
      "fm.personalizationT": "Plus d'options de personnalisation",
      "fm.availPlus": "Cette fonctionnalité est disponible avec Zynqora Plus et Pro.",
      "fm.seePlans": "Voir les forfaits",
      "co.title": "Paiement de démonstration", "co.plan": "Forfait", "co.total": "Total",
      "co.name": "Nom", "co.email": "Email", "co.payment": "Moyen de paiement",
      "co.paymentDemo": "Paiement de démonstration — aucun prélèvement réel n'est effectué.",
      "co.card": "Carte (démo)", "co.confirm": "Confirmer l'abonnement",
      "co.note": "Paiement de démonstration. Aucune donnée bancaire réelle n'est demandée ni traitée.",
      "co.welcome": "Bienvenue sur {plan} ! ✨",
      "co.welcomeSub": "Ton forfait de démonstration est actif. Tu peux revenir à Free quand tu veux depuis ton profil.",
      "co.start": "Commencer", "co.cancelAnytime": "Tu peux annuler le renouvellement à tout moment.",
      "tools.title": "Outils d'étude IA", "tools.sub": "Transforme ton contenu en nouveaux formats.",
      "tools.podcast": "Créer un podcast", "tools.podcastS": "Écoute tes notes comme un épisode.",
      "tools.presentation": "Créer une présentation", "tools.presentationS": "Génère des diapositives à partir de ton contenu.",
      "tools.conceptMap": "Créer une carte conceptuelle", "tools.conceptMapS": "Visualise comment les idées se relient.",
      "tf.source": "Contenu", "tf.style": "Style", "tf.preview": "Aperçu",
      "tf.generate": "Générer", "tf.edit": "Modifier", "tf.export": "Exporter",
      "tf.step": "Étape {n} sur {total}",
      "tf.demoPreview": "Aperçu de démonstration. La génération réelle sera connectée plus tard.",
      "tf.podcastStyle1": "Conversation (2 voix)", "tf.podcastStyle2": "Narration (1 voix)",
      "tf.presStyle1": "Minimaliste", "tf.presStyle2": "Visuel",
      "tf.mapStyle1": "Radial", "tf.mapStyle2": "Hiérarchique",
      "pol.title": "Politiques et conditions",
      "pol.sub": "Tout ce que tu dois savoir sur Zynqora, expliqué clairement et en toute transparence.",
      "pol.nutshell": "En bref",
      "pol.nut1t": "Annulation", "pol.nut1d": "Les abonnements peuvent être annulés pour éviter de futurs renouvellements.",
      "pol.nut2t": "Renouvellement", "pol.nut2d": "Les conditions de renouvellement sont affichées avant la souscription.",
      "pol.nut3t": "Remboursements", "pol.nut3d": "Les conditions applicables sont affichées avant l'achat.",
      "pol.nut4t": "Confidentialité", "pol.nut4d": "Les données sont traitées conformément à la Politique de confidentialité.",
      "pol.nut5t": "IA", "pol.nut5d": "Zynqora AI est un outil d'aide à l'étude et ses réponses peuvent contenir des erreurs.",
      "pol.adsTitle": "Sans publicité",
      "pol.adsBody": "Sans publicité. Juste toi, tes études et Zynqora. Zynqora n'utilise de publicité dans l'application sur aucun de ses forfaits : pas de bannières, pas de publicité entre les exercices et pas de publicité intrusive.",
      "pol.disclaimer": "Ce texte est une ébauche de produit. Les conditions définitives devront être adaptées à la législation applicable avant le lancement commercial. Les droits légaux des consommateurs prévalent lorsqu'ils s'appliquent.",
      "pol.s01t": "Objectif de Zynqora", "pol.s01b": "Zynqora est un outil numérique d'aide à l'étude qui aide à organiser le contenu, générer du contenu de révision (résumés, flashcards, tests) et planifier l'apprentissage.",
      "pol.s02t": "Acceptation des conditions", "pol.s02b": "En créant un compte ou en utilisant Zynqora, l'utilisateur accepte ces conditions. En cas de désaccord, il ne doit pas utiliser le service.",
      "pol.s03t": "Compte utilisateur", "pol.s03b": "L'utilisateur est responsable de la confidentialité de ses identifiants et de l'activité effectuée depuis son compte.",
      "pol.s04t": "Forfaits et services", "pol.s04b": "Zynqora propose un forfait gratuit et des forfaits payants (Plus et Pro) avec différentes limites d'utilisation. Les fonctionnalités de chaque forfait peuvent évoluer.",
      "pol.s05t": "Prix et paiements", "pol.s05b": "Les prix sont affichés avant la souscription, taxes applicables comprises le cas échéant. Les montants de cette version sont indicatifs.",
      "pol.s06t": "Paiements et prestataires", "pol.s06b": "Lorsque les paiements réels seront activés, ils seront traités par des prestataires de paiement externes. Zynqora ne stocke pas les données complètes des cartes.",
      "pol.s07t": "Abonnements et renouvellement", "pol.s07b": "Les abonnements payants se renouvellent pour des périodes équivalentes sauf annulation. Les conditions de renouvellement sont affichées avant la souscription.",
      "pol.s08t": "Annulation", "pol.s08b": "L'utilisateur peut annuler le renouvellement à tout moment depuis son profil. L'accès payant reste actif jusqu'à la fin de la période déjà payée.",
      "pol.s09t": "Remboursements", "pol.s09b": "Les conditions de remboursement applicables sont affichées avant l'achat. Une garantie commerciale de satisfaction de 30 minutes peut exister pour certains forfaits, sous réserve des conditions applicables. Les droits légaux des consommateurs prévalent lorsqu'ils s'appliquent.",
      "pol.s10t": "Essais et promotions", "pol.s10b": "Zynqora peut proposer des périodes d'essai ou des promotions avec des conditions spécifiques, communiquées au cas par cas.",
      "pol.s11t": "Confidentialité et protection des données", "pol.s11b": "Les données personnelles sont traitées conformément à la Politique de confidentialité, qui détaille les finalités, bases légales et droits.",
      "pol.s12t": "Données traitées", "pol.s12b": "Zynqora peut traiter des données de compte, des données d'utilisation du service et le contenu que l'utilisateur choisit de mettre en ligne pour utiliser les fonctionnalités d'étude.",
      "pol.s13t": "Utilisation des données", "pol.s13b": "Les données sont utilisées pour fournir le service, l'améliorer, offrir un support et respecter les obligations légales. Elles ne sont pas vendues à des tiers.",
      "pol.s14t": "Sécurité", "pol.s14b": "Zynqora applique des mesures techniques et organisationnelles raisonnables pour protéger les informations. Aucun système n'est totalement infaillible.",
      "pol.s15t": "Prestataires externes", "pol.s15b": "Zynqora s'appuie sur des prestataires d'infrastructure, d'intelligence artificielle et d'analyse nécessaires pour fournir le service, soumis aux accords de traitement des données correspondants.",
      "pol.s16t": "Droits de l'utilisateur", "pol.s16b": "L'utilisateur peut accéder à ses données, les rectifier, les supprimer et les porter, ainsi que s'opposer à certains traitements ou les limiter, conformément à la réglementation applicable.",
      "pol.s17t": "Fichiers et contenu de l'utilisateur", "pol.s17b": "L'utilisateur peut mettre en ligne du contenu d'étude (PDF, documents, images ou texte) pour utiliser les fonctionnalités de Zynqora. L'utilisateur déclare avoir le droit d'utiliser ce contenu. Pour fournir le service, les fichiers pourront être traités par les prestataires technologiques nécessaires lorsque l'architecture réelle l'exigera. Les conditions détaillées seront précisées dans la Politique de confidentialité.",
      "pol.s18t": "Zynqora AI et contenu généré", "pol.s18b": "Zynqora AI offre un soutien éducatif. Ses réponses sont générées par des systèmes d'intelligence artificielle et peuvent contenir des erreurs. L'utilisateur doit vérifier les informations importantes. Zynqora ne garantit pas qu'une réponse soit toujours correcte et ne remplace pas les enseignants, professionnels ou autres sources officielles le cas échéant.",
      "pol.s19t": "Usage responsable", "pol.s19b": "L'utilisateur s'engage à ne pas utiliser Zynqora à des fins illicites, pour porter atteinte aux droits de tiers ni pour générer du contenu nuisible.",
      "pol.s20t": "Propriété intellectuelle", "pol.s20b": "Zynqora et ses éléments de marque appartiennent à leurs titulaires. L'utilisateur conserve les droits sur son propre contenu.",
      "pol.s21t": "Disponibilité du service", "pol.s21b": "Zynqora s'efforce de maintenir le service disponible, mais des interruptions peuvent survenir pour maintenance ou raisons techniques.",
      "pol.s22t": "Suppression des comptes", "pol.s22b": "L'utilisateur peut supprimer son compte à tout moment. La suppression entraîne l'effacement ou l'anonymisation de ses données selon les délais légaux.",
      "pol.s23t": "Suspension des comptes", "pol.s23b": "Zynqora peut suspendre ou restreindre des comptes qui enfreignent ces conditions ou qui mettent en danger le service ou d'autres utilisateurs.",
      "pol.s24t": "Modification du service", "pol.s24b": "Zynqora peut ajouter, modifier ou retirer des fonctionnalités pour améliorer le produit, en informant des changements importants.",
      "pol.s25t": "Modification des politiques", "pol.s25b": "Ces conditions peuvent être mises à jour. Les changements substantiels seront communiqués avec un préavis raisonnable.",
      "pol.s26t": "Service client", "pol.s26b": "L'utilisateur peut contacter l'équipe de support via les canaux indiqués dans l'application.",
      "pol.s27t": "Loi applicable", "pol.s27b": "Ces conditions sont régies par la loi applicable selon le lieu de résidence de l'utilisateur et la réglementation de consommation en vigueur."
    },
    pt: {
      "menu.plans": "Planos", "menu.checkout": "Checkout (demo)", "menu.policies": "Políticas", "menu.aitools": "Ferramentas de IA",
      "menu.policiesFull": "Políticas e condições",
      "plan.free": "Zynqora Free", "plan.plus": "Zynqora Plus", "plan.pro": "Zynqora Pro",
      "plan.freeShort": "Free", "plan.plusShort": "Plus", "plan.proShort": "Pro",
      "plans.title": "Escolhe como queres estudar", "plans.sub": "Começa grátis e atualiza quando precisares de mais.",
      "plan.forever": "Sempre grátis",
      "plans.monthly": "Mensal", "plans.annual": "Anual",
      "plans.perMonth": "/mês", "plans.perYear": "/ano", "plans.free0": "0 €",
      "plans.save": "Poupas {pct}% em relação ao pagamento mensal",
      "plans.popular": "Mais popular", "plans.proTag": "Experiência de IA avançada",
      "plans.proSub": "Para estudantes que querem aproveitar a Zynqora ao máximo",
      "plans.current": "O teu plano atual", "plans.choose": "Escolher {plan}",
      "plans.downgrade": "Mudar para Free", "plans.cta": "Atualizar", "plans.manage": "Gerir plano",
      "plans.noAds": "Sem anúncios. Só tu, os teus estudos e a Zynqora.",
      "feat.aiMessages": "Mensagens à Zynqora AI", "feat.files": "Ficheiros para estudar",
      "feat.tests": "Testes gerados", "feat.flashcards": "Flashcards geradas",
      "feat.podcasts": "Podcasts de IA", "feat.presentations": "Apresentações de IA",
      "feat.conceptMaps": "Mapas concetuais de IA", "feat.subjects": "Disciplinas",
      "feat.perMonth": "{n} por mês", "feat.unlimited": "Sem limite", "feat.none": "Não incluído", "feat.persBasic": "Cores básicas",
      "usage.title": "O teu plano", "usage.resets": "Os limites renovam-se todos os meses.",
      "usage.reached": "Atingiste o limite desta funcionalidade no teu plano.",
      "usage.atLimit": "limite atingido",
      "up.title": "Atingiste o limite do teu plano Free",
      "up.body": "Podes continuar a estudar com a Zynqora atualizando o teu plano.",
      "up.usedFeature": "Já usaste os teus {limit} {feature} deste mês.",
      "up.plusOffer": "Atualiza para Plus para teres até {n} {feature} por mês.",
      "short.aiMessages": "mensagens de IA", "short.files": "ficheiros", "short.tests": "testes", "short.flashcards": "flashcards",
      "up.subjectsUsed": "O teu plano Free inclui {limit} disciplinas.",
      "up.subjectsOffer": "Atualiza para Plus para teres até {n} disciplinas.",
      "up.toPlus": "Atualizar para Plus", "up.seeAll": "Ver todos os planos", "up.notNow": "Agora não",
      "fm.podcastT": "Transforma os teus apontamentos num podcast",
      "fm.presentationT": "Transforma os teus apontamentos numa apresentação",
      "fm.conceptMapT": "Transforma os teus apontamentos num mapa concetual",
      "fm.personalizationT": "Mais opções de personalização",
      "fm.availPlus": "Esta funcionalidade está disponível na Zynqora Plus e Pro.",
      "fm.seePlans": "Ver planos",
      "co.title": "Checkout de demonstração", "co.plan": "Plano", "co.total": "Total",
      "co.name": "Nome", "co.email": "Email", "co.payment": "Método de pagamento",
      "co.paymentDemo": "Pagamento de demonstração — não é processada nenhuma cobrança real.",
      "co.card": "Cartão (demo)", "co.confirm": "Confirmar subscrição",
      "co.note": "Checkout de demonstração. Não é solicitado nem processado nenhum dado bancário real.",
      "co.welcome": "Bem-vindo à {plan}! ✨",
      "co.welcomeSub": "O teu plano de demonstração está ativo. Podes voltar a Free quando quiseres a partir do teu perfil.",
      "co.start": "Começar", "co.cancelAnytime": "Podes cancelar a renovação a qualquer momento.",
      "tools.title": "Ferramentas de estudo com IA", "tools.sub": "Transforma o teu material em novos formatos.",
      "tools.podcast": "Criar podcast", "tools.podcastS": "Ouve os teus apontamentos como um episódio.",
      "tools.presentation": "Criar apresentação", "tools.presentationS": "Gera diapositivos a partir do teu material.",
      "tools.conceptMap": "Criar mapa concetual", "tools.conceptMapS": "Visualiza como as ideias se ligam.",
      "tf.source": "Material", "tf.style": "Estilo", "tf.preview": "Pré-visualização",
      "tf.generate": "Gerar", "tf.edit": "Editar", "tf.export": "Exportar",
      "tf.step": "Passo {n} de {total}",
      "tf.demoPreview": "Pré-visualização de demonstração. A geração real será ligada mais tarde.",
      "tf.podcastStyle1": "Conversa (2 vozes)", "tf.podcastStyle2": "Narração (1 voz)",
      "tf.presStyle1": "Minimalista", "tf.presStyle2": "Visual",
      "tf.mapStyle1": "Radial", "tf.mapStyle2": "Hierárquico",
      "pol.title": "Políticas e condições",
      "pol.sub": "Tudo o que precisas de saber sobre a Zynqora, explicado de forma clara e transparente.",
      "pol.nutshell": "Em poucas palavras",
      "pol.nut1t": "Cancelamento", "pol.nut1d": "As subscrições podem ser canceladas para evitar futuras renovações.",
      "pol.nut2t": "Renovação", "pol.nut2d": "As condições de renovação são mostradas antes da subscrição.",
      "pol.nut3t": "Reembolsos", "pol.nut3d": "As condições aplicáveis são mostradas antes da compra.",
      "pol.nut4t": "Privacidade", "pol.nut4d": "Os dados são tratados de acordo com a Política de Privacidade.",
      "pol.nut5t": "IA", "pol.nut5d": "A Zynqora AI é uma ferramenta de apoio ao estudo e as suas respostas podem conter erros.",
      "pol.adsTitle": "Sem anúncios",
      "pol.adsBody": "Sem anúncios. Só tu, os teus estudos e a Zynqora. A Zynqora não utiliza publicidade dentro da aplicação em nenhum dos seus planos: sem banners, sem publicidade entre exercícios e sem anúncios intrusivos.",
      "pol.disclaimer": "Este texto é um rascunho de produto. As condições definitivas deverão ser adaptadas à legislação aplicável antes do lançamento comercial. Os direitos legais do consumidor prevalecem quando aplicáveis.",
      "pol.s01t": "Objetivo da Zynqora", "pol.s01b": "A Zynqora é uma ferramenta digital de apoio ao estudo que ajuda a organizar materiais, gerar conteúdo de revisão (resumos, flashcards, testes) e planear a aprendizagem.",
      "pol.s02t": "Aceitação das condições", "pol.s02b": "Ao criar uma conta ou utilizar a Zynqora, o utilizador aceita estas condições. Se não concordar, não deve utilizar o serviço.",
      "pol.s03t": "Conta de utilizador", "pol.s03b": "O utilizador é responsável por manter a confidencialidade das suas credenciais e pela atividade realizada a partir da sua conta.",
      "pol.s04t": "Planos e serviços", "pol.s04b": "A Zynqora oferece um plano gratuito e planos pagos (Plus e Pro) com diferentes limites de utilização. As funcionalidades de cada plano podem evoluir.",
      "pol.s05t": "Preços e pagamentos", "pol.s05b": "Os preços são mostrados antes da subscrição, incluindo os impostos aplicáveis quando pertinente. Os valores desta versão são indicativos.",
      "pol.s06t": "Pagamentos e fornecedores", "pol.s06b": "Quando os pagamentos reais forem ativados, serão processados através de fornecedores de pagamento externos. A Zynqora não armazena dados completos de cartões.",
      "pol.s07t": "Subscrições e renovação", "pol.s07b": "As subscrições pagas renovam-se por períodos equivalentes, salvo cancelamento. As condições de renovação são mostradas antes da subscrição.",
      "pol.s08t": "Cancelamento", "pol.s08b": "O utilizador pode cancelar a renovação a qualquer momento a partir do seu perfil. O acesso pago mantém-se até ao final do período já pago.",
      "pol.s09t": "Reembolsos", "pol.s09b": "As condições de reembolso aplicáveis são mostradas antes da compra. Poderá existir uma garantia comercial de satisfação de 30 minutos para determinados planos, sujeita às condições aplicáveis. Os direitos legais do consumidor prevalecem quando aplicáveis.",
      "pol.s10t": "Testes e promoções", "pol.s10b": "A Zynqora pode oferecer períodos de teste ou promoções com condições específicas, comunicadas em cada caso.",
      "pol.s11t": "Privacidade e proteção de dados", "pol.s11b": "Os dados pessoais são tratados de acordo com a Política de Privacidade, que detalha finalidades, bases legais e direitos.",
      "pol.s12t": "Dados tratados", "pol.s12b": "A Zynqora pode tratar dados da conta, dados de utilização do serviço e o conteúdo que o utilizador decida carregar para utilizar as funcionalidades de estudo.",
      "pol.s13t": "Uso dos dados", "pol.s13b": "Os dados são utilizados para prestar o serviço, melhorá-lo, dar apoio e cumprir obrigações legais. Não são vendidos a terceiros.",
      "pol.s14t": "Segurança", "pol.s14b": "A Zynqora aplica medidas técnicas e organizativas razoáveis para proteger a informação. Nenhum sistema é completamente infalível.",
      "pol.s15t": "Fornecedores externos", "pol.s15b": "A Zynqora apoia-se em fornecedores de infraestrutura, inteligência artificial e análise necessários para prestar o serviço, sujeitos aos respetivos acordos de tratamento de dados.",
      "pol.s16t": "Direitos do utilizador", "pol.s16b": "O utilizador pode aceder, retificar, eliminar e portar os seus dados, bem como opor-se ou limitar determinados tratamentos, de acordo com a legislação aplicável.",
      "pol.s17t": "Ficheiros e conteúdo do utilizador", "pol.s17b": "O utilizador pode carregar materiais de estudo (PDF, documentos, imagens ou texto) para utilizar as funcionalidades da Zynqora. O utilizador declara ter o direito de utilizar esses materiais. Para prestar o serviço, os ficheiros poderão ser processados pelos fornecedores tecnológicos necessários quando a arquitetura real o exigir. As condições detalhadas constarão da Política de Privacidade.",
      "pol.s18t": "Zynqora AI e conteúdo gerado", "pol.s18b": "A Zynqora AI oferece apoio educativo. As suas respostas são geradas por sistemas de inteligência artificial e podem conter erros. O utilizador deve verificar informações importantes. A Zynqora não garante que uma resposta esteja sempre correta e não substitui professores, profissionais ou outras fontes oficiais quando pertinente.",
      "pol.s19t": "Uso responsável", "pol.s19b": "O utilizador compromete-se a não usar a Zynqora para fins ilícitos, para infringir direitos de terceiros nem para gerar conteúdo prejudicial.",
      "pol.s20t": "Propriedade intelectual", "pol.s20b": "A Zynqora e os seus elementos de marca pertencem aos respetivos titulares. O utilizador mantém os direitos sobre o seu próprio conteúdo.",
      "pol.s21t": "Disponibilidade do serviço", "pol.s21b": "A Zynqora esforça-se por manter o serviço disponível, mas podem ocorrer interrupções por manutenção ou causas técnicas.",
      "pol.s22t": "Eliminação de contas", "pol.s22b": "O utilizador pode eliminar a sua conta a qualquer momento. A eliminação implica o apagamento ou a anonimização dos seus dados de acordo com os prazos legais.",
      "pol.s23t": "Suspensão de contas", "pol.s23b": "A Zynqora pode suspender ou restringir contas que violem estas condições ou que coloquem em risco o serviço ou outros utilizadores.",
      "pol.s24t": "Modificação do serviço", "pol.s24b": "A Zynqora pode adicionar, modificar ou remover funcionalidades para melhorar o produto, avisando sobre alterações relevantes.",
      "pol.s25t": "Modificação das políticas", "pol.s25b": "Estas condições podem ser atualizadas. As alterações substanciais serão comunicadas com uma antecedência razoável.",
      "pol.s26t": "Apoio ao cliente", "pol.s26b": "O utilizador pode contactar a equipa de apoio através dos canais indicados dentro da aplicação.",
      "pol.s27t": "Legislação aplicável", "pol.s27b": "Estas condições regem-se pela legislação aplicável de acordo com a residência do utilizador e a regulamentação de consumo em vigor."
    }
  });
  ...
  (function (P) {
    ...
    es: {
      ...
      "bul.langs": "Español + English + Italiano + Français + Português", "bul.noAds": "Sin anuncios",
    ...
    en: {
      ...
      "bul.langs": "Spanish + English + Italian + French + Portuguese", "bul.noAds": "No ads",
    ...
    it: {
      "co.title": "Completa il pagamento",
      "co.activating": "Stai attivando {plan}",
      "co.cycleMonthly": "fatturazione mensile", "co.cycleAnnual": "fatturazione annuale",
      "co.methodCard": "Carta", "co.methodPaypal": "PayPal",
      "co.cardName": "Nome sulla carta", "co.cardNumber": "Numero di carta",
      "co.expiry": "Scadenza", "co.cvc": "CVC", "co.country": "Paese", "co.zip": "CAP",
      "co.pay": "Paga {amount}",
      "co.simNote": "Pagamento simulato — demo del prodotto, non viene effettuato alcun addebito reale",
      "co.paypalNote": "Continuando si aprirebbe PayPal (simulato in questa demo).",
      "co.payPaypal": "Continua con PayPal",
      "co.welcome": "Benvenuto su {plan}! ✨",
      "co.welcomeSub": "Il tuo piano dimostrativo è attivo e i tuoi limiti sono stati aggiornati. Puoi tornare a Free quando vuoi dal tuo profilo.",
      "co.start": "Inizia", "co.cancelNote": "Puoi annullare il rinnovo in qualsiasi momento. Nessun vincolo.",
      "plans.policiesLink": "Politiche e condizioni",
      "plans.reviewFree": "Ripasso base", "plans.reviewFull": "Ripasso avanzato",
      "bul.allFree": "Tutto ciò che è in Free", "bul.allPlus": "Tutto ciò che è in Plus",
      "bul.calendar": "Calendario e compiti", "bul.streak": "Serie di studio",
      "bul.langs": "Spagnolo + English + Italiano + Français + Português", "bul.noAds": "Senza pubblicità",
      "bul.colorsBasic": "Colori base", "bul.persFull": "Personalizzazione completa",
      "bul.aiAdvanced": "Esperienza IA avanzata",
      "bul.ai": "Zynqora AI — {n} messaggi al mese", "bul.files": "{n} file al mese",
      "bul.tests": "{n} test al mese", "bul.fc": "{n} flashcard al mese",
      "bul.pod": "{n} podcast al mese", "bul.pres": "{n} presentazioni IA al mese",
      "bul.map": "{n} mappe concettuali al mese",
      "bul.subj": "{n} materie", "bul.subjUnlim": "Materie senza limite ragionevole",
      "tools.podcastS": "Trasforma i tuoi appunti in una spiegazione che puoi ascoltare.",
      "tools.presentationS": "Trasforma i tuoi appunti in una presentazione visiva, chiara e pronta per studiare.",
      "tools.conceptMapS": "Visualizza come si collegano le idee del tuo materiale.",
      "tf.whatCreate": "Cosa vuoi creare?",
      "tf.podStudy": "Podcast di studio", "tf.podStudyS": "Una spiegazione narrata del tuo materiale",
      "tf.duration": "Durata",
      "tf.durShort": "Breve", "tf.durMedium": "Media", "tf.durDeep": "Approfondita",
      "tf.min": "{n} min",
      "tf.podEx": "Spiegazione", "tf.podRev": "Ripasso", "tf.podConv": "Conversazione",
      "tf.presMin": "Minimalista", "tf.presAcad": "Accademico", "tf.presVis": "Visivo", "tf.presCrea": "Creativo",
      "tf.mapRadial": "Radiale", "tf.mapHier": "Gerarchico",
      "tf.createPodcast": "Crea podcast", "tf.createPres": "Crea presentazione", "tf.createMap": "Crea mappa",
      "tf.genPodcast": "Zynqora sta preparando il tuo podcast…",
      "tf.genPres": "Zynqora sta montando la tua presentazione…",
      "tf.genMap": "Zynqora sta tracciando la tua mappa…",
      "tf.genSub": "Con il servizio reale ci vorrebbero pochi secondi.",
      "tf.podNote": "Audio dimostrativo. La generazione vocale reale verrà collegata più avanti.",
      "tf.presNote": "Presentazione dimostrativa generata dal tuo materiale.",
      "tf.mapNote": "Mappa dimostrativa. La generazione reale verrà collegata più avanti.",
      "tf.regen": "Rigenera", "tf.export": "Esporta", "tf.edit": "Modifica",
      "tf.exportDemo": "Esportazione simulata in questa demo.",
      "tf.editDemo": "Modifica simulata in questa demo.",
      "tf.regenDone": "Rigenerato (demo).",
      "mat.actionsTitle": "Cosa vuoi fare con questo materiale?",
      "mat.ask": "Chiedi a Zynqora", "mat.summary": "Crea riassunto", "mat.flashcards": "Crea flashcard",
      "mat.test": "Crea test", "mat.podcast": "Crea podcast", "mat.presentation": "Crea presentazione",
      "mat.conceptMap": "Crea mappa concettuale", "mat.exercises": "Crea esercizi",
      "fm.availPlus": "Questa funzione fa parte di Zynqora Plus.",
      "fm.podcastD": "Trasforma qualsiasi materiale in un podcast di studio che puoi ascoltare.",
      "fm.presentationD": "Trasforma i tuoi appunti in una presentazione visiva pronta per il ripasso.",
      "fm.conceptMapD": "Genera una mappa concettuale con le idee del tuo materiale e i loro collegamenti.",
      "fm.personalizationD": "Sblocca tutti i colori di accento e le opzioni di personalizzazione.",
      "fm.toPlus": "Passa a Plus",
      "up.title": "Hai raggiunto il limite del tuo piano Free",
      "prof.title": "Profilo", "prof.editProfile": "Modifica profilo", "prof.managePlan": "Gestisci piano",
      "prof.settings": "Impostazioni", "prof.statStreak": "giorni di serie", "prof.statSubjects": "materie",
      "prof.statAi": "messaggi IA", "prof.monthlyUse": "Uso mensile",
      "pol.nut1t": "Senza pubblicità", "pol.nut1d": "Zynqora non mostra pubblicità in nessun piano.",
      "pol.nut2t": "Cancellazione", "pol.nut2d": "L'abbonamento può essere cancellato secondo le condizioni applicabili.",
      "pol.nut3t": "Rimborsi", "pol.nut3d": "Le condizioni di rimborso vengono mostrate prima dell'abbonamento.",
      "pol.nut4t": "Protezione dei dati", "pol.nut4d": "I dati vengono trattati in conformità con l'Informativa sulla Privacy.",
      "pol.nut5t": "Zynqora AI", "pol.nut5d": "Può commettere errori; verifica le informazioni importanti.",
      "pol.nut6t": "I tuoi materiali", "pol.nut6d": "Vengono utilizzati per le corrispondenti funzioni di studio.",
      "pol.disclaimer": "Queste condizioni dovranno essere riviste e adattate alla legislazione applicabile prima del lancio commerciale. I diritti legali del consumatore prevalgono quando applicabili."
    },
    fr: {
      "co.title": "Finaliser le paiement",
      "co.activating": "Tu es en train d'activer {plan}",
      "co.cycleMonthly": "facturation mensuelle", "co.cycleAnnual": "facturation annuelle",
      "co.methodCard": "Carte", "co.methodPaypal": "PayPal",
      "co.cardName": "Nom sur la carte", "co.cardNumber": "Numéro de carte",
      "co.expiry": "Expiration", "co.cvc": "CVC", "co.country": "Pays", "co.zip": "Code postal",
      "co.pay": "Payer {amount}",
      "co.simNote": "Paiement simulé — démo produit, aucun prélèvement réel n'est effectué",
      "co.paypalNote": "En continuant, PayPal s'ouvrirait (simulé dans cette démo).",
      "co.payPaypal": "Continuer avec PayPal",
      "co.welcome": "Bienvenue sur {plan} ! ✨",
      "co.welcomeSub": "Ton forfait de démonstration est actif et tes limites ont été mises à jour. Tu peux revenir à Free quand tu veux depuis ton profil.",
      "co.start": "Commencer", "co.cancelNote": "Tu peux annuler le renouvellement à tout moment. Sans engagement.",
      "plans.policiesLink": "Politiques et conditions",
      "plans.reviewFree": "Révision de base", "plans.reviewFull": "Révision avancée",
      "bul.allFree": "Tout ce qui est dans Free", "bul.allPlus": "Tout ce qui est dans Plus",
      "bul.calendar": "Calendrier et tâches", "bul.streak": "Série d'étude",
      "bul.langs": "Espagnol + English + Italiano + Français + Português", "bul.noAds": "Sans publicité",
      "bul.colorsBasic": "Couleurs de base", "bul.persFull": "Personnalisation complète",
      "bul.aiAdvanced": "Expérience IA avancée",
      "bul.ai": "Zynqora AI — {n} messages/mois", "bul.files": "{n} fichiers/mois",
      "bul.tests": "{n} tests/mois", "bul.fc": "{n} flashcards/mois",
      "bul.pod": "{n} podcasts/mois", "bul.pres": "{n} présentations IA/mois",
      "bul.map": "{n} cartes conceptuelles/mois",
      "bul.subj": "{n} matières", "bul.subjUnlim": "Pas de limite raisonnable de matières",
      "tools.podcastS": "Transforme tes notes en une explication que tu peux écouter.",
      "tools.presentationS": "Transforme tes notes en une présentation visuelle claire, prête à étudier.",
      "tools.conceptMapS": "Visualise comment les idées de ton contenu se relient.",
      "tf.whatCreate": "Que veux-tu créer ?",
      "tf.podStudy": "Podcast d'étude", "tf.podStudyS": "Une explication narrée de ton contenu",
      "tf.duration": "Durée",
      "tf.durShort": "Court", "tf.durMedium": "Moyen", "tf.durDeep": "Approfondi",
      "tf.min": "{n} min",
      "tf.podEx": "Explication", "tf.podRev": "Révision", "tf.podConv": "Conversation",
      "tf.presMin": "Minimaliste", "tf.presAcad": "Académique", "tf.presVis": "Visuel", "tf.presCrea": "Créatif",
      "tf.mapRadial": "Radial", "tf.mapHier": "Hiérarchique",
      "tf.createPodcast": "Créer un podcast", "tf.createPres": "Créer une présentation", "tf.createMap": "Créer une carte",
      "tf.genPodcast": "Zynqora prépare ton podcast…",
      "tf.genPres": "Zynqora construit ta présentation…",
      "tf.genMap": "Zynqora trace ta carte…",
      "tf.genSub": "Cela prendrait quelques secondes avec le service réel.",
      "tf.podNote": "Audio de démonstration. La génération vocale réelle sera connectée plus tard.",
      "tf.presNote": "Présentation de démonstration générée à partir de ton contenu.",
      "tf.mapNote": "Carte de démonstration. La génération réelle sera connectée plus tard.",
      "tf.regen": "Régénérer", "tf.export": "Exporter", "tf.edit": "Modifier",
      "tf.exportDemo": "Exportation simulée dans cette démo.",
      "tf.editDemo": "Modification simulée dans cette démo.",
      "tf.regenDone": "Régénéré (démo).",
      "mat.actionsTitle": "Que veux-tu faire avec ce contenu ?",
      "mat.ask": "Demander à Zynqora", "mat.summary": "Créer un résumé", "mat.flashcards": "Créer des flashcards",
      "mat.test": "Créer un test", "mat.podcast": "Créer un podcast", "mat.presentation": "Créer une présentation",
      "mat.conceptMap": "Créer une carte conceptuelle", "mat.exercises": "Créer des exercices",
      "fm.availPlus": "Cette fonctionnalité fait partie de Zynqora Plus.",
      "fm.podcastD": "Transforme n'importe quel contenu en podcast d'étude que tu peux écouter.",
      "fm.presentationD": "Transforme tes notes en présentation visuelle prête à réviser.",
      "fm.conceptMapD": "Génère une carte conceptuelle avec les idées de ton contenu et leurs liens.",
      "fm.personalizationD": "Débloque toutes les couleurs d'accent et options de personnalisation.",
      "fm.toPlus": "Passer à Plus",
      "up.title": "Tu as atteint la limite de ton forfait Free",
      "prof.title": "Profil", "prof.editProfile": "Modifier le profil", "prof.managePlan": "Gérer le forfait",
      "prof.settings": "Paramètres", "prof.statStreak": "jours de série", "prof.statSubjects": "matières",
      "prof.statAi": "messages IA", "prof.monthlyUse": "Utilisation mensuelle",
      "pol.nut1t": "Sans publicité", "pol.nut1d": "Zynqora n'affiche de publicité sur aucun forfait.",
      "pol.nut2t": "Annulation", "pol.nut2d": "L'abonnement peut être annulé selon les conditions applicables.",
      "pol.nut3t": "Remboursements", "pol.nut3d": "Les conditions de remboursement sont affichées avant la souscription.",
      "pol.nut4t": "Protection des données", "pol.nut4d": "Les données sont traitées conformément à la Politique de confidentialité.",
      "pol.nut5t": "Zynqora AI", "pol.nut5d": "Elle peut faire des erreurs ; vérifie les informations importantes.",
      "pol.nut6t": "Ton contenu", "pol.nut6d": "Il est utilisé pour les fonctionnalités d'étude correspondantes.",
      "pol.disclaimer": "Ces conditions devront être revues et adaptées à la législation applicable avant le lancement commercial. Les droits légaux des consommateurs prévalent lorsqu'ils s'appliquent."
    },
    pt: {
      "co.title": "Concluir pagamento",
      "co.activating": "Estás a ativar {plan}",
      "co.cycleMonthly": "faturação mensal", "co.cycleAnnual": "faturação anual",
      "co.methodCard": "Cartão", "co.methodPaypal": "PayPal",
      "co.cardName": "Nome no cartão", "co.cardNumber": "Número do cartão",
      "co.expiry": "Validade", "co.cvc": "CVC", "co.country": "País", "co.zip": "Código postal",
      "co.pay": "Pagar {amount}",
      "co.simNote": "Pagamento simulado — demonstração de produto, não é feita nenhuma cobrança real",
      "co.paypalNote": "Ao continuar, abrir-se-ia o PayPal (simulado nesta demonstração).",
      "co.payPaypal": "Continuar com PayPal",
      "co.welcome": "Bem-vindo à {plan}! ✨",
      "co.welcomeSub": "O teu plano de demonstração está ativo e os teus limites foram atualizados. Podes voltar a Free quando quiseres a partir do teu perfil.",
      "co.start": "Começar", "co.cancelNote": "Podes cancelar a renovação a qualquer momento. Sem fidelização.",
      "plans.policiesLink": "Políticas e condições",
      "plans.reviewFree": "Revisão básica", "plans.reviewFull": "Revisão avançada",
      "bul.allFree": "Tudo o que há no Free", "bul.allPlus": "Tudo o que há no Plus",
      "bul.calendar": "Calendário e tarefas", "bul.streak": "Sequência de estudo",
      "bul.langs": "Espanhol + English + Italiano + Français + Português", "bul.noAds": "Sem anúncios",
      "bul.colorsBasic": "Cores básicas", "bul.persFull": "Personalização completa",
      "bul.aiAdvanced": "Experiência de IA avançada",
      "bul.ai": "Zynqora AI — {n} mensagens por mês", "bul.files": "{n} ficheiros por mês",
      "bul.tests": "{n} testes por mês", "bul.fc": "{n} flashcards por mês",
      "bul.pod": "{n} podcasts por mês", "bul.pres": "{n} apresentações de IA por mês",
      "bul.map": "{n} mapas concetuais por mês",
      "bul.subj": "{n} disciplinas", "bul.subjUnlim": "Disciplinas sem limite razoável",
      "tools.podcastS": "Transforma os teus apontamentos numa explicação que podes ouvir.",
      "tools.presentationS": "Transforma os teus apontamentos numa apresentação visual, clara e pronta a estudar.",
      "tools.conceptMapS": "Visualiza como as ideias do teu material se ligam.",
      "tf.whatCreate": "O que queres criar?",
      "tf.podStudy": "Podcast de estudo", "tf.podStudyS": "Uma explicação narrada do teu material",
      "tf.duration": "Duração",
      "tf.durShort": "Curto", "tf.durMedium": "Médio", "tf.durDeep": "Aprofundado",
      "tf.min": "{n} min",
      "tf.podEx": "Explicação", "tf.podRev": "Revisão", "tf.podConv": "Conversa",
      "tf.presMin": "Minimalista", "tf.presAcad": "Académico", "tf.presVis": "Visual", "tf.presCrea": "Criativo",
      "tf.mapRadial": "Radial", "tf.mapHier": "Hierárquico",
      "tf.createPodcast": "Criar podcast", "tf.createPres": "Criar apresentação", "tf.createMap": "Criar mapa",
      "tf.genPodcast": "A Zynqora está a preparar o teu podcast…",
      "tf.genPres": "A Zynqora está a montar a tua apresentação…",
      "tf.genMap": "A Zynqora está a traçar o teu mapa…",
      "tf.genSub": "Isto demoraria alguns segundos com o serviço real.",
      "tf.podNote": "Áudio de demonstração. A geração de voz real será ligada mais tarde.",
      "tf.presNote": "Apresentação de demonstração gerada a partir do teu material.",
      "tf.mapNote": "Mapa de demonstração. A geração real será ligada mais tarde.",
      "tf.regen": "Regenerar", "tf.export": "Exportar", "tf.edit": "Editar",
      "tf.exportDemo": "Exportação simulada nesta demonstração.",
      "tf.editDemo": "Edição simulada nesta demonstração.",
      "tf.regenDone": "Regenerado (demo).",
      "mat.actionsTitle": "O que queres fazer com este material?",
      "mat.ask": "Perguntar à Zynqora", "mat.summary": "Criar resumo", "mat.flashcards": "Criar flashcards",
      "mat.test": "Criar teste", "mat.podcast": "Criar podcast", "mat.presentation": "Criar apresentação",
      "mat.conceptMap": "Criar mapa concetual", "mat.exercises": "Criar exercícios",
      "fm.availPlus": "Esta funcionalidade faz parte da Zynqora Plus.",
      "fm.podcastD": "Transforma qualquer material num podcast de estudo que podes ouvir.",
      "fm.presentationD": "Transforma os teus apontamentos numa apresentação visual pronta a rever.",
      "fm.conceptMapD": "Gera um mapa concetual com as ideias do teu material e as suas ligações.",
      "fm.personalizationD": "Desbloqueia todas as cores de destaque e opções de personalização.",
      "fm.toPlus": "Atualizar para Plus",
      "up.title": "Atingiste o limite do teu plano Free",
      "prof.title": "Perfil", "prof.editProfile": "Editar perfil", "prof.managePlan": "Gerir plano",
      "prof.settings": "Definições", "prof.statStreak": "dias de sequência", "prof.statSubjects": "disciplinas",
      "prof.statAi": "mensagens de IA", "prof.monthlyUse": "Uso mensal",
      "pol.nut1t": "Sem anúncios", "pol.nut1d": "A Zynqora não mostra publicidade em nenhum plano.",
      "pol.nut2t": "Cancelamento", "pol.nut2d": "A subscrição pode ser cancelada de acordo com as condições aplicáveis.",
      "pol.nut3t": "Reembolsos", "pol.nut3d": "As condições de reembolso são mostradas antes da subscrição.",
      "pol.nut4t": "Proteção de dados", "pol.nut4d": "Os dados são tratados de acordo com a Política de Privacidade.",
      "pol.nut5t": "Zynqora AI", "pol.nut5d": "Pode cometer erros; verifica informações importantes.",
      "pol.nut6t": "Os teus materiais", "pol.nut6d": "São utilizados para as funcionalidades de estudo correspondentes.",
      "pol.disclaimer": "Estas condições deverão ser revistas e adaptadas à legislação aplicável antes do lançamento comercial. Os direitos legais do consumidor prevalecem quando aplicáveis."
    }
  });
  ...
  (function (P) {
    ...
    it: {
      "pres.st0": "Minimal", "pres.st1": "Editoriale", "pres.st2": "Accademico", "pres.st3": "Visivo", "pres.st4": "Scuro",
      "pres.style": "Stile della presentazione",
      "pres.genPrefix": "Presentazione",
      "pres.byZynqora": "Generato da Zynqora AI",
      "pres.slides": "{n} diapositive",
      "pres.present": "Modalità presentazione", "pres.exit": "Esci",
      "pres.thumbs": "Miniature",
      "pres.note": "Presentazione dimostrativa generata dal tuo materiale · stile {style}. Gli elementi visivi si adattano all'argomento.",
      "pres.tWhy": "Perché è importante", "pres.tBig": "Il quadro generale",
      "pres.tKey": "I punti chiave", "pres.tRemember": "Cosa ricordare",
      "pres.tTimeline": "Come si collega tutto", "pres.tStructure": "Il percorso dell'argomento",
      "pres.tDef": "Concetto chiave", "pres.tCompare": "Due idee a confronto",
      "pres.tHighlight": "Per l'esame", "pres.tClose": "Ripasso finale",
      "pres.closeSub": "Padroneggia questi punti e avrai l'argomento.",
      "gen.pres1": "Analizzando i tuoi appunti…", "gen.pres2": "Organizzando le idee…", "gen.pres3": "Creando la struttura…",
      "gen.pres4": "Selezionando gli elementi visivi…", "gen.pres5": "Preparando la tua presentazione…",
      "gen.pod1": "Analizzando i tuoi appunti…", "gen.pod2": "Scrivendo il copione…", "gen.pod3": "Regolando tono e ritmo…",
      "gen.pod4": "Preparando l'audio…",
      "gen.map1": "Analizzando i tuoi appunti…", "gen.map2": "Rilevando i concetti…", "gen.map3": "Tracciando i collegamenti…",
      "gen.done": "Pronto!",
      "pod.approach": "Come vuoi impararlo?",
      "pod.apExplain": "Spiegazione", "pod.apExplainS": "Da zero, passo dopo passo",
      "pod.apReview": "Ripasso", "pod.apReviewS": "Veloce, prima dell'esame",
      "pod.apConv": "Conversazione", "pod.apConvS": "Due voci che chiacchierano",
      "pod.duration": "Durata", "pod.voice": "Voce", "pod.voiceStyle": "Stile di voce",
      "pod.voice1": "Voce 1", "pod.voice2": "Voce 2",
      "pod.voice1S": "Calda", "pod.voice2S": "Chiara",
      "pod.vsNatural": "Naturale", "pod.vsTeacher": "Professore", "pod.vsPodcast": "Podcast", "pod.vsConv": "Conversazione",
      "pod.generate": "Genera podcast",
      "pod.coverSub": "{approach} · {min} min",
      "pod.volume": "Volume",
      "pod.transcript": "Trascrizione", "pod.follow": "Segue l'audio",
      "pod.back15": "−15 s", "pod.fwd15": "+15 s",
      "pod.ambientNote": "Lettore funzionante con audio ambientale dimostrativo (Web Audio API). La voce TTS con «{voice} · {style}» è pronta per collegare un servizio di generazione vocale.",
      "pod.ambientNoteNoAudio": "Lettore dimostrativo. La voce TTS con «{voice} · {style}» è pronta per collegare un servizio di generazione vocale.",
      "mat.upTitle": "Materiale analizzato", "mat.upSub": "Cosa vuoi fare con questo materiale?"
    },
    fr: {
      "pres.st0": "Minimal", "pres.st1": "Éditorial", "pres.st2": "Académique", "pres.st3": "Visuel", "pres.st4": "Sombre",
      "pres.style": "Style de présentation",
      "pres.genPrefix": "Présentation",
      "pres.byZynqora": "Généré par Zynqora AI",
      "pres.slides": "{n} diapositives",
      "pres.present": "Mode présentation", "pres.exit": "Quitter",
      "pres.thumbs": "Vignettes",
      "pres.note": "Présentation de démonstration générée à partir de ton contenu · style {style}. Les visuels s'adaptent au sujet.",
      "pres.tWhy": "Pourquoi c'est important", "pres.tBig": "La vue d'ensemble",
      "pres.tKey": "Les points clés", "pres.tRemember": "Ce qu'il faut retenir",
      "pres.tTimeline": "Comment tout s'articule", "pres.tStructure": "Le parcours du sujet",
      "pres.tDef": "Concept clé", "pres.tCompare": "Deux idées face à face",
      "pres.tHighlight": "Pour l'examen", "pres.tClose": "Révision finale",
      "pres.closeSub": "Maîtrise ces points et le sujet sera acquis.",
      "gen.pres1": "Analyse de tes notes…", "gen.pres2": "Organisation des idées…", "gen.pres3": "Construction de la structure…",
      "gen.pres4": "Sélection des visuels…", "gen.pres5": "Préparation de ta présentation…",
      "gen.pod1": "Analyse de tes notes…", "gen.pod2": "Écriture du script…", "gen.pod3": "Ajustement du ton et du rythme…",
      "gen.pod4": "Préparation de l'audio…",
      "gen.map1": "Analyse de tes notes…", "gen.map2": "Détection des concepts…", "gen.map3": "Traçage des connexions…",
      "gen.done": "Prêt !",
      "pod.approach": "Comment veux-tu l'apprendre ?",
      "pod.apExplain": "Explication", "pod.apExplainS": "En partant de zéro, étape par étape",
      "pod.apReview": "Révision", "pod.apReviewS": "Rapide, avant l'examen",
      "pod.apConv": "Conversation", "pod.apConvS": "Deux voix qui discutent",
      "pod.duration": "Durée", "pod.voice": "Voix", "pod.voiceStyle": "Style de voix",
      "pod.voice1": "Voix 1", "pod.voice2": "Voix 2",
      "pod.voice1S": "Chaleureuse", "pod.voice2S": "Claire",
      "pod.vsNatural": "Naturel", "pod.vsTeacher": "Professeur", "pod.vsPodcast": "Podcast", "pod.vsConv": "Conversation",
      "pod.generate": "Générer le podcast",
      "pod.coverSub": "{approach} · {min} min",
      "pod.volume": "Volume",
      "pod.transcript": "Transcription", "pod.follow": "Suit l'audio",
      "pod.back15": "−15 s", "pod.fwd15": "+15 s",
      "pod.ambientNote": "Lecteur fonctionnel avec une piste d'ambiance de démonstration (Web Audio API). La voix TTS avec « {voice} · {style} » est prête à connecter un service de génération vocale.",
      "pod.ambientNoteNoAudio": "Lecteur de démonstration. La voix TTS avec « {voice} · {style} » est prête à connecter un service de génération vocale.",
      "mat.upTitle": "Contenu analysé", "mat.upSub": "Que veux-tu faire avec ce contenu ?"
    },
    pt: {
      "pres.st0": "Minimal", "pres.st1": "Editorial", "pres.st2": "Académico", "pres.st3": "Visual", "pres.st4": "Escuro",
      "pres.style": "Estilo da apresentação",
      "pres.genPrefix": "Apresentação",
      "pres.byZynqora": "Gerado pela Zynqora AI",
      "pres.slides": "{n} diapositivos",
      "pres.present": "Modo apresentação", "pres.exit": "Sair",
      "pres.thumbs": "Miniaturas",
      "pres.note": "Apresentação de demonstração gerada a partir do teu material · estilo {style}. Os elementos visuais adaptam-se ao tema.",
      "pres.tWhy": "Porque é importante", "pres.tBig": "A ideia geral",
      "pres.tKey": "Os pontos-chave", "pres.tRemember": "O que deves recordar",
      "pres.tTimeline": "Como tudo encaixa", "pres.tStructure": "O percurso do tema",
      "pres.tDef": "Conceito-chave", "pres.tCompare": "Duas ideias lado a lado",
      "pres.tHighlight": "Para o exame", "pres.tClose": "Revisão final",
      "pres.closeSub": "Domina estes pontos e terás o tema dominado.",
      "gen.pres1": "A analisar os teus apontamentos…", "gen.pres2": "A organizar as ideias…", "gen.pres3": "A criar a estrutura…",
      "gen.pres4": "A selecionar elementos visuais…", "gen.pres5": "A preparar a tua apresentação…",
      "gen.pod1": "A analisar os teus apontamentos…", "gen.pod2": "A escrever o guião…", "gen.pod3": "A ajustar o tom e o ritmo…",
      "gen.pod4": "A preparar o áudio…",
      "gen.map1": "A analisar os teus apontamentos…", "gen.map2": "A detetar conceitos…", "gen.map3": "A traçar as ligações…",
      "gen.done": "Pronto!",
      "pod.approach": "Como queres aprender isto?",
      "pod.apExplain": "Explicação", "pod.apExplainS": "Do zero, passo a passo",
      "pod.apReview": "Revisão", "pod.apReviewS": "Rápida, antes do exame",
      "pod.apConv": "Conversa", "pod.apConvS": "Duas vozes a conversar",
      "pod.duration": "Duração", "pod.voice": "Voz", "pod.voiceStyle": "Estilo de voz",
      "pod.voice1": "Voz 1", "pod.voice2": "Voz 2",
      "pod.voice1S": "Calorosa", "pod.voice2S": "Clara",
      "pod.vsNatural": "Natural", "pod.vsTeacher": "Professor", "pod.vsPodcast": "Podcast", "pod.vsConv": "Conversa",
      "pod.generate": "Gerar podcast",
      "pod.coverSub": "{approach} · {min} min",
      "pod.volume": "Volume",
      "pod.transcript": "Transcrição", "pod.follow": "Segue o áudio",
      "pod.back15": "−15 s", "pod.fwd15": "+15 s",
      "pod.ambientNote": "Leitor funcional com áudio ambiente de demonstração (Web Audio API). A voz TTS com «{voice} · {style}» está pronta para ligar a um serviço de geração de voz.",
      "pod.ambientNoteNoAudio": "Leitor de demonstração. A voz TTS com «{voice} · {style}» está pronta para ligar a um serviço de geração de voz.",
      "mat.upTitle": "Material analisado", "mat.upSub": "O que queres fazer com este material?"
    }
  });
  ...
  (function (P) {
    ...
    es: {
      ...
      "auth.gateNote": "Crea tu cuenta gratis para empezar. Es obligatorio verificar el email.",
      "auth.checkEmailTitle": "Revisa tu correo",
      "auth.checkEmailSub": "Te hemos enviado un enlace de verificación a {email}. Ábrelo desde este dispositivo para activar tu cuenta.",
      "auth.backToForm": "Volver",
      "auth.linkExpired": "Ese enlace ya no es válido o ha caducado. Pide uno nuevo iniciando sesión o registrándote de nuevo.",
    ...
    en: {
      ...
      "auth.gateNote": "Create your free account to get started. Email verification is required.",
      "auth.checkEmailTitle": "Check your email",
      "auth.checkEmailSub": "We've sent a verification link to {email}. Open it on this device to activate your account.",
      "auth.backToForm": "Back",
      "auth.linkExpired": "That link is invalid or has expired. Get a new one by signing in or registering again.",
      "auth.google": "Continue with Google", "auth.or": "or"
    },
    it: {
      "ai.modeDemo": "Demo", "ai.modeReal": "IA reale",
      "ai.sources": "Fonti",
      "ai.demoNote": "Modalità demo · motore locale di Zynqora AI. Collega il tuo server per l'IA reale (Gemini), la ricerca web e la voce.",
      "ai.realNote": "Zynqora AI connesso. Risposte, ricerca web e voce reali.",
      "gen.pod1": "Analizzando il materiale…", "gen.pod2": "Creando il copione…", "gen.pod3": "Preparando la narrazione…",
      "gen.pod4": "Generando la voce…", "gen.pod5": "Preparando l'audio…",
      "gen.errTitle": "Non siamo riusciti a generarlo in questo momento",
      "gen.errBody": "Zynqora AI non ha risposto. Riprova.",
      "gen.retry": "Riprova",
      "pod.noteReal": "Voce generata da Zynqora AI, con pause, intonazione e pronuncia naturale di date e numeri.",
      "pod.noteBrowser": "Voce del browser (demo) con direzione vocale applicata: pause, ritmo variabile e pronuncia naturale di date e numeri («1789» → «millesettecentottantanove»). Una volta connesso, il copione e questa stessa direzione andranno a Gemini TTS (voce di studio di alta qualità).",
      "pod.noteScript": "Anteprima del copione. Il tuo browser non può leggere la voce; collega Zynqora AI per la voce generata.",
      "pod.music": "Musica di sottofondo",
      "pod.noVoice": "Il tuo browser non può riprodurre la voce. Collega Zynqora AI per la voce generata.",
      "pod.twoVoices": "Due voci", "pod.voiceA": "Voce A", "pod.voiceB": "Voce B",
      "pod.prevLine": "Frase precedente", "pod.nextLine": "Frase successiva",
      "set.ai": "Zynqora AI", "set.aiMode": "Modalità",
      "set.aiDemo": "Demo · motore locale + voce del browser",
      "set.aiReal": "IA reale · Gemini",
      "set.aiEndpoint": "Server di Zynqora AI",
      "set.aiEndpointPh": "https://tuo-server…/zynqora-ai",
      "set.aiConnect": "Connetti", "set.aiDisconnect": "Disconnetti",
      "set.aiHelp": "In modalità demo, Zynqora AI usa un motore locale e la voce del browser. Collega il tuo server (un proxy di Gemini) per attivare l'IA reale, la ricerca web e la voce Gemini TTS.",
      "set.aiKeyNote": "L'app non salva mai alcuna API key. La chiave GEMINI_API_KEY vive solo sul tuo server. Codice e guida: docs/DEPLOY.md",
      "set.aiConnected": "Connesso a Zynqora AI",
      "set.cloud": "Zynqora Cloud (Supabase)",
      "set.cloudHelp": "Collega un progetto Supabase per salvare i tuoi dati nel cloud, accedere e usare l'IA reale di Gemini in modo sicuro. La guida passo passo (senza saper programmare) è in docs/DEPLOY.md.",
      "set.cloudUrl": "URL di Supabase", "set.cloudUrlPh": "https://xxxx.supabase.co",
      "set.cloudKey": "Chiave pubblica (anon)", "set.cloudKeyPh": "eyJhbGciOiJI…",
      "set.cloudConnect": "Connetti", "set.cloudConnected": "Cloud connesso",
      "set.cloudDisconnect": "Disconnetti cloud",
      "set.cloudLocalNote": "Senza connessione, i tuoi dati vengono salvati solo su questo dispositivo (IndexedDB).",
      "auth.title": "Zynqora Cloud", "auth.signin": "Accedi", "auth.signup": "Crea account",
      "auth.email": "Email", "auth.password": "Password", "auth.name": "Nome",
      "auth.forgot": "Ho dimenticato la password", "auth.recoverSent": "Se l'email esiste, ti abbiamo inviato un link.",
      "auth.noCloud": "Non hai ancora connesso Supabase. Vai su Impostazioni → Zynqora Cloud, oppure apri docs/DEPLOY.md.",
      "auth.signedInAs": "Sessione avviata come", "auth.signout": "Esci",
      "auth.toSignup": "Non hai un account? Creane uno", "auth.toSignin": "Hai già un account? Accedi",
      "auth.err": "Non è stato possibile completare l'operazione. Controlla email e password.",
      "auth.gateNote": "Crea il tuo account gratuito per iniziare. È obbligatorio verificare l'email.",
      "auth.checkEmailTitle": "Controlla la tua email",
      "auth.checkEmailSub": "Ti abbiamo inviato un link di verifica a {email}. Aprilo da questo dispositivo per attivare il tuo account.",
      "auth.backToForm": "Indietro",
      "auth.linkExpired": "Quel link non è più valido o è scaduto. Richiedine uno nuovo accedendo o registrandoti di nuovo.",
      "auth.google": "Continua con Google", "auth.or": "o"
    },
    fr: {
      "ai.modeDemo": "Démo", "ai.modeReal": "IA réelle",
      "ai.sources": "Sources",
      "ai.demoNote": "Mode démo · moteur local de Zynqora AI. Connecte ton serveur pour l'IA réelle (Gemini), la recherche web et la voix.",
      "ai.realNote": "Zynqora AI connecté. Réponses, recherche web et voix réelles.",
      "gen.pod1": "Analyse du contenu…", "gen.pod2": "Écriture du script…", "gen.pod3": "Préparation de la narration…",
      "gen.pod4": "Génération de la voix…", "gen.pod5": "Préparation de l'audio…",
      "gen.errTitle": "Nous n'avons pas pu le générer pour le moment",
      "gen.errBody": "Zynqora AI n'a pas répondu. Réessaie.",
      "gen.retry": "Réessayer",
      "pod.noteReal": "Voix générée par Zynqora AI, avec pauses, intonation et prononciation naturelle des dates et des nombres.",
      "pod.noteBrowser": "Voix du navigateur (démo) avec direction vocale appliquée : pauses, rythme variable et prononciation naturelle des dates et des nombres (« 1789 » → « dix-sept cent quatre-vingt-neuf »). Une fois connecté, le script et cette même direction sont envoyés à Gemini TTS (voix d'étude haute qualité).",
      "pod.noteScript": "Aperçu du script. Ton navigateur ne peut pas lire la voix ; connecte Zynqora AI pour la voix générée.",
      "pod.music": "Musique de fond",
      "pod.noVoice": "Ton navigateur ne peut pas lire la voix. Connecte Zynqora AI pour la voix générée.",
      "pod.twoVoices": "Deux voix", "pod.voiceA": "Voix A", "pod.voiceB": "Voix B",
      "pod.prevLine": "Phrase précédente", "pod.nextLine": "Phrase suivante",
      "set.ai": "Zynqora AI", "set.aiMode": "Mode",
      "set.aiDemo": "Démo · moteur local + voix du navigateur",
      "set.aiReal": "IA réelle · Gemini",
      "set.aiEndpoint": "Serveur Zynqora AI",
      "set.aiEndpointPh": "https://ton-serveur…/zynqora-ai",
      "set.aiConnect": "Connecter", "set.aiDisconnect": "Déconnecter",
      "set.aiHelp": "En mode démo, Zynqora AI utilise un moteur local et la voix du navigateur. Connecte ton serveur (un proxy Gemini) pour activer l'IA réelle, la recherche web et la voix Gemini TTS.",
      "set.aiKeyNote": "L'application ne stocke jamais de clé API. La clé GEMINI_API_KEY vit uniquement sur ton serveur. Code et guide : docs/DEPLOY.md",
      "set.aiConnected": "Connecté à Zynqora AI",
      "set.cloud": "Zynqora Cloud (Supabase)",
      "set.cloudHelp": "Connecte un projet Supabase pour enregistrer tes données dans le cloud, te connecter et utiliser l'IA réelle Gemini en toute sécurité. Le guide pas à pas (sans savoir coder) se trouve dans docs/DEPLOY.md.",
      "set.cloudUrl": "URL Supabase", "set.cloudUrlPh": "https://xxxx.supabase.co",
      "set.cloudKey": "Clé publique (anon)", "set.cloudKeyPh": "eyJhbGciOiJI…",
      "set.cloudConnect": "Connecter", "set.cloudConnected": "Cloud connecté",
      "set.cloudDisconnect": "Déconnecter le cloud",
      "set.cloudLocalNote": "Sans connexion, tes données sont enregistrées uniquement sur cet appareil (IndexedDB).",
      "auth.title": "Zynqora Cloud", "auth.signin": "Se connecter", "auth.signup": "Créer un compte",
      "auth.email": "Email", "auth.password": "Mot de passe", "auth.name": "Nom",
      "auth.forgot": "J'ai oublié le mot de passe", "auth.recoverSent": "Si cet email existe, nous t'avons envoyé un lien.",
      "auth.noCloud": "Tu n'as pas encore connecté Supabase. Va dans Paramètres → Zynqora Cloud, ou ouvre docs/DEPLOY.md.",
      "auth.signedInAs": "Connecté en tant que", "auth.signout": "Se déconnecter",
      "auth.toSignup": "Pas de compte ? En créer un", "auth.toSignin": "Déjà un compte ? Se connecter",
      "auth.err": "Impossible de terminer. Vérifie l'email et le mot de passe.",
      "auth.gateNote": "Crée ton compte gratuit pour commencer. La vérification de l'email est obligatoire.",
      "auth.checkEmailTitle": "Vérifie ton email",
      "auth.checkEmailSub": "Nous t'avons envoyé un lien de vérification à {email}. Ouvre-le depuis cet appareil pour activer ton compte.",
      "auth.backToForm": "Retour",
      "auth.linkExpired": "Ce lien n'est plus valable ou a expiré. Demandes-en un nouveau en te connectant ou en t'inscrivant à nouveau.",
      "auth.google": "Continuer avec Google", "auth.or": "ou"
    },
    pt: {
      "ai.modeDemo": "Demo", "ai.modeReal": "IA real",
      "ai.sources": "Fontes",
      "ai.demoNote": "Modo demo · motor local da Zynqora AI. Liga o teu servidor para a IA real (Gemini), pesquisa na web e voz.",
      "ai.realNote": "Zynqora AI ligada. Respostas, pesquisa na web e voz reais.",
      "gen.pod1": "A analisar o material…", "gen.pod2": "A criar o guião…", "gen.pod3": "A preparar a narração…",
      "gen.pod4": "A gerar a voz…", "gen.pod5": "A preparar o áudio…",
      "gen.errTitle": "Não conseguimos gerar isto agora",
      "gen.errBody": "A Zynqora AI não respondeu. Tenta novamente.",
      "gen.retry": "Tentar novamente",
      "pod.noteReal": "Voz gerada pela Zynqora AI, com pausas, entoação e pronúncia natural de datas e números.",
      "pod.noteBrowser": "Voz do navegador (demo) com direção de voz aplicada: pausas, ritmo variável e pronúncia natural de datas e números («1789» → «mil setecentos e oitenta e nove»). Depois de ligado, o guião e esta mesma direção vão para o Gemini TTS (voz de estudo de alta qualidade).",
      "pod.noteScript": "Pré-visualização do guião. O teu navegador não consegue ler a voz; liga a Zynqora AI para a voz gerada.",
      "pod.music": "Música de fundo",
      "pod.noVoice": "O teu navegador não consegue reproduzir a voz. Liga a Zynqora AI para a voz gerada.",
      "pod.twoVoices": "Duas vozes", "pod.voiceA": "Voz A", "pod.voiceB": "Voz B",
      "pod.prevLine": "Frase anterior", "pod.nextLine": "Frase seguinte",
      "set.ai": "Zynqora AI", "set.aiMode": "Modo",
      "set.aiDemo": "Demo · motor local + voz do navegador",
      "set.aiReal": "IA real · Gemini",
      "set.aiEndpoint": "Servidor da Zynqora AI",
      "set.aiEndpointPh": "https://teu-servidor…/zynqora-ai",
      "set.aiConnect": "Ligar", "set.aiDisconnect": "Desligar",
      "set.aiHelp": "No modo demo, a Zynqora AI usa um motor local e a voz do navegador. Liga o teu servidor (um proxy do Gemini) para ativar a IA real, a pesquisa na web e a voz Gemini TTS.",
      "set.aiKeyNote": "A app nunca guarda nenhuma API key. A chave GEMINI_API_KEY vive apenas no teu servidor. Código e guia: docs/DEPLOY.md",
      "set.aiConnected": "Ligado à Zynqora AI",
      "set.cloud": "Zynqora Cloud (Supabase)",
      "set.cloudHelp": "Liga um projeto Supabase para guardar os teus dados na nuvem, iniciar sessão e usar a IA real do Gemini com segurança. O guia passo a passo (sem saber programar) está em docs/DEPLOY.md.",
      "set.cloudUrl": "URL do Supabase", "set.cloudUrlPh": "https://xxxx.supabase.co",
      "set.cloudKey": "Chave pública (anon)", "set.cloudKeyPh": "eyJhbGciOiJI…",
      "set.cloudConnect": "Ligar", "set.cloudConnected": "Cloud ligada",
      "set.cloudDisconnect": "Desligar cloud",
      "set.cloudLocalNote": "Sem ligação, os teus dados são guardados apenas neste dispositivo (IndexedDB).",
      "auth.title": "Zynqora Cloud", "auth.signin": "Iniciar sessão", "auth.signup": "Criar conta",
      "auth.email": "Email", "auth.password": "Palavra-passe", "auth.name": "Nome",
      "auth.forgot": "Esqueci-me da palavra-passe", "auth.recoverSent": "Se esse email existir, enviámos-te um link.",
      "auth.noCloud": "Ainda não ligaste o Supabase. Vai a Definições → Zynqora Cloud, ou abre docs/DEPLOY.md.",
      "auth.signedInAs": "Sessão iniciada como", "auth.signout": "Terminar sessão",
      "auth.toSignup": "Não tens conta? Cria uma", "auth.toSignin": "Já tens conta? Inicia sessão",
      "auth.err": "Não foi possível concluir. Verifica o email e a palavra-passe.",
      "auth.gateNote": "Cria a tua conta gratuita para começar. É obrigatório verificar o email.",
      "auth.checkEmailTitle": "Verifica o teu email",
      "auth.checkEmailSub": "Enviámos um link de verificação para {email}. Abre-o neste dispositivo para ativares a tua conta.",
      "auth.backToForm": "Voltar",
      "auth.linkExpired": "Esse link já não é válido ou expirou. Pede um novo ao iniciar sessão ou ao registares-te novamente.",
      "auth.google": "Continuar com Google", "auth.or": "ou"
    }
  });
  ...
  var STOPWORDS = {
    ...
    it: ("il lo la i gli le un uno una di del dello della dei degli delle a al allo alla ai agli alle e o ma che chi cui non ne si se come più meno molto tanto già poi quando dove quale quali perché però anche così quindi ci vi ha hanno ho hai abbiamo avete essere è sono era erano fu fui questo questa questi queste quello quella quelli quelle suo sua suoi sue mio mia miei mie tuo tua tuoi tue nostro nostra vostro vostra loro per con senza su tra fra sopra sotto dentro fuori verso durante mediante uno due tre parte modo volta volte caso casi fatto tutto tutta tutti tutte altro altra altri altre stesso stessa").split(/\s+/),
    fr: ("le la les un une des de du au aux et ou que qui quoi dont où se sa ses son mes mon ma tes ton ta nos notre vos votre leur leurs se ce cet cette ces cela ceci celui celle ceux celles est sont était étaient fut être été suis es sommes êtes ont a avons avez avoir eu pour avec sans sur sous entre dans par vers chez comme plus moins très aussi déjà donc alors puis ainsi quand lorsque parce car mais cependant toutefois tout toute tous toutes autre autres même mêmes un deux trois partie façon fois cas fait à en").split(/\s+/),
    pt: ("o a os as um uma uns umas de do da dos das ao aos à às e ou que quem qual quais onde quando porque mas também assim então pois há tem têm foi foram era eram ser é são está estão estar este esta estes estas esse essa esses essas aquele aquela aqueles aquelas seu sua seus suas meu minha meus minhas teu tua teus tuas nosso nossa nossos nossas para com sem sobre entre até desde após ante sob perante durante mediante como mais menos muito tanto já não nem se sim cada todo toda todos todas outro outra outros outras mesmo mesma um dois três parte forma vez vezes caso casos feito através em").split(/\s+/)
  };
  ...
  /* Frases de plantilla para las materias de idioma (it/fr/pt) — el resto de
     la app sigue solo en es/en, pero el contenido generado para una materia
     marcada como idioma usa estas. */
  var GLANG = {
    es: { qIs: "¿Qué es ", qWas: "¿Qué fue ", fill: "Completa la frase — ", whichWord: "¿Qué palabra completa esta frase del documento?", docSays: "El documento dice: ", fromDoc: "Según el documento:", notFound: "No encuentro eso en este documento. Trata sobre: ", analyse: "Analiza y relaciónalo con el resto del tema", define: "Define en una frase", explainOwn: "Explícalo con tus palabras", summMain: "Resume la idea principal del documento en 3 líneas." },
    en: { qIs: "What is ", qWas: "What was ", fill: "Fill in the blank — ", whichWord: "Which word completes this line from the document?", docSays: "The document reads: ", fromDoc: "From the document:", notFound: "I couldn't find that in this document. It covers: ", analyse: "Analyse and relate to the rest of the topic", define: "Define in one sentence", explainOwn: "Explain in your own words", summMain: "Summarise the main idea of the document in 3 lines." },
    it: { qIs: "Che cos'è ", qWas: "Che cos'era ", fill: "Completa la frase — ", whichWord: "Quale parola completa questa frase del documento?", docSays: "Il documento dice: ", fromDoc: "Secondo il documento:", notFound: "Non trovo questo nel documento. Tratta di: ", analyse: "Analizza e collega al resto dell'argomento", define: "Definisci in una frase", explainOwn: "Spiegalo con parole tue", summMain: "Riassumi l'idea principale del documento in 3 righe." },
    fr: { qIs: "Qu'est-ce que ", qWas: "Qu'était ", fill: "Complète la phrase — ", whichWord: "Quel mot complète cette phrase du document ?", docSays: "Le document dit : ", fromDoc: "D'après le document :", notFound: "Je ne trouve pas cela dans ce document. Il traite de : ", analyse: "Analyse et relie au reste du sujet", define: "Définis en une phrase", explainOwn: "Explique-le avec tes propres mots", summMain: "Résume l'idée principale du document en 3 lignes." },
    pt: { qIs: "O que é ", qWas: "O que foi ", fill: "Completa a frase — ", whichWord: "Que palavra completa esta frase do documento?", docSays: "O documento diz: ", fromDoc: "Segundo o documento:", notFound: "Não encontro isso neste documento. Trata de: ", analyse: "Analisa e relaciona com o resto do tema", define: "Define numa frase", explainOwn: "Explica por palavras tuas", summMain: "Resume a ideia principal do documento em 3 linhas." }
  };
  function gl(lang) { return GLANG[lang || DB.lang] || GLANG.es; }

  /* --------- generación local extractiva a partir del texto real --------- */
  var DocGen = (function () {
    function sw() { var m = STOPWORDS[DB.lang] || STOPWORDS.es, o = {}; m.forEach(function (w) { o[w] = 1; }); return o; }
    ...
    function flashcards(text, n, lang) {
      n = n || 8;
      var a = analyze(text), L2 = gl(lang), cards = [];
      a.sents.forEach(function (s) {
        ...
        if (m) cards.push({ q: ((/\b(is|are|es|son)\b/i.test(m[2]) ? L2.qIs : L2.qWas) + m[1].trim() + "?"), a: s.replace(/\s+/g, " ").trim() });
      });
      ...
      for (var i = 0; i < pool.length && cards.length < n; i++) {
        ...
        if (s2 && !cards.some(function (c) { return c.a.toLowerCase() === term.toLowerCase(); })) {
          cards.push({ q: L2.fill + s2.replace(re, "$1_____$3"), a: term });
        }
      }
    ...
    function quiz(text, n, difficulty, lang) {
      n = n || 5;
      var a = analyze(text), L2 = gl(lang);
    ...
    function exercises(text, tier, lang) {
      var a = analyze(text), L2 = gl(lang), out = [];
      var verb = tier === "hard" ? L2.analyse : tier === "easy" ? L2.define : L2.explainOwn;
      ...
      if (!out.length) out.push({ q: L2.summMain, steps: [], a: a.sents.slice(0, 2).join(" ") });
      return out;
    }
    function answer(text, question, lang) {
      var a = analyze(text), L2 = gl(lang);
      ...
      if (!ranked.length) return { html: "<p>" + L2.notFound + a.concepts.slice(0, 4).join(", ") + ".</p>", grounded: false, tutor: true };
      var picks = [];
      ...
      return { html: "<p>" + L2.fromDoc + "</p><blockquote>" + esc(quote) + "</blockquote>", grounded: true, tutor: true };
    }
  ...
  function docFlashcards(d, n) {
    ...
    if (!d.flashcards || !d.flashcards.length) {
      d.flashcards = DocGen.flashcards(d.text, n || 8, docLang(d));
  ...
  function docQuiz(d, n, difficulty) {
    ...
    if (!d.quiz || !d.quiz.length) {
      d.quiz = DocGen.quiz(d.text, n || 5, difficulty, docLang(d));
  ...
  function uid() { try { if (crypto && crypto.randomUUID) return crypto.randomUUID(); } catch (e) {} return "id" + Math.random().toString(36).slice(2, 9) + Date.now().toString(36); }
  ...
  // Mientras arranca la app (cargando el caché local, sembrando datos de
  // muestra, o volcando lo que acaba de traer la nube) NUNCA se manda nada a
  // Supabase desde aquí — solo se lee/hidrata. Se pone a false una vez que
  // el arranque termina; a partir de ahí, cada persist() sí sincroniza.
  var BOOTING = true;
  function persist(key) {
    if (PERSIST_MAP[key]) Store.schedule(key, PERSIST_MAP[key]);
    // Además de guardar en local (IndexedDB, arriba), si hay sesión activa mandamos
    // el mismo cambio a Supabase — "fire and forget": si falla (sin red, etc.) el
    // dato sigue a salvo en local y se reintentará en el próximo persist().
    if (BOOTING) return;
    try { if (typeof Sync !== "undefined" && Sync.enabled && Sync.enabled()) Sync.push(key); } catch (e) {}
  }
  ...
  function syncUser() {
    USER.name = (DB.profile && DB.profile.name) || (DB.lang === "en" ? "Student" : "Estudiante");
  ...
  var DB = {
    lang: (function () { var v = lsGet("zynqora.lang", "es"); return APP_LANGS.indexOf(v) >= 0 ? v : "es"; })(),
    ...
    profile: { id: (lsGet("zynqora.localUser", "") || ("u" + Math.random().toString(36).slice(2, 9))), name: (lsGet("zynqora.lang", "es") === "en" ? "Student" : "Estudiante"), email: "", avatar: lsGet("zynqora.avatar", "") },
  ...
  function resetLocalData() {
    ...
    DB.profile = { id: "u" + Math.random().toString(36).slice(2, 9), name: (DB.lang === "en" ? "Student" : "Estudiante"), email: "", avatar: "" };
  ...
  /* Cuenta nueva (o distinta) en este dispositivo -> el caché local (demo/otra
     cuenta) ya no aplica. Se limpia ANTES de pedir los datos reales a Supabase,
     para que nunca se mezclen materias/tareas/conversaciones de muestra con una
     cuenta real, ni datos de una cuenta con los de otra en el mismo navegador. */
  // Al arrancar: si hay una sesión guardada de una cuenta que NO es la que
  // tenemos cacheada en local (primer arranque en este navegador, u otra
  // cuenta distinta a la última usada aquí), limpiamos el local ANTES de
  // pintar nada — así nunca se ve la materia/tarea de muestra ni datos de
  // otra cuenta mientras llega la respuesta real de Supabase.
  function ensureAccountMatch() {
    var s = Auth.session();
    if (!s || !s.user || !s.user.id) return;
    if (!DB.profile || DB.profile.id !== s.user.id) {
      clearLocalForNewAccount();
      DB.profile = DB.profile || {};
      DB.profile.id = s.user.id;
      if (s.user.email) DB.profile.email = s.user.email;
    }
  }
  function clearLocalForNewAccount() {
    DB.subjects = []; DB.calendar = []; DB.conversations = []; DB.documents = []; DB.sessions = [];
    DB.currentSubjectId = null; DB.reviewsDueBySubject = {}; DB.lastTestBySubject = {};
    DB.pathProgress = {}; DB.studiedMin = 0; DB.streak = 0; DB.streakDates = []; DB._streakBumped = 0;
    DB.usage = { aiMessages: 0, files: 0, tests: 0, flashcards: 0, podcasts: 0, presentations: 0, conceptMaps: 0 };
    DB.onboardingDone = false; DB.plan = "free"; DB.avatar = "";
    // También el nombre/foto: si no se limpian aquí, la cuenta nueva enseña
    // por un instante el nombre de la cuenta anterior hasta que llegue su
    // propio perfil desde Supabase (o hasta que rellene el suyo).
    DB.profile = DB.profile || {};
    DB.profile.name = "";
  }
  ...
  var USER = { name: (DB.lang === "en" ? "Student" : "Estudiante"), initial: (DB.lang === "en" ? "S" : "E") };

  function subj(id) { return DB.subjects.filter(function (s) { return s.id === (id || DB.currentSubjectId); })[0] || DB.subjects[0]; }
  // Idioma de estudio de una materia (si es una materia de idioma como Francés/Italiano/Portugués),
  // o el idioma normal de la app si no lo es. sid puede ser un id de materia o de documento->materia.
  function subjLang(sid) {
    var s = sid && DB.subjects.filter(function (x) { return x.id === sid; })[0];
    return (s && s.studyLang) || DB.lang;
  }
  function docLang(d) { return d ? subjLang(d.subjectId) : DB.lang; }
  ...
  var ZAI = {
    greet: {
      ...
      it: [
        "<p>Ciao! 👋 Che bello vederti. Cosa vuoi studiare oggi?</p>",
        "<p>Ciao! 😊 Sono pronta ad aiutarti. Ripassiamo qualcosa, chiariamo un dubbio o ti faccio una verifica?</p>",
        "<p>Ciao di nuovo! Da dove vuoi iniziare?</p>",
        "<p>Ehi! Sono felice di vederti. Dimmi cosa ti serve e iniziamo.</p>"
      ],
      fr: [
        "<p>Salut ! 👋 Ravi de te voir. Qu'est-ce que tu veux étudier aujourd'hui ?</p>",
        "<p>Coucou ! 😊 Je suis prête à t'aider. On révise quelque chose, on éclaircit un doute ou je te teste ?</p>",
        "<p>Rebonjour ! Par où veux-tu commencer ?</p>",
        "<p>Hé ! Content de te voir. Dis-moi ce dont tu as besoin et on s'y met.</p>"
      ],
      pt: [
        "<p>Olá! 👋 Que bom ver-te por aqui. O que queres estudar hoje?</p>",
        "<p>Olá! 😊 Estou pronta para ajudar. Revemos algo, esclarecemos uma dúvida ou faço-te um teste?</p>",
        "<p>Olá de novo! Por onde queres começar?</p>",
        "<p>Ei! Fico contente em ver-te. Diz-me o que precisas e vamos a isso.</p>"
      ]
    },
    hello: {
      ...
      it: "<p>Ciao! 👋 Sono <strong>Zynqora AI</strong>.</p><p>Sono qui per aiutarti a studiare, rispondere ai tuoi dubbi e organizzare il tuo apprendimento.</p><p>Cosa vuoi fare oggi?</p>",
      fr: "<p>Salut ! 👋 Je suis <strong>Zynqora AI</strong>.</p><p>Je suis là pour t'aider à étudier, répondre à tes questions et organiser ton apprentissage.</p><p>Qu'est-ce que tu veux faire aujourd'hui ?</p>",
      pt: "<p>Olá! 👋 Sou a <strong>Zynqora AI</strong>.</p><p>Estou aqui para te ajudar a estudar, esclarecer dúvidas e organizar a tua aprendizagem.</p><p>O que queres fazer hoje?</p>"
    },
    ...
    bank: {
      ...
      it: {
        thanks: ["<p>Di niente! Sono qui quando vuoi continuare. 💪</p>", "<p>Piacere mio. In bocca al lupo con lo studio.</p>", "<p>Quando vuoi. Stai andando bene. 🙂</p>"],
        why_failed: "<p>Ripassiamo quell'errore. Quello che conta non è la risposta corretta in sé, ma <strong>perché</strong> l'altra opzione ti sembrava valida.</p><p>Torna all'enunciato, individua il dato chiave e controlla quale condizione non era soddisfatta. {topicline}</p>",
        improve: "<p>Per migliorare in <strong>{topic}</strong>, concentrati su <strong>{weak}</strong>.</p><ul><li>Ripassa il riassunto dell'argomento (5 min).</li><li>6 flashcard su quel concetto oggi.</li><li>Un test breve domani per fissarlo.</li></ul>",
        plan: "<p>Ecco come dividerei lo studio per il tuo esame:</p><ul><li><strong>Lun</strong> · Riassunto + 8 flashcard dell'argomento principale.</li><li><strong>Mar</strong> · Ripasso di {weak}.</li><li><strong>Mer</strong> · Flashcard su tutta la materia.</li><li><strong>Gio</strong> · Test di pratica completo.</li><li><strong>Ven</strong> · Ripasso leggero, senza stress.</li></ul><p class=\"ai-followup\">Posso aggiungere questo piano al tuo calendario, se ti va bene.</p>",
        prep_exam: "<p>Per preparare l'esame di <strong>{topic}</strong>, ti propongo tre blocchi:</p><ol><li><strong>Capire</strong>: leggi il riassunto e chiedimi ciò che non ti è chiaro.</li><li><strong>Praticare</strong>: flashcard + completa la parola di {c1} e {c2}.</li><li><strong>Verificare</strong>: un test completo e ripassiamo insieme gli errori.</li></ol><p>Dimmi la data e te lo suddivido per giorni.</p>",
        default_ctx: "<p>Dimmi cosa ti serve su <strong>{topic}</strong> e lo vediamo: un concetto, un esempio, un riassunto o un test.</p>",
        default_free: "<p>Dimmi cosa vuoi studiare e ti aiuto subito.</p>",
        detailed_generic: "<p>Te lo spiego passo dopo passo 👇</p><p><strong>1 · L'idea:</strong> prima fissa <strong>{term}</strong> in una frase, con parole tue.<br><strong>2 · Un esempio:</strong> cerca un caso concreto che già conosci e verificalo con quella frase.<br><strong>3 · Il dettaglio:</strong> nota la condizione o eccezione che spesso capita all'esame.</p><p>Dimmi il tuo corso o incollami il pezzo dei tuoi appunti su <strong>{term}</strong> e lo sviluppo con esempi al tuo livello.</p>",
        direct_generic: "<p>Vediamo <strong>{term}</strong> 👇</p><p>Per darti una risposta precisa mi serve un po' di più: dimmi <strong>di quale materia</strong> si tratta o <strong>incollami il pezzo dei tuoi appunti</strong>, e te lo spiego con la definizione, un esempio svolto e un trucco per ricordarlo.</p>",
        help_exercise: "<p>Vediamolo 👇</p><p>Per aiutarti davvero mi serve il <strong>testo dell'esercizio</strong> (incollalo qui o fagli una foto e allegala). Con quello te lo scompongo passo dopo passo.</p><p>Nel frattempo dimmi: cosa hai provato e dove ti sei bloccato?</p>",
        summarize: "<p>Per riassumerli mi serve il materiale: <strong>incolla il testo qui</strong> o allega il file, e se scegli un <strong>contesto</strong> sopra riassumo direttamente gli appunti di quella materia.</p>",
        quiz_intro: ["<p>Andiamo 👇</p>", "<p>Cominciamo 👇</p>", "<p>Ecco la prima 👇</p>"],
        quiz_generic: "<p>Verifichiamolo. Rispondimi a questo:</p><p><em>{qstem}</em></p>"
      },
      fr: {
        thanks: ["<p>De rien ! Je suis là quand tu veux continuer. 💪</p>", "<p>Avec plaisir. Bon courage pour tes études.</p>", "<p>Quand tu veux. Tu progresses bien. 🙂</p>"],
        why_failed: "<p>Reprenons cette erreur. Ce qui compte, ce n'est pas la bonne réponse elle-même, mais <strong>pourquoi</strong> l'autre option te semblait valable.</p><p>Reviens à l'énoncé, repère l'information clé et vérifie quelle condition n'était pas remplie. {topicline}</p>",
        improve: "<p>Pour progresser en <strong>{topic}</strong>, concentre-toi sur <strong>{weak}</strong>.</p><ul><li>Relis le résumé du sujet (5 min).</li><li>6 flashcards sur ce concept aujourd'hui.</li><li>Un test court demain pour bien le fixer.</li></ul>",
        plan: "<p>Voici comment je répartirais tes révisions pour l'examen :</p><ul><li><strong>Lun</strong> · Résumé + 8 flashcards du sujet principal.</li><li><strong>Mar</strong> · Révision de {weak}.</li><li><strong>Mer</strong> · Flashcards sur toute la matière.</li><li><strong>Jeu</strong> · Test blanc complet.</li><li><strong>Ven</strong> · Révision légère, sans stress.</li></ul><p class=\"ai-followup\">Je peux ajouter ce plan à ton calendrier si ça te convient.</p>",
        prep_exam: "<p>Pour préparer l'examen de <strong>{topic}</strong>, je te propose trois étapes :</p><ol><li><strong>Comprendre</strong> : lis le résumé et demande-moi ce qui n'est pas clair.</li><li><strong>S'entraîner</strong> : flashcards + complète le mot sur {c1} et {c2}.</li><li><strong>Vérifier</strong> : un test complet, puis on revoit tes erreurs ensemble.</li></ol><p>Donne-moi la date et je te le répartis par jour.</p>",
        default_ctx: "<p>Dis-moi ce dont tu as besoin sur <strong>{topic}</strong> et on s'en occupe : un concept, un exemple, un résumé ou un test.</p>",
        default_free: "<p>Dis-moi ce que tu veux étudier et je t'aide tout de suite.</p>",
        detailed_generic: "<p>Je t'explique étape par étape 👇</p><p><strong>1 · L'idée :</strong> fixe d'abord <strong>{term}</strong> en une phrase, avec tes propres mots.<br><strong>2 · Un exemple :</strong> trouve un cas concret que tu connais déjà et vérifie-le avec cette phrase.<br><strong>3 · La nuance :</strong> repère la condition ou l'exception qui tombe souvent à l'examen.</p><p>Dis-moi ta filière, ou colle-moi l'extrait de tes notes sur <strong>{term}</strong>, et je le développe avec des exemples à ton niveau.</p>",
        direct_generic: "<p>Voyons <strong>{term}</strong> 👇</p><p>Pour bien te répondre j'ai besoin d'un peu plus : dis-moi <strong>de quelle matière</strong> il s'agit ou <strong>colle-moi l'extrait de tes notes</strong>, et je t'explique avec la définition, un exemple résolu et une astuce pour t'en souvenir.</p>",
        help_exercise: "<p>Regardons ça 👇</p><p>Pour vraiment t'aider j'ai besoin de <strong>l'énoncé de l'exercice</strong> (colle-le ici, ou prends-le en photo et joins-la). Avec ça je te le décompose étape par étape.</p><p>En attendant, dis-moi : qu'as-tu déjà essayé et où es-tu bloqué ?</p>",
        summarize: "<p>Pour les résumer j'ai besoin du contenu : <strong>colle le texte ici</strong> ou joins le fichier, et si tu choisis un <strong>contexte</strong> ci-dessus je résume directement les notes de cette matière.</p>",
        quiz_intro: ["<p>C'est parti 👇</p>", "<p>On y va 👇</p>", "<p>Voici la première 👇</p>"],
        quiz_generic: "<p>Vérifions. Réponds à ceci :</p><p><em>{qstem}</em></p>"
      },
      pt: {
        thanks: ["<p>De nada! Estou aqui quando quiseres continuar. 💪</p>", "<p>Foi um prazer. Boa sorte com os estudos.</p>", "<p>Sempre que quiseres. Estás a ir bem. 🙂</p>"],
        why_failed: "<p>Vamos rever esse erro. O importante não é a resposta certa em si, mas <strong>porque</strong> é que a outra opção te pareceu válida.</p><p>Volta ao enunciado, localiza o dado-chave e verifica que condição não se cumpria. {topicline}</p>",
        improve: "<p>Para melhorares em <strong>{topic}</strong>, foca-te em <strong>{weak}</strong>.</p><ul><li>Revê o resumo do tema (5 min).</li><li>6 flashcards sobre esse conceito hoje.</li><li>Um teste curto amanhã para fixar.</li></ul>",
        plan: "<p>Assim distribuía o estudo para o teu exame:</p><ul><li><strong>Seg</strong> · Resumo + 8 flashcards do tema principal.</li><li><strong>Ter</strong> · Revisão de {weak}.</li><li><strong>Qua</strong> · Flashcards de toda a matéria.</li><li><strong>Qui</strong> · Teste de prática completo.</li><li><strong>Sex</strong> · Revisão leve, sem pressão.</li></ul><p class=\"ai-followup\">Posso adicionar este plano ao teu calendário, se te for bem.</p>",
        prep_exam: "<p>Para preparares o exame de <strong>{topic}</strong>, proponho três blocos:</p><ol><li><strong>Perceber</strong>: lê o resumo e pergunta-me o que não ficou claro.</li><li><strong>Praticar</strong>: flashcards + completa a palavra de {c1} e {c2}.</li><li><strong>Verificar</strong>: um teste completo e revemos os erros juntos.</li></ol><p>Diz-me a data e eu distribuo por dias.</p>",
        default_ctx: "<p>Diz-me o que precisas sobre <strong>{topic}</strong> e vemos: um conceito, um exemplo, um resumo ou um teste.</p>",
        default_free: "<p>Diz-me o que queres estudar e ajudo-te já.</p>",
        detailed_generic: "<p>Explico passo a passo 👇</p><p><strong>1 · A ideia:</strong> primeiro fixa <strong>{term}</strong> numa frase, por palavras tuas.<br><strong>2 · Um exemplo:</strong> procura um caso concreto que já conheças e testa-o com essa frase.<br><strong>3 · O pormenor:</strong> repara na condição ou exceção que costuma sair no exame.</p><p>Diz-me o teu curso ou cola aqui o trecho dos teus apontamentos sobre <strong>{term}</strong> e desenvolvo com exemplos ao teu nível.</p>",
        direct_generic: "<p>Vamos a <strong>{term}</strong> 👇</p><p>Para te dar uma resposta certeira preciso de mais um pouco: diz-me <strong>de que disciplina</strong> se trata ou <strong>cola o trecho dos teus apontamentos</strong>, e explico com a definição, um exemplo resolvido e um truque para memorizar.</p>",
        help_exercise: "<p>Vamos ver isso 👇</p><p>Para te ajudar mesmo preciso do <strong>enunciado do exercício</strong> (cola-o aqui ou tira uma foto e anexa-a). Com isso desmonto-o passo a passo.</p><p>Entretanto, diz-me: o que já tentaste e onde ficaste preso?</p>",
        summarize: "<p>Para os resumir preciso do material: <strong>cola o texto aqui</strong> ou anexa o ficheiro, e se escolheres um <strong>contexto</strong> acima resumo diretamente os apontamentos dessa disciplina.</p>",
        quiz_intro: ["<p>Vamos lá 👇</p>", "<p>Começamos 👇</p>", "<p>Aqui tens a primeira 👇</p>"],
        quiz_generic: "<p>Vamos verificar. Responde a isto:</p><p><em>{qstem}</em></p>"
      }
    },
  ...
  V.landing = function () {
    var s = cur();
    var heroLine = (s && s.doc) ? (L(s.name) + " · " + L(s.doc.title).replace(".pdf", "").replace(".PDF", "")) : t("landing.title");
    return '<div style="min-height:100%;display:flex;flex-direction:column;background:var(--app-bg)">' +
      '<header style="display:flex;align-items:center;justify-content:space-between;padding:22px 24px">' +
        ...
        '<button class="btn btn-ghost btn-sm" data-nav="auth">' + t("landing.signin") + "</button></header>" +
      '<div class="wrap" style="max-width:960px;flex:1;display:flex;flex-direction:column;justify-content:center;padding-top:24px;padding-bottom:40px">' +
        '<div class="landing-grid" style="display:grid;gap:40px">' +
          '<div style="max-width:30ch"><div class="pill accent" style="margin-bottom:18px"><span class="dot"></span>' + t("landing.badge") + "</div>" +
            ...
            '<div class="row" style="gap:10px;margin-top:26px"><button class="btn btn-primary btn-lg" data-nav="auth">' + t("landing.cta") + icon("arrowR", 16) + "</button></div>" +
          ...
          '<div class="hero-visual"><div style="position:absolute;inset:0;padding:22px;display:flex;flex-direction:column;gap:12px">' +
            '<div class="eyebrow">' + t("dash.nextStep") + '</div><div style="font-size:20px;font-weight:600;letter-spacing:-.02em">' + heroLine + "</div>" +
      ...
      '<div class="wrap wide"><div class="stagger" style="display:grid;grid-template-columns:repeat(auto-fill,minmax(250px,1fr));gap:14px">' +
        DB.subjects.map(function (s) {
          ...
          return '<button class="card" style="text-align:left" data-action="open-subject" data-id="' + s.id + '"><div class="row" style="gap:12px">' + subjIcon(s) +
            '<div style="flex:1;min-width:0"><div style="font-weight:600;letter-spacing:-.01em">' + L(s.name) + (s.studyLang ? " " + (LANG_SUBJ.filter(function (x) { return x.v === s.studyLang; })[0] || {}).flag : "") + '</div><div class="txt-sm txt-muted">' + ndocs + " " + (ndocs === 1 ? t("subjects.doc1") : t("subjects.docs")) + "</div></div>" +
  ...
  V.subject = function () {
    ...
    var head = topbar(L(s.name) + (s.studyLang ? " " + (LANG_SUBJ.filter(function (x) { return x.v === s.studyLang; })[0] || {}).flag : ""), { back: "subjects", actions: subjSwitcher() }) +
  ...
  var AI_CONFIG = {
    ...
    useCloudAI: false,                           // IA real (Gemini) desactivada por ahora a propósito: usamos el motor local aunque haya cuenta/nube activada
    // --- FASE F: backend de Supabase (cuentas + guardado en la nube) ---
    supabaseUrl: lsGet("zynqora.supabaseUrl", "https://ojggkovfsioriwnwzgce.supabase.co"),
    supabaseAnonKey: lsGet("zynqora.supabaseAnonKey", "sb_publishable_9z3AIGDtYQwVEGIXAQ2jKg_YdecvjpT"), // clave pública (la RLS protege los datos)
  ...
  function aiEndpointUrl() {
    if (!AI_CONFIG.useCloudAI) return "";
  ...
  function aiBadge() {
    return ""; // Zynqora ya no distingue "demo/real" de cara al usuario — un único motor de IA (Zynqora AI).
  }
  ...
  /* ---- Traduccion real bajo demanda ("traduce X al italiano", "how do you say X in French"...) ----
     Usa un servicio de traduccion gratuito (MyMemory) directamente desde el navegador del usuario.
     No hace falta ninguna clave ni servidor propio; es un extra aparte del motor local de Zynqora AI. */
  var TR_LANG_WORDS = {
    es: ["español", "espanol", "castellano", "spanish", "espagnol", "spagnolo", "espanhol"],
    en: ["ingles", "inglés", "english", "anglais", "inglese", "inglês"],
    it: ["italiano", "italian", "italien"],
    fr: ["frances", "francés", "french", "français", "francese", "francês"],
    pt: ["portugues", "portugués", "portuguese", "portugais", "portoghese", "português"],
    de: ["aleman", "alemán", "german", "allemand", "tedesco", "alemão"],
    ca: ["catalan", "catalán", "català"],
    gl: ["gallego", "galego"],
    eu: ["euskera", "vasco", "basque"],
    zh: ["chino", "chinese", "chinois", "cinese"],
    ja: ["japones", "japonés", "japanese", "japonais", "giapponese"],
    ru: ["ruso", "russian", "russe", "russo"],
    ar: ["arabe", "árabe", "arabic"]
  };
  function trStrip(s) { return (s || "").toLowerCase().normalize("NFD").replace(/[̀-ͯ]/g, ""); }
  function trLangCode(word) {
    var w = trStrip(word);
    for (var code in TR_LANG_WORDS) {
      var arr = TR_LANG_WORDS[code];
      for (var i = 0; i < arr.length; i++) { if (trStrip(arr[i]) === w) return code; }
    }
    return null;
  }
  var TR_LANG_NAMES_RE = Object.keys(TR_LANG_WORDS).map(function (c) { return TR_LANG_WORDS[c].join("|"); }).join("|");
  function detectTranslate(text) {
    var raw = (text || "").trim();
    if (!raw) return null;
    var re1 = new RegExp("\\b(?:traduc\\w*|translate\\w*|traduci\\w*|traduis\\w*|traduz\\w*)\\b" +
      "(?:\\s+(?:esto|esta\\s+frase|lo\\s+siguiente|this|questo|ceci|isto))?" +
      "(?:\\s+(?:de|from|da)\\s+(" + TR_LANG_NAMES_RE + "))?" +
      "\\s+(?:a|al|en|to|into|in|para)\\s+(" + TR_LANG_NAMES_RE + ")\\b" +
      "\\s*[:\\-–—]?\\s*(.*)$", "i");
    var m = raw.match(re1);
    if (m) {
      var tgt = trLangCode(m[2]), body = (m[3] || "").trim();
      if (tgt && body) return { text: body, src: m[1] ? trLangCode(m[1]) : null, tgt: tgt };
    }
    var re2 = new RegExp("\\b(?:c[oó]mo se dice|how do you say|come si dice|comment dit-on|como se diz)\\b\\s+(.+?)\\s+(?:en|in|em)\\s+(" + TR_LANG_NAMES_RE + ")\\s*\\??\\s*$", "i");
    var m2 = raw.match(re2);
    if (m2) {
      var tgt2 = trLangCode(m2[2]);
      if (tgt2 && m2[1]) return { text: m2[1].trim(), src: null, tgt: tgt2 };
    }
    return null;
  }
  var TR_FAIL_MSG = {
    es: "No he podido traducirlo ahora mismo (fallo de conexión con el traductor). Prueba de nuevo en un momento.",
    en: "I couldn't translate that right now (connection issue with the translator). Try again in a moment.",
    it: "Non sono riuscita a tradurlo in questo momento (problema di connessione con il traduttore). Riprova tra poco.",
    fr: "Je n'ai pas pu le traduire pour le moment (problème de connexion avec le traducteur). Réessaie dans un instant.",
  ...
  var DemoProvider = {
    ...
    chat: function (o) {
      var trq = detectTranslate(o.text || "");
      if (trq) {
        var srcC = trq.src || DB.lang;
        if (srcC === trq.tgt) srcC = trq.tgt === "es" ? "en" : "es";
        var url = "https://api.mymemory.translated.net/get?q=" + encodeURIComponent(trq.text) + "&langpair=" + srcC + "|" + trq.tgt;
        return fetch(url).then(function (res) { return res.json(); }).then(function (data) {
          ...
          return { html: "<p>" + esc(out) + "</p>", demo: true, translated: true };
        }).catch(function () {
          return { html: "<p>" + (TR_FAIL_MSG[DB.lang] || TR_FAIL_MSG.es) + "</p>", demo: true };
        });
      }
      ...
      // Si la conversación es de una materia de idioma (francés, italiano...),
      // que la IA conteste en ese idioma aunque la app esté en español/inglés.
      var effSid = ZAI.detectSubject(o.text) || o.contextId;
      var effLang = effSid ? subjLang(effSid) : DB.lang;
      var prevLang = DB.lang, r;
      if (effLang !== DB.lang) DB.lang = effLang;
  ...
  var Auth = (function () {
    ...
    function setSession(j) {
      ...
      if (j.user) {
        var isNewAccount = !DB.profile || DB.profile.id !== j.user.id;
        if (isNewAccount) { try { clearLocalForNewAccount(); } catch (e) {} }
        DB.profile = DB.profile || {};
    ...
    // Confirmación de email por enlace: Supabase redirige a Site URL con
    // #access_token=...&refresh_token=...&type=signup (o error=...&error_description=...).
    // Esto NO llega como típico "código de 6 dígitos" (eso exigiría SMTP propio) —
    // el usuario simplemente toca el enlace del correo y, al volver a la app, queda
    // verificado y con sesión iniciada automáticamente.
    function parseHash() {
      var h = (window.location.hash || "").replace(/^#/, "");
      if (!h || (h.indexOf("access_token") === -1 && h.indexOf("error") === -1)) return null;
      var p = {};
      h.split("&").forEach(function (kv) {
        var i = kv.indexOf("="); if (i < 0) return;
        try { p[decodeURIComponent(kv.slice(0, i))] = decodeURIComponent(kv.slice(i + 1).replace(/\+/g, " ")); } catch (e) {}
      });
      return (p.access_token || p.error) ? p : null;
    }
    function fetchUser(token) {
      return fetch(base() + "/auth/v1/user", { headers: { apikey: AI_CONFIG.supabaseAnonKey, authorization: "Bearer " + token } })
    ...
    return {
      ...
      // Botón "Continuar con Google": manda el navegador a Supabase, que a su vez
      // manda a Google. Al volver, Supabase redirige aquí mismo con
      // #access_token=... en la URL — lo recoge consumeRedirect() al arrancar,
      // igual que con el enlace de verificación de email.
      // prompt=select_account: sin esto, si el navegador ya tiene una sesión de
      // Google abierta, Google la reutiliza en silencio y siempre entra con la
      // misma cuenta aunque quieras probar con otra — con esto, Google SIEMPRE
      // enseña el selector de cuentas para elegir cuál usar.
      signInWithGoogle: function () {
        var redirectTo = window.location.origin + window.location.pathname;
        window.location.href = base() + "/auth/v1/authorize?provider=google&prompt=select_account&redirect_to=" + encodeURIComponent(redirectTo);
      },
      refresh: function () {
      ...
      // Se llama una vez al arrancar: si venimos de tocar el enlace de verificación
      // del correo, completa el login y limpia el hash de la URL. Devuelve
      // {ok:true} si había sesión nueva, {ok:false,error} si el enlace falló
      // (caducado/ya usado), o null si no había nada que consumir.
      consumeRedirect: function () {
        var p = parseHash();
        if (!p) return Promise.resolve(null);
        try { window.history.replaceState(null, "", window.location.pathname + window.location.search); } catch (e) {}
        if (p.error) return Promise.resolve({ ok: false, error: p.error_description || p.error });
        return fetchUser(p.access_token).then(function (u) {
          setSession({ access_token: p.access_token, refresh_token: p.refresh_token, expires_in: p.expires_in, user: u });
          return { ok: true, type: p.type || "signup" };
      ...
      signOut: function () {
        ...
        refreshAIProvider();
        if (s) { try { fetch(base() + "/auth/v1/logout", { method: "POST", headers: { apikey: AI_CONFIG.supabaseAnonKey, authorization: "Bearer " + s.access_token } }).catch(function () {}); } catch (e) {} }
      },
  ...
  var Sync = (function () {
    ...
    function rowsFor(entity, uid) {
      ...
      if (entity === "conversations") return DB.conversations.filter(function (c) { return c.messages && c.messages.length; }).map(function (c) { return { id: c.id, user_id: uid, subject_id: c.contextId || null, document_id: c.docId || null, title: c.title ? L(c.title) : null, thread: { messages: c.messages || [] } }; });
    ...
    return {
      ...
      push: function (entity) {
        ...
        if (entity === "profile" || entity === "state") {
          // La fila de profiles ya existe (la crea un trigger en Supabase al registrarse) -> PATCH, no upsert.
          var body = {
            name: (DB.profile && DB.profile.name) || null,
            avatar_url: DB.avatar || null,
            language: DB.lang || "es",
            theme: DB.theme || "system",
            accent: DB.accent || "violet",
            plan_key: DB.plan || "free",
            onboarding: { done: !!DB.onboardingDone },
            prefs: { goalMin: DB.goalMin, sessionLength: DB.sessionLength, notifications: DB.notifications, reminder: DB.reminder }
          };
          return rest("profiles?id=eq." + uid, { method: "PATCH", headers: { "prefer": "return=minimal" }, body: JSON.stringify(body) }).catch(function () {});
        }
        var table = ENTITIES[entity]; if (!table) return Promise.resolve();
  ...
  // (Antes aquí se exponía window.ZynqoraCloud con el AI_CONFIG editable y los
  // módulos Auth/Sync — era solo un resto de depuración sin ningún uso real en
  // la app, y cualquiera podía abrir la consola del navegador y tocarlo. Se
  // quita para que no haya ninguna puerta para cambiar el servidor de IA,
  // las claves o la sesión desde fuera del código.)

  // Convierte lo que devuelve Sync.pull() (filas de Postgres) de vuelta a la
  // forma que usa DB.* en el front. Es el espejo de rowsFor() en Sync.
  function hydrateFromCloud(r) {
    if (!r) return false;
    var gotAny = false;
    if (r.profile) {
      DB.profile = DB.profile || {};
      if (r.profile.name) DB.profile.name = r.profile.name;
      if (r.profile.email) DB.profile.email = r.profile.email;
      if (r.profile.avatar_url) DB.avatar = r.profile.avatar_url;
      if (r.profile.plan_key) DB.plan = r.profile.plan_key;
      if (r.profile.language) DB.lang = r.profile.language;
      if (r.profile.theme) DB.theme = r.profile.theme;
      if (r.profile.accent) DB.accent = r.profile.accent;
      if (r.profile.onboarding && typeof r.profile.onboarding.done === "boolean") DB.onboardingDone = r.profile.onboarding.done;
      if (r.profile.prefs) {
        var pr = r.profile.prefs;
        if (pr.goalMin != null) DB.goalMin = pr.goalMin;
        if (pr.sessionLength) DB.sessionLength = pr.sessionLength;
        if (typeof pr.notifications === "boolean") DB.notifications = pr.notifications;
        if (pr.reminder) DB.reminder = pr.reminder;
      }
      gotAny = true;
    }
    if (Array.isArray(r.subjects) && r.subjects.length) {
      // La tabla subjects de Supabase solo guarda id/nombre/icono/color/mastery —
      // el resto (doc de referencia, temas flojos, etc.) vive únicamente en local.
      // Por eso NO se reemplaza sin más: se actualizan esos campos sobre la
      // materia local si ya existía (conserva su contenido), y si es una
      // materia que llega por primera vez (otro dispositivo) se le da la
      // misma base que usa "crear materia" para que no falte nada.
      var existingById = {};
      ...
      if (!DB.currentSubjectId || !subj(DB.currentSubjectId)) DB.currentSubjectId = DB.subjects[0].id;
      gotAny = true;
    }
    if (Array.isArray(r.calendar)) {
      DB.calendar = r.calendar.map(function (x) { return { id: x.id, title: { es: x.title, en: x.title }, subjectId: x.subject_id, type: x.type || "study", date: x.due_date, time: x.due_time || "", desc: x.description || "", done: !!x.done }; });
      if (r.calendar.length) gotAny = true;
    }
    if (Array.isArray(r.documents)) {
      DB.documents = r.documents.map(function (d) { return { id: d.id, title: { es: d.name, en: d.name }, subjectId: d.subject_id, kind: d.kind, mime: d.mime_type, sizeBytes: d.size, storagePath: d.storage_path, status: d.status === "ready" ? "analyzed" : d.status, textSource: d.text_source, text: d.extracted_text, summary: d.summary, analysis: d.metadata || {} }; });
      if (r.documents.length) gotAny = true;
    }
    if (Array.isArray(r.conversations)) {
      DB.conversations = r.conversations.map(function (c) { return { id: c.id, contextId: c.subject_id, docId: c.document_id, title: c.title ? { es: c.title, en: c.title } : null, updated: c.updated_at ? Date.parse(c.updated_at) : Date.now(), messages: (c.thread && c.thread.messages) || [] }; });
      if (r.conversations.length) gotAny = true;
    }
    if (Array.isArray(r.sessions)) {
      DB.sessions = r.sessions.map(function (x) { return { id: x.id, subjectId: x.subject_id, docId: x.document_id, mode: x.mode, score: x.score, total: x.total }; });
    }
    if (r.usage) DB.usage = Object.assign({}, DB.usage, r.usage);
    if (!DB.subjects.length) DB.onboardingDone = false;
    // Solo guardamos en caché local (IndexedDB) lo que acabamos de traer de la
    // nube — nunca lo volvemos a mandar a Supabase (sería un eco inútil de lo
    // mismo que ya tiene).
    var wasBooting = BOOTING; BOOTING = true;
    persistAll();
    BOOTING = wasBooting;
    return gotAny;
  }
  // Tras iniciar sesión (o al arrancar con sesión ya guardada): trae lo que haya
  // en Supabase y lo vuelca en DB.*. Si la cuenta está recién creada (sin datos
  // aún en la nube), no hace nada — el usuario simplemente empieza vacío.
  function cloudPullAndHydrate() {
    if (!Sync.enabled()) return Promise.resolve(false);
    return Sync.pull().then(hydrateFromCloud).catch(function () { return false; });
  }
  // Justo después de iniciar sesión (registro confirmado o login): trae los
  // datos reales de la cuenta y decide si toca onboarding (cuenta nueva, sin
  // materias todavía) o directo al dashboard (cuenta con datos ya guardados).
  function onSignedIn() {
    toast(DB.lang === "en" ? "Signed in" : "Sesión iniciada");
    cloudPullAndHydrate().then(function () {
      S.authPendingEmail = null;
      S.screen = (DB.subjects && DB.subjects.length) ? "dashboard" : "onboarding";
      render();
    });
  }
  ...
  V.settings = function () {
    ...
    var body = topbar(t("settings.title"), { noAi: true }) +
      '<div class="wrap" style="max-width:600px">' +
        ...
        '<div class="card" style="margin-top:14px"><div class="between"><div class="eyebrow">' + t("settings.account") + "</div>" +
          (Auth.enabled() && Auth.session() ? pill(icon("check", 11) + t("set.cloudConnected"), "good") : "") + "</div>" +
          (Auth.enabled() && Auth.session()
            ? '<div class="switchrow" style="border:none;margin-top:8px;padding:0"><span class="txt-sm">' + esc((Auth.user() && Auth.user().email) || "") + '</span><button class="btn btn-ghost btn-sm" data-action="real-signout">' + t("auth.signout") + "</button></div>"
            : '<p class="txt-sm txt-muted" style="margin-top:8px">' + t("auth.gateNote") + "</p>") + "</div>" +
        ...
        '<div class="card" style="margin-top:14px"><div class="eyebrow" style="margin-bottom:12px">' + t("settings.language") + '</div><div class="chip-row">' +
          '<button class="chip-sel ' + (DB.lang === "es" ? "on" : "") + '" data-lang-set="es">Español</button><button class="chip-sel ' + (DB.lang === "en" ? "on" : "") + '" data-lang-set="en">English</button>' +
          '<button class="chip-sel ' + (DB.lang === "it" ? "on" : "") + '" data-lang-set="it">Italiano</button><button class="chip-sel ' + (DB.lang === "fr" ? "on" : "") + '" data-lang-set="fr">Français</button>' +
          '<button class="chip-sel ' + (DB.lang === "pt" ? "on" : "") + '" data-lang-set="pt">Português</button></div></div>' +
        ...
        '<div class="card" style="margin-top:14px;padding:6px 20px"><div class="divide">' +
          ...
          '<button class="list-row tap" style="width:100%" data-action="real-signout"><span class="ic">' + icon("logout", 17) + '</span><span class="gr"><span class="tt" style="font-weight:450;font-size:13.5px">' + t("settings.signout") + "</span></span></button>" +
  ...
  V.auth = function () {
    ...
    var gated = Auth.enabled() && !sess;
    var body = topbar(gated ? "Zynqora" : t("auth.title"), gated ? { noAi: true } : { back: "settings", noAi: true });
    if (!Auth.enabled()) {
      return chrome("profile", body +
    ...
    var mode = S.authMode === "signin" ? "signin" : "signup";
    var pending = S.authPendingEmail;
    if (pending) {
      return chrome("profile", body +
        '<div class="wrap" style="max-width:420px"><div class="empty" style="padding-top:30px"><div class="eic">' + icon("mail", 22) + "</div>" +
        "<h3>" + t("auth.checkEmailTitle") + "</h3><p>" + t("auth.checkEmailSub", { email: esc(pending) }) + "</p>" +
        '<button class="btn btn-secondary btn-block" style="margin-top:16px" data-action="auth-back-to-form">' + t("auth.backToForm") + "</button></div></div>", { noBottom: gated });
    }
    return chrome("profile", body +
      (gated ? '<div class="wrap" style="max-width:420px;text-align:center;margin-top:6px"><span class="mk" style="display:inline-flex">' + icon("logo", 22) + '</span><p class="txt-sm txt-muted" style="margin-top:6px">' + t("auth.gateNote") + "</p></div>" : "") +
      (S.authLinkError ? '<div class="wrap" style="max-width:420px"><div class="field-err" style="margin-bottom:10px">' + t("auth.linkExpired") + "</div></div>" : "") +
      '<div class="wrap" style="max-width:420px">' +
        ...
        '<div class="row" style="align-items:center;gap:10px;margin:16px 0"><span style="flex:1;height:1px;background:var(--border)"></span><span class="txt-sm txt-muted">' + t("auth.or") + '</span><span style="flex:1;height:1px;background:var(--border)"></span></div>' +
        '<button class="btn btn-secondary btn-block btn-lg" data-action="auth-google" style="gap:10px">' +
          '<svg width="18" height="18" viewBox="0 0 48 48"><path fill="#FFC107" d="M43.6 20.5H42V20H24v8h11.3C33.7 32.9 29.3 36 24 36c-6.6 0-12-5.4-12-12s5.4-12 12-12c3.1 0 5.9 1.2 8 3.1l5.7-5.7C34.5 6.5 29.5 4.5 24 4.5 12.7 4.5 3.5 13.7 3.5 25S12.7 45.5 24 45.5 44.5 36.3 44.5 25c0-1.6-.2-3.1-.5-4.5z"/><path fill="#FF3D00" d="m6.3 14.7 6.6 4.8C14.6 15.9 18.9 13 24 13c3.1 0 5.9 1.2 8 3.1l5.7-5.7C34.5 6.5 29.5 4.5 24 4.5c-7.8 0-14.5 4.4-17.7 10.2z"/><path fill="#4CAF50" d="M24 45.5c5.4 0 10.3-1.8 14.1-5l-6.5-5.5c-2 1.5-4.6 2.5-7.6 2.5-5.3 0-9.7-3.1-11.4-7.9l-6.5 5C9.5 41 16.2 45.5 24 45.5z"/><path fill="#1976D2" d="M43.6 20.5H42V20H24v8h11.3c-.8 2.3-2.3 4.3-4.2 5.7l6.5 5.5C41 36 44.5 31 44.5 25c0-1.6-.2-3.1-.9-4.5z"/></svg>' +
          t("auth.google") +
        "</button>" +
  ...
  V.profile = function () {
    var body = topbar(t("prof.title"), { noAi: true, actions: '<button class="btn btn-ghost btn-sm" data-nav="settings">' + icon("edit", 14) + t("prof.settings") + "</button>" }) +
      '<div class="wrap" style="max-width:600px">' +
        ...
        "</div></div>" +
        '<button class="btn btn-ghost btn-block" style="margin-top:14px" data-action="real-signout">' + icon("logout", 15) + t("settings.signout") + "</button>" +
  ...
  function sheetHtml() {
    ...
    if (S.sheet.kind === "add-subject") {
      ...
      inner = "<h3>" + t("subjects.newTitle") + '</h3><p class="sub">' + t("subjects.newSub") + "</p>" +
        '<label class="label">' + t("ob.nameLabel") + '</label><input class="field" id="sheetName" value="' + esc(S.sheet.name || "") + '" placeholder="' + t("subjects.namePlaceholder") + '">' +
  ...
  function render(soft) {
    // Cuenta obligatoria: sin sesión válida, no se enseña ninguna otra pantalla
    // (ni la landing ni datos locales) — todo camino lleva a "auth".
    if (Auth.enabled() && !Auth.session() && S.screen !== "auth") { S.screen = "auth"; if (!S.authMode) S.authMode = "signup"; }
    ...
    try {
      ...
      // Cualquier pantalla puede fallar por datos inesperados (p. ej. justo
      // después de sincronizar con la nube) — mejor mostrar el estado de
      // error ya existente que dejar la pantalla congelada o en blanco.
      try { console.error("Zynqora render error on screen '" + S.screen + "':", e); } catch (e2) {}
      if (S.screen !== "st-error") { S.screen = "st-error"; return render(soft); }
      html = "";
    }
    scroll.innerHTML = '<div class="view' + (soft ? "" : " view-enter") + '">' + html + "</div>" + sheetHtml();
  ...
  function keepSubjectSheet() {
    if (!S.sheet) return;
    var e = document.getElementById("sheetName");
    if (e) S.sheet.name = e.value;
  }
  ...
  function docRespond(c, text, intent) {
    ...
    function bank(tier) {
      ...
      if (!th.docExBank[tier] || !th.docExBank[tier].length) th.docExBank[tier] = DocGen.exercises(d.text, tier, docLang(d));
    ...
    return DocGen.answer(d.text, text, docLang(d));
  }
  ...
  function docExercises(docId) {
    ...
    var ex = DocGen.exercises(d.text, "med", docLang(d));
  ...
  document.addEventListener("click", function (e) {
    var t2 = e.target.closest("[data-nav],[data-action],[data-theme-set],[data-lang-set],[data-ai-open],[data-ai-sugg]");
    if (!t2) {
    ...
    switch (a) {
      ...
      case "sheet-icon": keepSubjectSheet(); S.sheet.icon = d.v; render(true); break;
      case "sheet-color": keepSubjectSheet(); S.sheet.color = d.v; render(true); break;
      case "sheet-studylang": keepSubjectSheet(); S.sheet.studyLang = d.v || null; render(true); break;
      ...
      case "real-signout":
        Auth.signOut();
        try { clearLocalForNewAccount(); } catch (e) {}
        S.screen = "auth"; S.authMode = "signin"; S.authPendingEmail = null; S.authLinkError = false;
        render();
        toast(DB.lang === "en" ? "Signed out" : "Sesión cerrada");
        break;
      case "auth-mode": S.authMode = d.v; S.authPendingEmail = null; S.authLinkError = false; render(true); break;
      case "auth-back-to-form": S.authPendingEmail = null; S.authLinkError = false; render(true); break;
      case "auth-submit": {
        ...
        var isSignup = d.v === "signup";
        var pr = isSignup ? Auth.signUp(ae, ap, an) : Auth.signIn(ae, ap);
        pr.then(function (j) {
          if (isSignup && !(j && j.access_token)) {
            // "Confirm email" está activo en Supabase: no hay sesión hasta que
            // el usuario toque el enlace que le acaba de llegar por correo.
            S.authPendingEmail = ae; render(true); return;
          }
          onSignedIn();
        }).catch(function (err) {
          var eb2 = document.getElementById("authErr");
          var msg = ((err && (err.error_description || err.msg || err.error_code || err.error)) || "").toLowerCase();
          var text = msg.indexOf("confirm") > -1 ? t("auth.checkEmailTitle") + ": " + (DB.lang === "en" ? "confirm your email first (check your inbox)." : "confirma tu email primero (revisa tu bandeja de entrada).") : t("auth.err");
          if (eb2) eb2.innerHTML = '<div class="field-err">' + text + "</div>";
        });
        break;
      }
      case "auth-recover": {
      ...
      case "auth-google": Auth.signInWithGoogle(); break;
  ...
  function makeSubject(name, ic, color, studyLang) {
    var base = {
  ...
  function saveSubject() {
    ...
    var ns = makeSubject(name, S.sheet.icon || "book", S.sheet.color || "#5A54C9", S.sheet.studyLang || null);
  ...
  Store.open()
    ...
    .then(function (data) {
      ...
      ensureAccountMatch();                               // nunca mezclar demo/otra cuenta con la sesión real
      if (S.screen === "landing" && Auth.session()) {
        // Con sesión ya activa nunca se enseña la landing de marketing —
        // directo al dashboard (o a onboarding si la cuenta está vacía).
        S.screen = (DB.subjects && DB.subjects.length) ? "dashboard" : "onboarding";
      }
    })
    .catch(function () {})
    .then(function () { return Auth.consumeRedirect(); })
    .then(function (redirectResult) {
      setLang(DB.lang); applyAccent(); syncUser();
      if (redirectResult && redirectResult.ok) {
        // El usuario acaba de tocar el enlace de verificación del correo:
        // ya tiene sesión — trae sus datos reales (si los hay) y entra.
        render(); // splash -> pantalla "auth" momentánea mientras llega la nube
        return cloudPullAndHydrate().then(function () {
          S.screen = (DB.subjects && DB.subjects.length) ? "dashboard" : "onboarding";
          render();
        });
      }
      if (redirectResult && redirectResult.ok === false) {
        S.screen = "auth"; S.authMode = "signin"; S.authLinkError = true;
        render();
        return;
      }
      if (Auth.session()) {
        // Sesión ya guardada de una visita anterior: refresca desde la nube
        // (por si se usó otro dispositivo) sin bloquear el primer pintado.
        render();
        return cloudPullAndHydrate().then(function () {
          if (S.screen === "landing" || S.screen === "auth" || S.screen === "onboarding") { S.screen = (DB.subjects && DB.subjects.length) ? "dashboard" : "onboarding"; }
          render(true);
        });
      }
      render(); // sin sesión: render() fuerza la pantalla "auth" (cuenta obligatoria)
    })
    .catch(function (e) { try { render(); } catch (e2) {} })
    .then(function () {
      BOOTING = false; // a partir de aquí, cualquier cambio del usuario sí se sincroniza con Supabase
